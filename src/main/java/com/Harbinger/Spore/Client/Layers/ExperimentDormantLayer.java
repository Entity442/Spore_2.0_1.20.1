...
public class ExperimentDormantLayer<T extends Experiment> extends RenderLayer<T, EntityModel<T>> {
    ...
    public ExperimentDormantLayer(RenderLayerParent<T, EntityModel<T>> p_117346_, EntityModelSet set) {
        super(p_117346_);
        this.model = new ExperimentDormantLayerModel<>(set.bakeLayer(ExperimentDormantLayerModel.LAYER_LOCATION));
    }
