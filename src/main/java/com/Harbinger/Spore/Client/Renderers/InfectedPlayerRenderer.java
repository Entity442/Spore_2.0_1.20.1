...
public class InfectedPlayerRenderer extends BaseInfectedRenderer<InfectedPlayer , HumanoidModel<InfectedPlayer>> {
    ...
    public static final Map<Component,ResourceLocation> SPECIAL_SKINS =new HashMap<>(){{
        ...
        put(Component.literal("BigXplosion"),new ResourceLocation(Spore.MODID,
                "textures/entity/player/inf_explosion_skin.png"));
        put(Component.literal("Toasteroni"),new ResourceLocation(Spore.MODID,
        ...
        put(Component.literal("AllToAshes"),new ResourceLocation(Spore.MODID,
        ...
        put(Component.literal("minisketchy0919"), new ResourceLocation(Spore.MODID,
                "textures/entity/player/inf_player_minisketchy0919.png"));
        put(Component.literal("yile_ouo"), new ResourceLocation(Spore.MODID,
                "textures/entity/player/yile_ouo.png"));
        put(Component.literal("TheCaramelGuy"), new ResourceLocation(Spore.MODID,
        ...
        put(Component.literal("hammbug"), new ResourceLocation(Spore.MODID,
                "textures/entity/player/hammbug.png"));
        put(Component.literal("DivnejFelix"), new ResourceLocation(Spore.MODID,
                "textures/entity/player/penguin.png"));
    }};
