...
public class LeftArmArmorPartEnchant extends BaseArmorRenderingBit implements EnchantingPart{
    ...
    public LeftArmArmorPartEnchant(Item item, Supplier<EntityModel<LivingEntity>> model, Supplier<ModelPart> part, float x, float y, float z, float expand, Enchantment enchantment, ResourceLocation location) {
