...
public class AcidicAssassinPartRight extends BaseArmorRenderingBit{
   public AcidicAssassinPartRight(Supplier<EntityModel<LivingEntity>> model, Supplier<ModelPart> part, float x, float y, float z, float expand) {
        super(EquipmentSlot.MAINHAND, Sitems.ACIDIC_ASSASSIN.get(), model, part, x, y, z, expand);
    }
