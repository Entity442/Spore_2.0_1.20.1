...
public class RightBootArmorPartEnchant extends BaseArmorRenderingBit implements EnchantingPart{
    ...
    public RightBootArmorPartEnchant(Supplier<EntityModel<LivingEntity>> model, Supplier<ModelPart> part, float x, float y, float z, float expand, Enchantment enchantment, ResourceLocation location, List<Item> blacklist) {
