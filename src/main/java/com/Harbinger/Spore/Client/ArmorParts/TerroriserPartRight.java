...
public class TerroriserPartRight extends BaseArmorRenderingBit{
   public TerroriserPartRight(Supplier<EntityModel<LivingEntity>> model, Supplier<ModelPart> part, float x, float y, float z, float expand) {
        super(EquipmentSlot.MAINHAND, Sitems.TERRORISER.get(), model, part, x, y, z, expand);
    }
