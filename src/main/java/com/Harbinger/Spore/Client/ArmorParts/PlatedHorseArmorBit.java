...
public class PlatedHorseArmorBit extends HorseArmorBit{
    private  final PlatedHorseArmorModel<AbstractHorse> platedHorseArmorModel = new PlatedHorseArmorModel<>();
    public PlatedHorseArmorBit(Item item) {
        super(item);
    }
