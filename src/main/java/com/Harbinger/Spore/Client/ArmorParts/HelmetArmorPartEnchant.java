...
public class HelmetArmorPartEnchant extends BaseArmorRenderingBit implements EnchantingPart{
    ...
    public HelmetArmorPartEnchant(Item item, Supplier<EntityModel<LivingEntity>> model, Supplier<ModelPart> part, float x, float y, float z, float expand, Enchantment enchantment, ResourceLocation location) {
