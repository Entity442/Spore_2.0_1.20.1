...
public class AcidicAssassinPartLeft extends BaseArmorRenderingBit {
    public AcidicAssassinPartLeft(Supplier<EntityModel<LivingEntity>> model, Supplier<ModelPart> part, float x, float y, float z, float expand) {
        super(EquipmentSlot.OFFHAND, Sitems.ACIDIC_ASSASSIN.get(), model, part, x, y, z, expand);
    }
