...
import com.Harbinger.Spore.Client.Layers.BodySynModel;
...
public class Testing<T extends LivingEntity> extends EntityModel<T> implements BodySynModel {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Spore.MODID, "asdsad"), "main");
	...
	@Override
	public void animateHead(PoseStack stack, ModelPart part, MultiBufferSource buffer, int packedLight) {
		stack.pushPose();
		VertexConsumer consumer = buffer.getBuffer(RenderType.entityCutout(BASIC_ROUND));
		part.translateAndRotate(stack);
		BileMissile.render(stack,consumer,packedLight,OverlayTexture.NO_OVERLAY);
		stack.popPose();
	}

	@Override
	public void animateBody(PoseStack stack, ModelPart part, MultiBufferSource buffer, int packedLight) {
		stack.pushPose();
		VertexConsumer consumer = buffer.getBuffer(RenderType.entityCutout(BASIC_ROUND));
		part.translateAndRotate(stack);
		BileMissile.render(stack,consumer,packedLight,OverlayTexture.NO_OVERLAY);
	...
	@Override
	public void animateRightArm(PoseStack stack, ModelPart part, MultiBufferSource buffer, int packedLight) {
		stack.pushPose();
		VertexConsumer consumer = buffer.getBuffer(RenderType.entityCutout(BASIC_ROUND));
		part.translateAndRotate(stack);
		BileMissile.render(stack,consumer,packedLight,OverlayTexture.NO_OVERLAY);
	...
	@Override
	public void animateLeftArm(PoseStack stack, ModelPart part, MultiBufferSource buffer, int packedLight) {
		stack.pushPose();
		VertexConsumer consumer = buffer.getBuffer(RenderType.entityCutout(BASIC_ROUND));
		part.translateAndRotate(stack);
		BileMissile.render(stack,consumer,packedLight,OverlayTexture.NO_OVERLAY);
	...
	@Override
	public void animateRightLeg(PoseStack stack, ModelPart part, MultiBufferSource buffer, int packedLight) {
		stack.pushPose();
		VertexConsumer consumer = buffer.getBuffer(RenderType.entityCutout(BASIC_ROUND));
		part.translateAndRotate(stack);
		BileMissile.render(stack,consumer,packedLight,OverlayTexture.NO_OVERLAY);
	...
	@Override
	public void animateLeftLeg(PoseStack stack, ModelPart part, MultiBufferSource buffer, int packedLight) {
		stack.pushPose();
		VertexConsumer consumer = buffer.getBuffer(RenderType.entityCutout(BASIC_ROUND));
		part.translateAndRotate(stack);
		BileMissile.render(stack,consumer,packedLight,OverlayTexture.NO_OVERLAY);
