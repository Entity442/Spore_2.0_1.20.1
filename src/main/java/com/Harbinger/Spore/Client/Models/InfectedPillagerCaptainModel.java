...
public class InfectedPillagerCaptainModel<T extends InfectedPillager> extends InfectedPillagerModel<T> implements ArmedModel{
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Spore.MODID, "infectedpillagercaptainmodel"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Fabric_r1 = Banner.addOrReplaceChild("Fabric_r1", CubeListBuilder.create().texOffs(0, 64).addBox(-20.0F, -10.0F, -0.5F, 40.0F, 20.0F, 1.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(0.0F, -16.4F, -0.8F, 0.0F, 0.0F, 1.5708F));

		PartDefinition PoleTop_r1 = Banner.addOrReplaceChild("PoleTop_r1", CubeListBuilder.create().texOffs(0, 106).addBox(-1.0F, -20.0F, -1.0F, 2.0F, 20.0F, 2.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(-10.0F, -35.4F, 0.0F, 0.0F, 0.0F, 1.5708F));
