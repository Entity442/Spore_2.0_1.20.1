...
public class adaptedwormsegment3<T extends HohlMultipart> extends EntityModel<T> implements TentacledModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition bone = hohl_seg.addOrReplaceChild("bone", CubeListBuilder.create(), PartPose.offset(10.4F, -13.1F, 13.9F));

		PartDefinition cube_r28 = bone.addOrReplaceChild("cube_r28", CubeListBuilder.create().texOffs(116, 62).addBox(-22.0F, -16.0F, -15.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(-2.5F)), PartPose.offsetAndRotation(-1.2F, 36.1F, 47.6F, -0.1867F, -0.8491F, 1.9939F));

		PartDefinition cube_r29 = bone.addOrReplaceChild("cube_r29", CubeListBuilder.create().texOffs(116, 62).addBox(-22.0F, -16.0F, -15.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(-2.5F)), PartPose.offsetAndRotation(-42.2F, -5.0F, 51.4F, -0.1867F, -0.8491F, 1.9939F));

		PartDefinition cube_r30 = bone.addOrReplaceChild("cube_r30", CubeListBuilder.create().texOffs(116, 62).addBox(-22.0F, -16.0F, -15.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(-1.2F)), PartPose.offsetAndRotation(-62.0F, 29.8F, 11.5F, -1.6281F, -0.5759F, 2.7308F));

		PartDefinition cube_r31 = bone.addOrReplaceChild("cube_r31", CubeListBuilder.create().texOffs(116, 62).addBox(-22.0F, -16.0F, -15.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(-1.9F)), PartPose.offsetAndRotation(24.3F, -17.4F, -3.5F, -1.8241F, 0.0054F, -1.3773F));

		PartDefinition cube_r32 = bone.addOrReplaceChild("cube_r32", CubeListBuilder.create().texOffs(116, 62).addBox(-22.0F, -16.0F, -15.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(-1.2F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.6281F, -0.5759F, 2.7308F));
