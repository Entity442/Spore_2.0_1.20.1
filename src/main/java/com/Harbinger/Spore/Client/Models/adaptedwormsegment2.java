...
public class adaptedwormsegment2<T extends HohlMultipart> extends EntityModel<T> implements TentacledModel {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Spore.MODID, "adaptedwormsegment2"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Root1 = Tendrils.addOrReplaceChild("Root1", CubeListBuilder.create().texOffs(298, 353).addBox(-1.0F, -3.5F, -3.5F, 20.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(32.7386F, -22.6373F, -101.7566F, -1.727F, -0.6317F, 0.2191F));
		...
		PartDefinition Root4 = Tendrils.addOrReplaceChild("Root4", CubeListBuilder.create().texOffs(298, 353).addBox(-1.0F, -3.5F, -3.5F, 20.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.2614F, -0.6373F, -122.7566F, -1.8429F, -0.5161F, 1.8495F));
		...
		PartDefinition LeftArm = body.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(448, 404).addBox(-1.0F, -2.0F, -1.5F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.0F, 2.0F, 0.0F, -1.5161F, -0.5216F, -0.0453F));
		...
		.texOffs(472, 350).addBox(-4.0F, -2.0F, 0.0F, 8.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(479, 371).addBox(-4.0F, -2.0F, -4.0F, 8.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -10.0F, 0.0F, -0.6981F, 0.0F, 0.0F));

		PartDefinition jaw2 = head2.addOrReplaceChild("jaw2", CubeListBuilder.create().texOffs(487, 390).addBox(-3.5F, 0.0F, -3.75F, 7.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.0F, 0.0F, 0.6109F, 0.0F, 0.0F));
		...
		.texOffs(459, 404).addBox(-2.0F, -1.0F, -1.0F, 4.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.0F, 6.0F, 0.0F));
		...
		PartDefinition RightArm3 = body3.addOrReplaceChild("RightArm3", CubeListBuilder.create().texOffs(448, 404).addBox(-2.0F, -2.0F, -1.5F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, 2.0F, 0.0F, -0.9428F, 0.7138F, 0.5775F));
		...
		PartDefinition RightArm4 = body4.addOrReplaceChild("RightArm4", CubeListBuilder.create().texOffs(448, 404).addBox(-2.0F, -2.0F, -1.5F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, 2.0F, 0.0F, 1.4579F, -0.4205F, 0.1201F));
		...
		PartDefinition ThornTendril = hohl_seg.addOrReplaceChild("ThornTendril", CubeListBuilder.create().texOffs(470, 237).addBox(-2.0F, 0.0F, -2.5F, 4.0F, 6.0F, 5.0F, new CubeDeformation(-0.01F)), PartPose.offsetAndRotation(-35.3882F, 16.3614F, 11.5217F, 2.2226F, -0.4529F, -0.0461F));
		...
		PartDefinition ThornTendril2 = hohl_seg.addOrReplaceChild("ThornTendril2", CubeListBuilder.create().texOffs(470, 237).addBox(-2.0F, 0.0F, -2.5F, 4.0F, 6.0F, 5.0F, new CubeDeformation(-0.01F)), PartPose.offsetAndRotation(21.6118F, -21.6386F, 10.5217F, 1.2076F, -0.5494F, 2.7778F));
		...
		PartDefinition ThornTendril3 = hohl_seg.addOrReplaceChild("ThornTendril3", CubeListBuilder.create().texOffs(470, 237).addBox(-2.0F, 0.0F, -2.5F, 4.0F, 6.0F, 5.0F, new CubeDeformation(-0.01F)), PartPose.offsetAndRotation(-10.3882F, -31.6386F, 37.5217F, 1.7375F, -0.5224F, 0.8467F));
		...
		PartDefinition ThornTendril4 = hohl_seg.addOrReplaceChild("ThornTendril4", CubeListBuilder.create().texOffs(470, 237).addBox(-2.0F, 0.0F, -2.5F, 4.0F, 6.0F, 5.0F, new CubeDeformation(-0.01F)), PartPose.offsetAndRotation(11.6118F, 23.3614F, 20.5217F, 0.8561F, -0.6162F, -1.5181F));
		...
		PartDefinition bone = hohl_seg.addOrReplaceChild("bone", CubeListBuilder.create(), PartPose.offset(0.9F, -22.6F, 14.1F));

		PartDefinition cube_r1 = bone.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(116, 62).addBox(-22.0F, -16.0F, -15.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(-1.6F)), PartPose.offsetAndRotation(-52.5F, 35.1F, -5.0F, -2.1056F, -0.7007F, -2.9401F));

		PartDefinition cube_r2 = bone.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(116, 62).addBox(-22.0F, -16.0F, -15.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(-1.2F)), PartPose.offsetAndRotation(-41.5F, 2.4F, 33.1F, -0.938F, -0.3043F, 2.6336F));

		PartDefinition cube_r3 = bone.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(116, 62).addBox(-22.0F, -16.0F, -15.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(-3.0F)), PartPose.offsetAndRotation(17.2F, 18.6F, 23.7F, -1.5063F, -0.0804F, 2.9218F));

		PartDefinition cube_r4 = bone.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(116, 62).addBox(-22.0F, -16.0F, -15.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(-2.4F)), PartPose.offsetAndRotation(1.4F, -0.8F, 5.8F, -1.3169F, -0.3391F, 2.5318F));

		PartDefinition cube_r5 = bone.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(116, 62).addBox(-22.0F, -16.0F, -15.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(-1.2F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.6281F, -0.5759F, 2.7308F));

		return LayerDefinition.create(meshdefinition, 515, 515);
	}
