...
public class GroberfubModel<T extends Grober> extends HierarchicalModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Spore.MODID, "groberfub"), "main");
	...
	public GroberfubModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Petal_r1 = UpperBodyFoliage.addOrReplaceChild("Petal_r1", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.5F, -24.4F, -9.5F, 2.0676F, 0.1649F, 2.677F));

		PartDefinition Petal_r2 = UpperBodyFoliage.addOrReplaceChild("Petal_r2", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.3F, -19.5F, -5.8F, 2.5429F, -0.0586F, 3.0734F));

		PartDefinition Petal_r3 = UpperBodyFoliage.addOrReplaceChild("Petal_r3", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.7F, -26.3F, -0.8F, -3.0457F, 0.7975F, 3.136F));

		PartDefinition Petal_r4 = UpperBodyFoliage.addOrReplaceChild("Petal_r4", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.8F, -23.0F, 2.3F, -0.4108F, 1.32F, -0.3814F));
		...
		PartDefinition Petal_r5 = PetalCrown5.addOrReplaceChild("Petal_r5", CubeListBuilder.create().texOffs(-8, 165).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.2F, 0.1F, -0.05F, 0.0114F, -0.0529F, 0.4352F));

		PartDefinition Petal_r6 = PetalCrown5.addOrReplaceChild("Petal_r6", CubeListBuilder.create().texOffs(-8, 155).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.2F, 0.1F, -0.05F, 0.045F, -0.0301F, -0.3331F));

		PartDefinition Petal_r7 = PetalCrown5.addOrReplaceChild("Petal_r7", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.1F, -3.15F, -1.5405F, 1.1485F, -1.524F));

		PartDefinition Petal_r8 = PetalCrown5.addOrReplaceChild("Petal_r8", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.1F, 3.25F, 1.5433F, 1.1027F, 1.5653F));

		PartDefinition LowerBody = Body.addOrReplaceChild("LowerBody", CubeListBuilder.create(), PartPose.offset(0.0F, 3.9784F, 1.9674F));

		PartDefinition PelvisClothing_r1 = LowerBody.addOrReplaceChild("PelvisClothing_r1", CubeListBuilder.create().texOffs(216, 0).addBox(-6.0F, -3.0F, -4.0F, 12.0F, 6.0F, 8.0F, new CubeDeformation(0.2F))
		...
		PartDefinition Petal_r9 = LowerBodyFoliage.addOrReplaceChild("Petal_r9", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, -17.2F, -4.3F, 1.1056F, -0.29F, 2.7958F));

		PartDefinition Petal_r10 = LowerBodyFoliage.addOrReplaceChild("Petal_r10", CubeListBuilder.create().texOffs(-8, 155).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.9F, -19.0F, 4.2F, -0.0151F, 0.3315F, 0.0442F));
		...
		PartDefinition Petal_r12 = HeadFoliage.addOrReplaceChild("Petal_r12", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.4F, -31.2F, -12.2F, 2.3761F, 1.267F, 2.2022F));

		PartDefinition Petal_r13 = HeadFoliage.addOrReplaceChild("Petal_r13", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.8F, -40.5F, -3.3F, -2.4458F, 0.8738F, -2.3906F));

		PartDefinition Petal_r14 = HeadFoliage.addOrReplaceChild("Petal_r14", CubeListBuilder.create().texOffs(-8, 155).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.4F, -36.6F, -2.4F, -0.3164F, -0.4012F, 0.2202F));

		PartDefinition Petal_r15 = HeadFoliage.addOrReplaceChild("Petal_r15", CubeListBuilder.create().texOffs(-8, 164).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.1F, -31.2F, -10.2F, 0.1067F, -0.417F, 0.1658F));

		PartDefinition Petal_r16 = HeadFoliage.addOrReplaceChild("Petal_r16", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.1F, -35.1F, -12.5F, 0.3383F, -0.5274F, -0.2629F));

		PartDefinition Petal_r17 = HeadFoliage.addOrReplaceChild("Petal_r17", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.1F, -38.4F, -12.5F, 0.3778F, -0.0715F, 0.2287F));

		PartDefinition Petal_r18 = HeadFoliage.addOrReplaceChild("Petal_r18", CubeListBuilder.create().texOffs(-8, 155).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.7F, -31.8F, -7.4F, -0.2079F, -0.5077F, -0.2351F));

		PartDefinition Petal_r19 = HeadFoliage.addOrReplaceChild("Petal_r19", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.9F, -37.0F, -3.8F, -0.1919F, 0.0067F, 0.0343F));
		...
		PartDefinition Petal_r20 = PetalCrown1.addOrReplaceChild("Petal_r20", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.2F, 0.1F, -0.05F, 0.0114F, -0.0529F, 0.4352F));

		PartDefinition Petal_r21 = PetalCrown1.addOrReplaceChild("Petal_r21", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.2F, 0.1F, -0.05F, 0.045F, -0.0301F, -0.3331F));

		PartDefinition Petal_r22 = PetalCrown1.addOrReplaceChild("Petal_r22", CubeListBuilder.create().texOffs(-8, 165).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.1F, -3.15F, -1.5405F, 1.1485F, -1.524F));

		PartDefinition Petal_r23 = PetalCrown1.addOrReplaceChild("Petal_r23", CubeListBuilder.create().texOffs(-8, 155).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.1F, 3.25F, 1.5433F, 1.1027F, 1.5653F));
		...
		PartDefinition Petal_r24 = PetalCrown2.addOrReplaceChild("Petal_r24", CubeListBuilder.create().texOffs(-8, 155).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.2F, 0.1F, -0.05F, 0.0114F, -0.0529F, 0.4352F));

		PartDefinition Petal_r25 = PetalCrown2.addOrReplaceChild("Petal_r25", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.2F, 0.1F, -0.05F, 0.045F, -0.0301F, -0.3331F));

		PartDefinition Petal_r26 = PetalCrown2.addOrReplaceChild("Petal_r26", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.1F, -3.15F, -1.5405F, 1.1485F, -1.524F));

		PartDefinition Petal_r27 = PetalCrown2.addOrReplaceChild("Petal_r27", CubeListBuilder.create().texOffs(-8, 165).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.1F, 3.25F, 1.5433F, 1.1027F, 1.5653F));
		...
		PartDefinition Petal_r28 = PetalCrown3.addOrReplaceChild("Petal_r28", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.2F, 0.1F, -0.05F, 0.0114F, -0.0529F, 0.4352F));

		PartDefinition Petal_r29 = PetalCrown3.addOrReplaceChild("Petal_r29", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.2F, 0.1F, -0.05F, 0.045F, -0.0301F, -0.3331F));

		PartDefinition Petal_r30 = PetalCrown3.addOrReplaceChild("Petal_r30", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.1F, -3.15F, -1.5405F, 1.1485F, -1.524F));

		PartDefinition Petal_r31 = PetalCrown3.addOrReplaceChild("Petal_r31", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.1F, 3.25F, 1.5433F, 1.1027F, 1.5653F));
		...
		PartDefinition Petal_r32 = PetalCrown4.addOrReplaceChild("Petal_r32", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.2F, 0.1F, -0.05F, 0.0114F, -0.0529F, 0.4352F));

		PartDefinition Petal_r33 = PetalCrown4.addOrReplaceChild("Petal_r33", CubeListBuilder.create().texOffs(-8, 165).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.2F, 0.1F, -0.05F, 0.045F, -0.0301F, -0.3331F));

		PartDefinition Petal_r34 = PetalCrown4.addOrReplaceChild("Petal_r34", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.1F, -3.15F, -1.5405F, 1.1485F, -1.524F));

		PartDefinition Petal_r35 = PetalCrown4.addOrReplaceChild("Petal_r35", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.1F, 3.25F, 1.5433F, 1.1027F, 1.5653F));
		...
		PartDefinition Petal_r36 = UpperRightArmFoliage.addOrReplaceChild("Petal_r36", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-14.2F, -17.5F, -8.0F, 0.5513F, 0.9747F, 0.2183F));

		PartDefinition Petal_r37 = UpperRightArmFoliage.addOrReplaceChild("Petal_r37", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-11.2F, -24.2F, -1.8F, -0.66F, 0.7857F, -0.489F));
		...
		PartDefinition Petal_r38 = PetalCrown6.addOrReplaceChild("Petal_r38", CubeListBuilder.create().texOffs(-8, 155).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.2F, 0.1F, -0.05F, 0.0114F, -0.0529F, 0.4352F));

		PartDefinition Petal_r39 = PetalCrown6.addOrReplaceChild("Petal_r39", CubeListBuilder.create().texOffs(-8, 164).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.2F, 0.1F, -0.05F, 0.045F, -0.0301F, -0.3331F));

		PartDefinition Petal_r40 = PetalCrown6.addOrReplaceChild("Petal_r40", CubeListBuilder.create().texOffs(-8, 165).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.1F, -3.15F, -1.5405F, 1.1485F, -1.524F));

		PartDefinition Petal_r41 = PetalCrown6.addOrReplaceChild("Petal_r41", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.1F, 3.25F, 1.5433F, 1.1027F, 1.5653F));
		...
		PartDefinition Petal_r42 = LowerRightArmFoliage.addOrReplaceChild("Petal_r42", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0582F, 11.4934F, -2.8F, 2.6245F, -1.3275F, -2.5158F));

		PartDefinition Petal_r43 = LowerRightArmFoliage.addOrReplaceChild("Petal_r43", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.5418F, 1.9934F, 1.7F, -0.2529F, -0.2585F, 0.0534F));

		PartDefinition Petal_r44 = LowerRightArmFoliage.addOrReplaceChild("Petal_r44", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.7582F, 5.9934F, 0.5F, -0.0598F, -0.2518F, 0.3239F));
		...
		PartDefinition Petal_r45 = UpperLeftArmFoliage.addOrReplaceChild("Petal_r45", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.4195F, 5.5056F, -2.6F, 2.8535F, 0.0958F, 3.0886F));

		PartDefinition Petal_r46 = UpperLeftArmFoliage.addOrReplaceChild("Petal_r46", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-6.5195F, 4.6056F, 1.6F, -0.3213F, 0.9552F, -0.4323F));

		PartDefinition Petal_r47 = UpperLeftArmFoliage.addOrReplaceChild("Petal_r47", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.1195F, 6.6056F, 1.6F, -0.2341F, 0.9747F, 0.2183F));
		...
		PartDefinition Petal_r48 = LowerLeftArmFoliage.addOrReplaceChild("Petal_r48", CubeListBuilder.create().texOffs(-8, 165).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.1289F, 9.3708F, -1.6F, 0.8325F, 0.8841F, 0.5999F));

		PartDefinition Petal_r49 = LowerLeftArmFoliage.addOrReplaceChild("Petal_r49", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.0289F, 4.0708F, 3.1F, -0.2952F, -0.4835F, 0.0549F));

		PartDefinition Petal_r50 = LowerLeftArmFoliage.addOrReplaceChild("Petal_r50", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.4711F, 0.4708F, -1.6F, 0.1182F, 0.0546F, 0.4613F));
		...
		PartDefinition Petal_r51 = PetalCrown7.addOrReplaceChild("Petal_r51", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.2F, 0.1F, -0.05F, 0.0114F, -0.0529F, 0.4352F));

		PartDefinition Petal_r52 = PetalCrown7.addOrReplaceChild("Petal_r52", CubeListBuilder.create().texOffs(-8, 146).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.2F, 0.1F, -0.05F, 0.045F, -0.0301F, -0.3331F));

		PartDefinition Petal_r53 = PetalCrown7.addOrReplaceChild("Petal_r53", CubeListBuilder.create().texOffs(-8, 155).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.1F, -3.15F, -1.5405F, 1.1485F, -1.524F));

		PartDefinition Petal_r54 = PetalCrown7.addOrReplaceChild("Petal_r54", CubeListBuilder.create().texOffs(-8, 165).addBox(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.1F, 3.25F, 1.5433F, 1.1027F, 1.5653F));
