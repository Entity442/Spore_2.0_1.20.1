...
public class DragonNeckPieceTarMidModel<T extends LivingEntity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Spore.MODID, "dragonneckpiecetarmodel"), "main");
	...
	public DragonNeckPieceTarMidModel() {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Pipe2 = yes.addOrReplaceChild("Pipe2", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.3166F, -5.8746F, -3.4504F, 0.1745F, 0.0F, 0.0F));
		...
		PartDefinition Pipe3 = yes.addOrReplaceChild("Pipe3", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.3166F, -14.3746F, -2.9504F, -0.2182F, 0.0F, 0.0F));
		...
		PartDefinition Leg_r1 = FS2Body1.addOrReplaceChild("Leg_r1", CubeListBuilder.create().texOffs(0, 112).addBox(-1.1032F, -0.7548F, -1.73F, 8.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.4672F, 2.2911F, 5.6196F, -0.6028F, -0.5244F, 1.2983F));
