...
public class BurstUsurperModel<T extends Usurper> extends EntityModel<T> implements TentacledModel{
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Spore.MODID, "burstusurper"), "main");
	private final ModelPart burstspitterorganoid;
	...
	private final ModelPart T2S4;
	private final ModelPart T2S5;
	private final ModelPart T2Tip;
	private final ModelPart Tube2;
	private final ModelPart T3S6;
	private final ModelPart T3S7;
	private final ModelPart T3S8;
	private final ModelPart T3S9;
	private final ModelPart T3Tip2;
	private final ModelPart Tube3;
	private final ModelPart T3S2;
	private final ModelPart T3S3;
	private final ModelPart T3S4;
	private final ModelPart T3S5;
	private final ModelPart T3Tip;
	private final ModelPart Tube4;
	private final ModelPart T3S10;
	private final ModelPart T3S11;
	private final ModelPart T3S12;
	private final ModelPart T3S13;
	private final ModelPart T3Tip3;
	private final ModelPart Tube5;
	private final ModelPart T2S6;
	private final ModelPart T2S7;
	private final ModelPart T2S8;
	private final ModelPart T2S9;
	private final ModelPart T2Tip2;

	public BurstUsurperModel(ModelPart root) {
		this.burstspitterorganoid = root.getChild("burstspitterorganoid");
		this.base = this.burstspitterorganoid.getChild("base");
		...
		this.OrganoidSeg1 = this.burstspitterorganoid.getChild("OrganoidSeg1");
		...
		this.Tube1 = this.LeTubes.getChild("Tube1");
		this.T2S2 = this.Tube1.getChild("T2S2");
		this.T2S3 = this.T2S2.getChild("T2S3");
		this.T2S4 = this.T2S3.getChild("T2S4");
		this.T2S5 = this.T2S4.getChild("T2S5");
		this.T2Tip = this.T2S5.getChild("T2Tip");
		this.Tube2 = this.LeTubes.getChild("Tube2");
		this.T3S6 = this.Tube2.getChild("T3S6");
		this.T3S7 = this.T3S6.getChild("T3S7");
		this.T3S8 = this.T3S7.getChild("T3S8");
		this.T3S9 = this.T3S8.getChild("T3S9");
		this.T3Tip2 = this.T3S9.getChild("T3Tip2");
		this.Tube3 = this.LeTubes.getChild("Tube3");
		this.T3S2 = this.Tube3.getChild("T3S2");
		this.T3S3 = this.T3S2.getChild("T3S3");
		this.T3S4 = this.T3S3.getChild("T3S4");
		this.T3S5 = this.T3S4.getChild("T3S5");
		this.T3Tip = this.T3S5.getChild("T3Tip");
		this.Tube4 = this.LeTubes.getChild("Tube4");
		this.T3S10 = this.Tube4.getChild("T3S10");
		this.T3S11 = this.T3S10.getChild("T3S11");
		this.T3S12 = this.T3S11.getChild("T3S12");
		this.T3S13 = this.T3S12.getChild("T3S13");
		this.T3Tip3 = this.T3S13.getChild("T3Tip3");
		this.Tube5 = this.LeTubes.getChild("Tube5");
		this.T2S6 = this.Tube5.getChild("T2S6");
		this.T2S7 = this.T2S6.getChild("T2S7");
		this.T2S8 = this.T2S7.getChild("T2S8");
		this.T2S9 = this.T2S8.getChild("T2S9");
		this.T2Tip2 = this.T2S9.getChild("T2Tip2");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition burstspitterorganoid = partdefinition.addOrReplaceChild("burstspitterorganoid", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition base = burstspitterorganoid.addOrReplaceChild("base", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition ribJoint = FrontRibs.addOrReplaceChild("ribJoint", CubeListBuilder.create(), PartPose.offset(-0.2113F, -5.5914F, -6.8422F));

		PartDefinition Rib1 = ribJoint.addOrReplaceChild("Rib1", CubeListBuilder.create().texOffs(48, 118).addBox(-1.0F, -6.5F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.7854F, 0.2618F, 0.0F));

		PartDefinition Rib1Seg2 = Rib1.addOrReplaceChild("Rib1Seg2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -6.5F, 0.0F, -0.4363F, 0.0F, 0.0F));

		PartDefinition Rib1Seg3_r1 = Rib1Seg2.addOrReplaceChild("Rib1Seg3_r1", CubeListBuilder.create().texOffs(0, 121).addBox(-1.0F, -3.5F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0013F, -1.1F, -0.2F, 0.1833F, 0.0F, 0.0F));

		PartDefinition Rib1Seg2_r1 = Rib1Seg2.addOrReplaceChild("Rib1Seg2_r1", CubeListBuilder.create().texOffs(0, 121).addBox(-1.0F, -3.5F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(0.0013F, -7.5F, 0.0F, -0.3054F, 0.0F, 0.0F));

		PartDefinition ribJoint2 = FrontRibs.addOrReplaceChild("ribJoint2", CubeListBuilder.create(), PartPose.offset(-7.1F, -7.7F, -4.8F));

		PartDefinition Rib2 = ribJoint2.addOrReplaceChild("Rib2", CubeListBuilder.create().texOffs(48, 118).addBox(-1.0F, -6.5F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(0.7887F, 1.7086F, -0.2422F, 0.8737F, 0.721F, 0.024F));

		PartDefinition Rib2Seg2 = Rib2.addOrReplaceChild("Rib2Seg2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -6.5F, 0.0F, -0.8727F, 0.0F, 0.0F));

		PartDefinition Rib3Seg3_r1 = Rib2Seg2.addOrReplaceChild("Rib3Seg3_r1", CubeListBuilder.create().texOffs(0, 121).addBox(-1.0F, -3.5F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0013F, 0.0F, 0.2F, 0.2618F, 0.0F, 0.0F));

		PartDefinition Rib2Seg2_r1 = Rib2Seg2.addOrReplaceChild("Rib2Seg2_r1", CubeListBuilder.create().texOffs(0, 121).addBox(-1.0F, -3.5F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(0.0013F, -6.5F, 0.0F, -0.2182F, 0.0F, 0.0F));

		PartDefinition ribJoint3 = FrontRibs.addOrReplaceChild("ribJoint3", CubeListBuilder.create(), PartPose.offset(-11.9113F, -6.1914F, -3.2422F));

		PartDefinition Rib3 = ribJoint3.addOrReplaceChild("Rib3", CubeListBuilder.create().texOffs(48, 118).addBox(-1.0F, -6.5F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(1.0F, 0.0F, 1.0F, 1.6382F, 0.7753F, 0.3129F));

		PartDefinition Rib3Seg2 = Rib3.addOrReplaceChild("Rib3Seg2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -6.5F, 0.0F, -0.8727F, 0.0F, 0.0F));

		PartDefinition Rib3Seg3_r2 = Rib3Seg2.addOrReplaceChild("Rib3Seg3_r2", CubeListBuilder.create().texOffs(0, 121).addBox(-1.0F, -3.5F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0013F, -1.1F, -0.3F, 0.2182F, 0.0F, 0.0F));

		PartDefinition Rib3Seg2_r1 = Rib3Seg2.addOrReplaceChild("Rib3Seg2_r1", CubeListBuilder.create().texOffs(0, 121).addBox(-1.0F, -3.5F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(0.0013F, -7.5F, 0.0F, -0.3054F, 0.0F, 0.0F));

		PartDefinition BackRibs = Ribs.addOrReplaceChild("BackRibs", CubeListBuilder.create(), PartPose.offset(-5.0F, 0.0F, 1.1F));
		...
		PartDefinition Rib4 = ribJoint4.addOrReplaceChild("Rib4", CubeListBuilder.create().texOffs(48, 118).addBox(-1.0F, -6.5F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(0.4225F, 0.0F, 0.4843F, -1.2796F, 0.5138F, 0.077F));

		PartDefinition Rib4Seg2 = Rib4.addOrReplaceChild("Rib4Seg2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -6.5F, 0.0F, 0.4363F, 0.0F, 0.0F));

		PartDefinition Rib4Seg3_r1 = Rib4Seg2.addOrReplaceChild("Rib4Seg3_r1", CubeListBuilder.create().texOffs(0, 121).addBox(-1.0F, -3.5F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(-0.0013F, -0.1F, 0.2F, -0.1222F, 0.0F, 0.0F));

		PartDefinition Rib4Seg2_r1 = Rib4Seg2.addOrReplaceChild("Rib4Seg2_r1", CubeListBuilder.create().texOffs(0, 121).addBox(-1.0F, -3.5F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(-0.0013F, -6.5F, 0.0F, 0.1745F, 0.0F, 0.0F));

		PartDefinition ribJoint5 = BackRibs.addOrReplaceChild("ribJoint5", CubeListBuilder.create(), PartPose.offset(4.7887F, -5.2914F, 4.1578F));

		PartDefinition Rib5 = ribJoint5.addOrReplaceChild("Rib5", CubeListBuilder.create().texOffs(48, 118).addBox(-1.0F, -6.5F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(0.4225F, 0.0F, 0.4843F, -0.8737F, 0.721F, -0.024F));

		PartDefinition Rib5Seg2 = Rib5.addOrReplaceChild("Rib5Seg2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -6.5F, 0.0F, 0.8727F, 0.0F, 0.0F));

		PartDefinition Rib5Seg3_r1 = Rib5Seg2.addOrReplaceChild("Rib5Seg3_r1", CubeListBuilder.create().texOffs(0, 121).addBox(-1.0F, -3.5F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(-0.0013F, -0.2F, 0.3F, -0.0873F, 0.0F, 0.0F));

		PartDefinition Rib5Seg2_r1 = Rib5Seg2.addOrReplaceChild("Rib5Seg2_r1", CubeListBuilder.create().texOffs(0, 121).addBox(-1.0F, -3.5F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(-0.0013F, -6.5F, 0.0F, 0.1745F, 0.0F, 0.0F));
		...
		PartDefinition Rib6 = ribJoint6.addOrReplaceChild("Rib6", CubeListBuilder.create().texOffs(48, 118).addBox(-1.0F, -6.5F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(-0.5775F, 0.0F, -0.5157F, -1.6382F, 0.7753F, -0.3129F));

		PartDefinition Rib6Seg2 = Rib6.addOrReplaceChild("Rib6Seg2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -6.5F, 0.0F, 0.8727F, 0.0F, 0.0F));

		PartDefinition Rib6Seg3_r1 = Rib6Seg2.addOrReplaceChild("Rib6Seg3_r1", CubeListBuilder.create().texOffs(0, 121).addBox(-1.0F, -3.5F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(-0.0013F, 0.0F, 0.3F, -0.0436F, 0.0F, 0.0F));

		PartDefinition Rib6Seg2_r1 = Rib6Seg2.addOrReplaceChild("Rib6Seg2_r1", CubeListBuilder.create().texOffs(0, 121).addBox(-1.0F, -3.5F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(-0.0013F, -6.5F, 0.0F, 0.1745F, 0.0F, 0.0F));

		PartDefinition ribJoint7 = BackRibs.addOrReplaceChild("ribJoint7", CubeListBuilder.create(), PartPose.offset(12.7887F, -5.4914F, -0.2422F));

		PartDefinition Rib7 = ribJoint7.addOrReplaceChild("Rib7", CubeListBuilder.create().texOffs(48, 118).addBox(-1.0F, -6.5F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(0.4225F, 0.0F, 0.4843F, -1.3531F, 1.0133F, 0.3947F));

		PartDefinition Rib6Seg3 = Rib7.addOrReplaceChild("Rib6Seg3", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, -6.5F, 0.0F, 1.0873F, 0.116F, -0.0607F));

		PartDefinition Rib6Seg4_r1 = Rib6Seg3.addOrReplaceChild("Rib6Seg4_r1", CubeListBuilder.create().texOffs(0, 121).addBox(-1.0F, -3.5F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(-0.0013F, 0.1F, -0.1F, -0.1571F, 0.0F, 0.0F));

		PartDefinition Rib6Seg3_r2 = Rib6Seg3.addOrReplaceChild("Rib6Seg3_r2", CubeListBuilder.create().texOffs(0, 121).addBox(-1.0F, -3.5F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(-0.0013F, -6.5F, 0.0F, 0.1309F, 0.0F, 0.0F));
		...
		PartDefinition OrganoidSeg1 = burstspitterorganoid.addOrReplaceChild("OrganoidSeg1", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition FungalFan_r1 = OrganoidSeg3.addOrReplaceChild("FungalFan_r1", CubeListBuilder.create().texOffs(41, 72).addBox(-3.5F, 1.0F, -4.0F, 7.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.1F, -9.8488F, 5.0527F, -0.3237F, 0.1332F, -0.3917F));
		...
		PartDefinition Crown_r13 = FungusCrown1.addOrReplaceChild("Crown_r13", CubeListBuilder.create().texOffs(41, 72).addBox(-3.5F, 1.0F, -4.0F, 7.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.5F, -11.0942F, -0.1997F, -0.2006F, 0.1065F, -0.5297F));

		PartDefinition Crown_r14 = FungusCrown1.addOrReplaceChild("Crown_r14", CubeListBuilder.create().texOffs(41, 72).addBox(-3.5F, 1.0F, -4.0F, 7.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.2F, -12.6942F, -7.5997F, 0.3921F, 0.3709F, 0.2337F));

		PartDefinition Crown_r15 = FungusCrown1.addOrReplaceChild("Crown_r15", CubeListBuilder.create().texOffs(41, 72).addBox(-3.5F, 1.0F, -4.0F, 7.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.0F, -13.9942F, -1.0997F, 0.5025F, 0.4203F, 0.3468F));

		PartDefinition Crown_r16 = FungusCrown1.addOrReplaceChild("Crown_r16", CubeListBuilder.create().texOffs(29, 0).addBox(-3.0F, 0.0F, -2.75F, 7.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.3105F, -12.4409F, -9.0523F, -0.1396F, -0.9008F, -0.2761F));

		PartDefinition Crown_r17 = FungusCrown1.addOrReplaceChild("Crown_r17", CubeListBuilder.create().texOffs(41, 56).addBox(-3.5F, 1.0F, -4.5F, 7.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.2F, -11.8F, -8.7F, 0.4865F, 0.2612F, -0.1612F));

		PartDefinition Crown_r18 = FungusCrown1.addOrReplaceChild("Crown_r18", CubeListBuilder.create().texOffs(41, 56).addBox(-3.5F, 1.0F, -4.5F, 7.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5F, -13.0F, -7.5F, -0.3415F, 0.456F, -0.1553F));

		PartDefinition Crown_r19 = FungusCrown1.addOrReplaceChild("Crown_r19", CubeListBuilder.create().texOffs(41, 72).addBox(-3.5F, 0.0F, -3.5F, 7.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5F, -13.0F, -3.5F, 0.4461F, -0.4802F, -0.2174F));
		...
		PartDefinition FungalFan_r2 = Left.addOrReplaceChild("FungalFan_r2", CubeListBuilder.create().texOffs(48, 72).addBox(-1.2642F, -3.4635F, 0.5F, 7.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.6F, -5.1F, -3.7F, 1.0429F, -0.2751F, 2.8824F));

		PartDefinition FungalFan_r3 = Left.addOrReplaceChild("FungalFan_r3", CubeListBuilder.create().texOffs(48, 72).addBox(-1.2642F, -3.4635F, 0.5F, 7.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5F, 0.5F, 0.0F, 0.0F, -0.3054F, -0.48F));
		...
		PartDefinition FungalFan4_r1 = Right.addOrReplaceChild("FungalFan4_r1", CubeListBuilder.create().texOffs(41, 56).addBox(-3.5F, 1.0F, -4.5F, 7.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, -2.4284F, -2.2F, 0.7857F, 0.5936F, 0.0517F));

		PartDefinition FungalFan3_r1 = Right.addOrReplaceChild("FungalFan3_r1", CubeListBuilder.create().texOffs(41, 56).addBox(-3.5F, 1.0F, -4.5F, 7.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.8F, -1.1284F, -2.1F, 0.4727F, 0.4025F, -0.5105F));

		PartDefinition FungalFan2_r1 = Right.addOrReplaceChild("FungalFan2_r1", CubeListBuilder.create().texOffs(41, 56).addBox(-3.5F, 1.0F, -4.5F, 7.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.3F, -5.8284F, -1.5F, 0.3205F, 0.3239F, -0.2041F));

		PartDefinition FungalFan1_r1 = Right.addOrReplaceChild("FungalFan1_r1", CubeListBuilder.create().texOffs(48, 56).addBox(-3.5F, -3.5F, 0.75F, 7.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.75F, 1.25F, 1.0F, -0.1122F, 0.0834F, 0.6812F));
		...
		PartDefinition Tube1 = LeTubes.addOrReplaceChild("Tube1", CubeListBuilder.create().texOffs(0, 24).addBox(-1.5F, -1.5F, -2.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(-2.0F, 0.5F, -3.8F, 0.3887F, 0.1662F, -0.1245F));

		PartDefinition T2S2 = Tube1.addOrReplaceChild("T2S2", CubeListBuilder.create().texOffs(12, 24).addBox(-1.4456F, -1.2136F, -1.0721F, 3.0F, 3.0F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(0.0F, -0.4F, -2.0F, -0.3054F, 0.0131F, -0.0436F));
		...
		PartDefinition T2S5 = T2S4.addOrReplaceChild("T2S5", CubeListBuilder.create().texOffs(18, 29).addBox(-1.5395F, -1.6038F, -2.2068F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(0.0F, 0.0F, -1.5F, -0.2182F, -0.0113F, -0.0421F));

		PartDefinition T2Tip = T2S5.addOrReplaceChild("T2Tip", CubeListBuilder.create().texOffs(56, 11).addBox(-1.0395F, -1.6038F, -2.2068F, 2.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F))
		.texOffs(56, 11).addBox(-1.0395F, 0.3962F, -2.2068F, 2.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F))
		.texOffs(62, 10).addBox(-1.5395F, -1.1038F, -2.2068F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.25F))
		.texOffs(62, 10).addBox(0.4605F, -1.1038F, -2.2068F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.25F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition Tube2 = LeTubes.addOrReplaceChild("Tube2", CubeListBuilder.create().texOffs(0, 24).addBox(-1.5F, -1.5F, -2.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(-0.1F, 0.2F, -3.5F, 0.6065F, 0.2443F, 0.2486F));

		PartDefinition T3S6 = Tube2.addOrReplaceChild("T3S6", CubeListBuilder.create().texOffs(12, 24).addBox(-1.4456F, -1.2136F, -1.0721F, 3.0F, 3.0F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(0.0F, -0.4F, -2.0F, -0.3054F, 0.0131F, -0.0436F));

		PartDefinition T3S7 = T3S6.addOrReplaceChild("T3S7", CubeListBuilder.create().texOffs(36, 116).addBox(-1.4369F, -1.586F, -2.2278F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(0.0F, 0.3F, 0.075F, 0.0F, -0.2715F, 0.0702F));

		PartDefinition T3S8 = T3S7.addOrReplaceChild("T3S8", CubeListBuilder.create().texOffs(23, 35).addBox(-1.5F, -1.5185F, -1.9194F, 3.0F, 3.0F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(-0.0369F, 0.064F, -0.9778F, -0.2182F, -0.2182F, -0.0175F));

		PartDefinition T3S9 = T3S8.addOrReplaceChild("T3S9", CubeListBuilder.create().texOffs(18, 29).addBox(-1.5395F, -1.6038F, -2.2067F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(0.0F, 0.0F, -1.5F, -0.2182F, -0.0113F, -0.0421F));

		PartDefinition T3Tip2 = T3S9.addOrReplaceChild("T3Tip2", CubeListBuilder.create().texOffs(56, 11).addBox(-1.0395F, -1.6038F, -2.2067F, 2.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F))
		...
		PartDefinition Tube3 = LeTubes.addOrReplaceChild("Tube3", CubeListBuilder.create().texOffs(0, 24).addBox(-1.5F, -1.5F, -2.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(2.9F, 0.5F, -4.0F, 0.3887F, 0.1662F, -0.1245F));
		...
		PartDefinition Tube4 = LeTubes.addOrReplaceChild("Tube4", CubeListBuilder.create().texOffs(0, 24).addBox(-1.5F, -1.5F, -2.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(0.0F, 2.1F, -5.2F, 1.7251F, 0.7369F, 0.4529F));

		PartDefinition T3S10 = Tube4.addOrReplaceChild("T3S10", CubeListBuilder.create().texOffs(12, 24).addBox(-1.4456F, -1.2136F, -1.0721F, 3.0F, 3.0F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(0.0F, -0.4F, -2.0F, -0.3054F, 0.0131F, -0.0436F));

		PartDefinition T3S11 = T3S10.addOrReplaceChild("T3S11", CubeListBuilder.create().texOffs(36, 116).addBox(-1.4369F, -1.586F, -2.2278F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(0.0F, 0.3F, 0.075F, 0.0F, -0.2715F, 0.0702F));

		PartDefinition T3S12 = T3S11.addOrReplaceChild("T3S12", CubeListBuilder.create().texOffs(23, 35).addBox(-1.5F, -1.5186F, -1.9194F, 3.0F, 3.0F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(-0.0369F, 0.064F, -0.9778F, -0.2182F, -0.2182F, -0.0175F));

		PartDefinition T3S13 = T3S12.addOrReplaceChild("T3S13", CubeListBuilder.create().texOffs(18, 29).addBox(-1.5395F, -1.6038F, -2.2067F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(0.0F, 0.0F, -1.5F, -0.2182F, -0.0113F, -0.0421F));

		PartDefinition T3Tip3 = T3S13.addOrReplaceChild("T3Tip3", CubeListBuilder.create().texOffs(56, 11).addBox(-1.0395F, -1.6038F, -2.2067F, 2.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F))
		.texOffs(56, 11).addBox(-1.0395F, 0.3962F, -2.2067F, 2.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F))
		.texOffs(62, 10).addBox(-1.5395F, -1.1038F, -2.2067F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.25F))
		.texOffs(62, 10).addBox(0.4605F, -1.1038F, -2.2067F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.25F)), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition Tube5 = LeTubes.addOrReplaceChild("Tube5", CubeListBuilder.create().texOffs(0, 24).addBox(-1.5F, -1.5F, -2.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(1.3F, 1.5F, -4.1F, 0.6449F, 0.0045F, -0.1904F));

		PartDefinition T2S6 = Tube5.addOrReplaceChild("T2S6", CubeListBuilder.create().texOffs(12, 24).addBox(-1.4456F, -1.2136F, -1.0721F, 3.0F, 3.0F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(0.0F, -0.4F, -2.0F, -0.3054F, 0.0131F, -0.0436F));

		PartDefinition T2S7 = T2S6.addOrReplaceChild("T2S7", CubeListBuilder.create().texOffs(36, 116).addBox(-1.4369F, -1.586F, -2.2278F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(0.0F, 0.3F, 0.075F, 0.5847F, 0.2715F, 0.0702F));

		PartDefinition T2S8 = T2S7.addOrReplaceChild("T2S8", CubeListBuilder.create().texOffs(23, 35).addBox(-1.5F, -1.5186F, -1.9194F, 3.0F, 3.0F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(0.0631F, 0.064F, -0.9778F, -0.2182F, 0.0F, -0.0175F));

		PartDefinition T2S9 = T2S8.addOrReplaceChild("T2S9", CubeListBuilder.create().texOffs(18, 29).addBox(-1.5395F, -1.6038F, -2.2067F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(0.0F, 0.0F, -1.5F, -0.2182F, -0.0113F, -0.0421F));

		PartDefinition T2Tip2 = T2S9.addOrReplaceChild("T2Tip2", CubeListBuilder.create().texOffs(56, 11).addBox(-1.0395F, -1.6038F, -2.2067F, 2.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F))
		.texOffs(56, 11).addBox(-1.0395F, 0.3962F, -2.2067F, 2.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F))
		.texOffs(62, 10).addBox(-1.5395F, -1.1038F, -2.2067F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.25F))
		.texOffs(62, 10).addBox(0.4605F, -1.1038F, -2.2067F, 1.0F, 2.0F, 1.0F, new CubeDeformation(-0.25F)), PartPose.offset(0.0F, 0.0F, 0.0F));
	...
	public void animateTubes2(ModelPart part,float val){
		this.animateTentacleX(part,val);
		this.animateTentacleZ(part,val);
	}
	@Override
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animateTubes1(Tube1,-Mth.cos(ageInTicks/4)/6);
		this.animateTubes2(Tube2,Mth.cos(ageInTicks/5)/6);
		this.animateTubes1(Tube3,Mth.sin(ageInTicks/4)/5);
		this.animateTubes2(Tube4,Mth.cos(ageInTicks/6)/4);
		this.animateTubes1(Tube5,Mth.sin(ageInTicks/5)/5);
	}

	@Override
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float r,float g,float b, float alpha) {
		burstspitterorganoid.render(poseStack, vertexConsumer, packedLight, packedOverlay, r, g, b,  alpha);
	}
}