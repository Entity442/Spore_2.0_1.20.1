...
public class Seg4<T extends Entity> extends EntityModel<T> implements TentacledModel{
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Spore.MODID, "seg4"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Fin = partdefinition.addOrReplaceChild("Fin", CubeListBuilder.create().texOffs(44, 4).addBox(-14.0F, -19.0F, 0.0F, 10.0F, 21.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 24.0F, 0.0F, 0.0F, 3.1416F, 0.0F));
	...
	public void setupAnim(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		animateTentacleZ(Tendril1,Mth.sin(ageInTicks/7)/6);
		animateTentacleZ(Tendril3,Mth.cos(ageInTicks/5)/6);
		animateTentacleY(Fin,Mth.cos(ageInTicks/8)/8);
	}
