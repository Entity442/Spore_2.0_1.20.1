...
public class AcidicAssasinModel<T extends LivingEntity> extends EntityModel<T> implements TentacledModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Caspian = partdefinition.addOrReplaceChild("Caspian", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity instanceof Player player){
			...
			this.Caspian.z = this.Caspian.getInitialPose().z +(anim * 6);
