...
public class BileBlasterModel<T extends LivingEntity> extends EntityModel<T> implements TentacledModel {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Spore.MODID, "bileblastermodel"), "main");
	public final ModelPart Bile_Blaster;
	private final ModelPart rotation;
	private final ModelPart innards;
	private final ModelPart head;
	private final ModelPart jaw;
	private final ModelPart bileAmmo;
	...
	public BileBlasterModel() {
		...
		this.rotation = this.Bile_Blaster.getChild("rotation");
		this.innards = this.rotation.getChild("innards");
		this.head = this.innards.getChild("head");
		this.jaw = this.head.getChild("jaw");
		this.bileAmmo = this.head.getChild("bileAmmo");
		...
		this.barrel = this.rotation.getChild("barrel");
		this.body = this.rotation.getChild("body");
		this.underbarre_and_grip = this.rotation.getChild("underbarre_and_grip");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition rotation = Bile_Blaster.addOrReplaceChild("rotation", CubeListBuilder.create(), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 1.5708F, 0.0F));

		PartDefinition innards = rotation.addOrReplaceChild("innards", CubeListBuilder.create().texOffs(84, 46).addBox(-25.0F, -1.0F, -9.0F, 9.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition bileAmmo = head.addOrReplaceChild("bileAmmo", CubeListBuilder.create(), PartPose.offset(-30.0F, -4.5F, 1.0F));

		PartDefinition cube_r12 = bileAmmo.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(208, 0).addBox(-10.7321F, 2.7189F, -9.0F, 16.0F, 0.0F, 16.0F, new CubeDeformation(-3.0F)), PartPose.offsetAndRotation(-2.0F, -0.5F, 0.0F, 0.0F, 0.0F, 0.4363F));

		PartDefinition stomach = innards.addOrReplaceChild("stomach", CubeListBuilder.create(), PartPose.offset(-0.5F, -0.25F, 0.5F));

		PartDefinition cube_r13 = stomach.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(0, 56).addBox(-12.0F, -1.0F, -1.0F, 23.0F, 10.0F, 10.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.7854F, 0.0F, 0.0F));

		PartDefinition tumor3 = innards.addOrReplaceChild("tumor3", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, -2.0F));

		PartDefinition cube_r14 = tumor3.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(50, 99).addBox(-1.0F, -3.0F, -1.0F, 3.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.1745F, 0.0F, -0.3054F));

		PartDefinition tumor = innards.addOrReplaceChild("tumor", CubeListBuilder.create(), PartPose.offset(1.0F, 0.0F, 4.0F));

		PartDefinition cube_r15 = tumor.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(114, 115).addBox(-3.0F, 0.0F, 0.0F, 6.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.0F, -1.0F, 2.0F, 1.6144F, 0.3491F, 0.0F));

		PartDefinition cube_r16 = tumor.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(114, 115).addBox(-3.0F, 0.0F, 0.0F, 6.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.0F, -1.0F, 2.0F, 1.1781F, 0.3491F, 0.0F));

		PartDefinition cube_r17 = tumor.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(114, 115).addBox(-3.0F, 0.0F, 0.0F, 6.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.0F, -1.0F, 2.0F, 0.2182F, 0.3491F, 0.0F));

		PartDefinition cube_r18 = tumor.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(114, 115).addBox(-3.0F, 0.0F, 0.0F, 6.0F, 0.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.0F, -1.0F, 2.0F, 0.7418F, 0.3491F, 0.0F));

		PartDefinition cube_r19 = tumor.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(70, 78).addBox(-7.0F, -4.0F, -2.0F, 10.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, 2.0F, -1.0F, -0.1468F, -0.1128F, 0.1306F));

		PartDefinition cube_r20 = tumor.addOrReplaceChild("cube_r20", CubeListBuilder.create().texOffs(60, 97).addBox(-3.0F, -4.0F, -4.0F, 7.0F, 7.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.5672F, 0.0F));

		PartDefinition tumor2 = innards.addOrReplaceChild("tumor2", CubeListBuilder.create(), PartPose.offset(-5.0F, 0.0F, -2.0F));

		PartDefinition cube_r21 = tumor2.addOrReplaceChild("cube_r21", CubeListBuilder.create().texOffs(116, 27).addBox(-5.0F, -4.0F, -1.0F, 6.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3124F, 0.2079F, 0.0666F));

		PartDefinition barrel = rotation.addOrReplaceChild("barrel", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r22 = barrel.addOrReplaceChild("cube_r22", CubeListBuilder.create().texOffs(66, 66).addBox(-44.0F, -3.5F, -3.5F, 16.0F, 6.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(68.0F, -0.75F, 0.5F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r23 = barrel.addOrReplaceChild("cube_r23", CubeListBuilder.create().texOffs(0, 0).addBox(-44.0F, -1.5F, -1.5F, 58.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(10.0F, -2.25F, 0.5F, -0.7854F, 0.0F, 0.0F));

		PartDefinition body = rotation.addOrReplaceChild("body", CubeListBuilder.create().texOffs(120, 87).addBox(11.0F, -4.75F, -0.5F, 7.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r24 = body.addOrReplaceChild("cube_r24", CubeListBuilder.create().texOffs(70, 46).addBox(-1.0F, -1.0F, -1.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(11.5F, -5.0F, 0.5F, -0.7854F, 0.0F, 0.0F));

		PartDefinition underbarre_and_grip = rotation.addOrReplaceChild("underbarre_and_grip", CubeListBuilder.create().texOffs(70, 29).addBox(-32.0F, -1.0F, -1.0F, 20.0F, 6.0F, 3.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r25 = underbarre_and_grip.addOrReplaceChild("cube_r25", CubeListBuilder.create().texOffs(84, 53).addBox(-7.0F, -1.0F, -1.0F, 9.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-21.0F, 8.45F, 0.4F, 0.0F, 0.0F, 0.1745F));

		PartDefinition cube_r26 = underbarre_and_grip.addOrReplaceChild("cube_r26", CubeListBuilder.create().texOffs(24, 103).addBox(-0.5F, -1.0F, -1.0F, 1.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-15.7F, 5.0F, 0.5F, 0.0F, 0.0F, 0.829F));

		PartDefinition cube_r27 = underbarre_and_grip.addOrReplaceChild("cube_r27", CubeListBuilder.create().texOffs(102, 78).addBox(-1.0F, -7.0F, -1.0F, 5.0F, 13.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-32.0F, 8.0F, -0.6F, 0.0F, 0.0F, 0.6981F));

		PartDefinition cube_r28 = underbarre_and_grip.addOrReplaceChild("cube_r28", CubeListBuilder.create().texOffs(32, 99).addBox(-2.0F, -7.0F, -1.0F, 6.0F, 14.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-31.25F, 7.75F, -0.1F, 0.0F, 0.0F, 0.6981F));
		...
		PartDefinition cube_r29 = trigger.addOrReplaceChild("cube_r29", CubeListBuilder.create().texOffs(38, 76).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-21.85F, 6.55F, 0.9F, 0.0F, 0.0F, 0.1745F));

		PartDefinition cube_r30 = trigger.addOrReplaceChild("cube_r30", CubeListBuilder.create().texOffs(76, 46).addBox(-0.5F, -1.5F, -0.5F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-23.0F, 4.75F, 0.5F, 0.0F, 0.0F, -0.4363F));
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		if (entity instanceof Player player){
			...
			this.bileAmmo.y = this.bileAmmo.getInitialPose().y -(reloadAnim * 0.5f);
			this.bileAmmo.x = this.bileAmmo.getInitialPose().x -(reloadAnim * 0.5f);
			this.bileAmmo.visible = reloadAnim > 0;
			if (reloadAnim > 0){
				animateTentacleZ(jaw,Mth.sin(ageInTicks)/4);
			}
		}
	}
