package com.Harbinger.Spore.Client.Models;// Made with Blockbench 4.9.2
...
public class InfectedHazmatModel<T extends InfectedHazmat> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Spore.MODID, "infected_hazmat"), "main");
	...
	private final ModelPart BackFungi1;
	private final ModelPart BackFungi2;
	...
	public InfectedHazmatModel(ModelPart root) {
		...
		this.Tumor = TorsoBase.getChild("TorsoTop").getChild("TorsoWound").getChild("Tumor");
		this.BackFungi1 = TorsoBase.getChild("TorsoTop").getChild("TorsoWound").getChild("Fungy").getChild("torsotendie1");
		this.BackFungi2 = TorsoBase.getChild("TorsoTop").getChild("TorsoWound").getChild("Fungy").getChild("torsotendie2");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition TorsoWound = TorsoTop.addOrReplaceChild("TorsoWound", CubeListBuilder.create(), PartPose.offset(0.0F, 17.5F, 0.0F));

		PartDefinition Fungy = TorsoWound.addOrReplaceChild("Fungy", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition torsotendie1 = Fungy.addOrReplaceChild("torsotendie1", CubeListBuilder.create().texOffs(57, 60).addBox(-1.1503F, -1.0981F, -1.5333F, 2.0F, 2.0F, 4.0F, new CubeDeformation(-0.4F)), PartPose.offsetAndRotation(1.25F, -19.0F, 2.5F, -0.2072F, 0.3053F, 0.3825F));

		PartDefinition Torsotendril1seg1 = torsotendie1.addOrReplaceChild("Torsotendril1seg1", CubeListBuilder.create(), PartPose.offset(-0.1503F, -0.0981F, 1.9667F));

		PartDefinition tendril1seg1_r1 = Torsotendril1seg1.addOrReplaceChild("tendril1seg1_r1", CubeListBuilder.create().texOffs(58, 51).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 4.0F, new CubeDeformation(-0.6F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2182F, 0.1745F, 0.0F));

		PartDefinition torsotendie2 = Fungy.addOrReplaceChild("torsotendie2", CubeListBuilder.create().texOffs(58, 42).addBox(-0.9534F, -0.9822F, -1.5025F, 2.0F, 2.0F, 4.0F, new CubeDeformation(-0.6F)), PartPose.offsetAndRotation(0.0F, -19.0F, 2.5F, 0.2103F, -0.0933F, -0.2196F));

		PartDefinition Torsotendril2seg1 = torsotendie2.addOrReplaceChild("Torsotendril2seg1", CubeListBuilder.create(), PartPose.offset(0.0466F, 0.0178F, 1.7475F));

		PartDefinition tendril2seg1_r1 = Torsotendril2seg1.addOrReplaceChild("tendril2seg1_r1", CubeListBuilder.create().texOffs(21, 64).addBox(-1.042F, -1.0335F, -0.7627F, 2.0F, 2.0F, 4.0F, new CubeDeformation(-0.7F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.41F, -0.2329F, -0.1312F));

		PartDefinition Tumor = TorsoWound.addOrReplaceChild("Tumor", CubeListBuilder.create(), PartPose.offset(1.2036F, -17.847F, 2.4435F));

		PartDefinition Tumor2_r1 = Tumor.addOrReplaceChild("Tumor2_r1", CubeListBuilder.create().texOffs(66, 41).addBox(-1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0127F, 0.749F, -0.2982F, 0.4382F, 0.5276F, -1.3369F));

		PartDefinition Tumor1_r1 = Tumor.addOrReplaceChild("Tumor1_r1", CubeListBuilder.create().texOffs(28, 37).addBox(-0.25F, -1.5F, -3.45F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.7036F, 1.347F, 1.0565F, -0.4064F, -0.4073F, -0.744F));
		...
		PartDefinition tendril1Seg1_r2 = tendril1Seg1.addOrReplaceChild("tendril1Seg1_r2", CubeListBuilder.create().texOffs(62, 2).addBox(-0.9753F, -1.0782F, -3.2721F, 2.0F, 2.0F, 4.0F, new CubeDeformation(-0.6F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.0116F, 0.0779F, -0.2956F));
		...
		PartDefinition tendril2Seg1_r2 = tendril2Seg1.addOrReplaceChild("tendril2Seg1_r2", CubeListBuilder.create().texOffs(64, 37).addBox(-0.5074F, -0.5212F, -3.0093F, 1.0F, 1.0F, 3.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(-0.021F, 0.2018F, -0.2099F, -0.0116F, 0.0779F, -0.2956F));
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.BackFungi1.yRot = 0.5f+Mth.sin(ageInTicks/5)/8;
		this.BackFungi2.yRot = -Mth.sin(ageInTicks/8)/6;
		this.BackFungi1.getChild("Torsotendril1seg1").xRot = Mth.sin(ageInTicks/5)/6;
		this.BackFungi2.getChild("Torsotendril2seg1").yRot = -Mth.sin(ageInTicks/5)/5;
