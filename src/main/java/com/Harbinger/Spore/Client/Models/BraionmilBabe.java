...
public class BraionmilBabe<T extends Braionmil> extends EntityModel<T> {
	...
	public BraionmilBabe(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Boobs = spine2.addOrReplaceChild("Boobs", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition BoobLeft_r1 = Boobs.addOrReplaceChild("BoobLeft_r1", CubeListBuilder.create().texOffs(0, 69).mirror().addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.2F)).mirror(false), PartPose.offsetAndRotation(1.4949F, -2.8188F, -3.7796F, -0.4498F, -0.2342F, 0.1179F));

		PartDefinition BoobRight_r1 = Boobs.addOrReplaceChild("BoobRight_r1", CubeListBuilder.create().texOffs(0, 69).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(-1.4949F, -2.8188F, -3.7796F, -0.4498F, 0.2342F, -0.1179F));
		...
		PartDefinition tongue = tongueM.addOrReplaceChild("tongue", CubeListBuilder.create().texOffs(0, 25).addBox(-2.0F, -0.5F, -6.0F, 4.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.4363F, 0.0F, 0.0F));

		PartDefinition tongueM2 = tongue.addOrReplaceChild("tongueM2", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, -6.0F));

		PartDefinition tongue2 = tongueM2.addOrReplaceChild("tongue2", CubeListBuilder.create().texOffs(39, 11).addBox(-1.5F, -0.5F, -6.0F, 3.0F, 1.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.0472F, 0.0F, 0.0F));
		...
		PartDefinition cube_r10 = lungs4.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(56, 55).addBox(-3.5F, 0.0F, -3.0F, 7.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.8992F, 8.2908F, 4.0F, 0.0F, 0.0F, 0.3491F));
