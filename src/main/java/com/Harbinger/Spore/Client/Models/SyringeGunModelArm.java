...
public class SyringeGunModelArm<T extends LivingEntity> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r2 = syringeGun.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(62, 102).addBox(-2.0F, -3.0F, -1.5F, 2.0F, 12.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.1F, -4.0F, 3.25F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r3 = syringeGun.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 38).addBox(-2.5F, -1.5F, -29.0F, 3.0F, 3.0F, 33.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -10.5F, -29.5F, 0.0F, 0.0F, -0.7854F));

		PartDefinition cube_r4 = syringeGun.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(98, 75).addBox(-2.5F, -1.5F, -1.0F, 3.0F, 3.0F, 9.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -11.5F, 2.0F, 0.0F, 0.0F, 0.7854F));

		PartDefinition power = syringeGun.addOrReplaceChild("power", CubeListBuilder.create().texOffs(0, 0).addBox(-2.0F, -1.5F, -2.0F, 2.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -10.0F, -12.0F));
		...
		PartDefinition magazine = syringeGun.addOrReplaceChild("magazine", CubeListBuilder.create().texOffs(78, 0).addBox(-6.0F, -5.0F, -2.0F, 10.0F, 10.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(0, 90).addBox(-6.5F, -5.5F, -1.5F, 11.0F, 11.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -6.0F, -18.25F, 0.0F, 0.0F, 0.7854F));
