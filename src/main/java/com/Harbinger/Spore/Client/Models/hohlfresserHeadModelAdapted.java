...
public class hohlfresserHeadModelAdapted<T extends Hohlfresser> extends EntityModel<T> implements TentacledModel{
	...
	public hohlfresserHeadModelAdapted() {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Npetal_r1 = FungalBloom.addOrReplaceChild("Npetal_r1", CubeListBuilder.create().texOffs(-16, 524).addBox(-16.8501F, -0.8001F, -17.6583F, 16.0F, 0.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(11.2033F, -1.9197F, -14.9924F, -1.1581F, 1.0261F, -1.1244F));

		PartDefinition Spetal_r1 = FungalBloom.addOrReplaceChild("Spetal_r1", CubeListBuilder.create().texOffs(-16, 511).addBox(-7.3501F, -4.4739F, -6.5275F, 16.0F, 0.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.9967F, 5.5803F, 9.2076F, 1.6549F, -1.1766F, -1.6618F));
		...
		PartDefinition Epetal_r1 = FungalBloom.addOrReplaceChild("Epetal_r1", CubeListBuilder.create().texOffs(-16, 539).addBox(-11.383F, -3.4789F, -8.3583F, 16.0F, 0.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-13.7967F, 2.1803F, -0.9924F, -3.1416F, 0.0F, -2.7489F));
		...
		PartDefinition bone = Front.addOrReplaceChild("bone", CubeListBuilder.create(), PartPose.offset(49.35F, -32.4284F, 1.0615F));

		PartDefinition cube_r1 = bone.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(645, 330).addBox(-22.0F, -16.0F, -15.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-41.1F, 38.2F, 14.1F, 0.4141F, -0.5316F, -1.7998F));

		PartDefinition cube_r2 = bone.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(645, 330).addBox(-22.0F, -16.0F, -15.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-28.5F, 14.9F, 23.5F, -0.1216F, -0.0719F, -0.2426F));

		PartDefinition cube_r3 = bone.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(645, 330).addBox(-22.0F, -16.0F, -15.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(-1.0F)), PartPose.offsetAndRotation(-36.6F, 23.8F, 17.1F, -0.395F, -0.5973F, 0.5143F));

		PartDefinition cube_r4 = bone.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(645, 330).addBox(-22.0F, -16.0F, -15.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(-1.5F)), PartPose.offsetAndRotation(5.0F, 15.1F, 40.7F, 0.0687F, -0.2721F, 0.2302F));

		PartDefinition cube_r5 = bone.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(645, 330).addBox(-22.0F, -16.0F, -15.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(-1.2F)), PartPose.offsetAndRotation(-3.5F, 21.2F, -0.1F, -1.6281F, -0.5759F, 2.7308F));

		PartDefinition cube_r6 = bone.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(645, 330).addBox(-22.0F, -16.0F, -15.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(-0.9F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.4881F, -0.2528F, -2.5587F));
		...
		PartDefinition NPetal_r2 = Bloom.addOrReplaceChild("NPetal_r2", CubeListBuilder.create().texOffs(-16, 524).addBox(-7.4F, -4.0564F, -9.2069F, 16.0F, 0.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.6F, 3.9676F, -10.6F, -1.5708F, 1.1781F, -1.5708F));

		PartDefinition SPetal_r2 = Bloom.addOrReplaceChild("SPetal_r2", CubeListBuilder.create().texOffs(-16, 511).addBox(-7.7F, -5.2045F, -9.5648F, 16.0F, 0.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.3F, 3.9676F, 12.7F, 1.6965F, -1.1748F, -1.7069F));

		PartDefinition WPetal_r2 = Bloom.addOrReplaceChild("WPetal_r2", CubeListBuilder.create().texOffs(-16, 555).addBox(3.0F, 0.0F, 0.0F, 16.0F, 0.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.6676F, -8.0F, 0.0F, 0.0F, -0.3927F));

		PartDefinition EPetal_r2 = Bloom.addOrReplaceChild("EPetal_r2", CubeListBuilder.create().texOffs(-16, 539).addBox(-9.7612F, -3.8268F, -8.5F, 16.0F, 0.0F, 16.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-12.5F, 2.9676F, 0.5F, 3.1416F, 0.0F, -2.7489F));
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay,float r,float g,float b, float alpha) {
		hohl_head.render(poseStack, vertexConsumer, packedLight, packedOverlay,r,g,b, alpha);
	}
}