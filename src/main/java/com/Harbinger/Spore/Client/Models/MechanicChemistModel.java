...
public class MechanicChemistModel<T extends Chemist> extends EntityModel<T> implements TentacledModel {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Spore.MODID, "mechanicchemistmodel"), "main");
	...
	private final ModelPart GasNozzle;
	private final ModelPart MainHandle;
	...
	public MechanicChemistModel(ModelPart root) {
		...
		this.GasNozzle = this.RightArm.getChild("GasNozzle");
		this.MainHandle = this.GasNozzle.getChild("MainHandle");
		this.Spout = this.GasNozzle.getChild("Spout");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition GasMask = Head.addOrReplaceChild("GasMask", CubeListBuilder.create(), PartPose.offset(0.05F, -1.0F, 1.45F));
		...
		PartDefinition IntakeTubeRight = Head.addOrReplaceChild("IntakeTubeRight", CubeListBuilder.create(), PartPose.offsetAndRotation(-3.1808F, -3.0987F, 1.5556F, 0.0F, 0.2094F, 0.0F));

		PartDefinition Vein8_r1 = IntakeTubeRight.addOrReplaceChild("Vein8_r1", CubeListBuilder.create().texOffs(48, 80).addBox(1.0F, -1.0F, -1.0F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.3596F, 1.6987F, -5.1777F, -0.2834F, 0.0313F, -1.3245F));

		PartDefinition Vein7_r1 = IntakeTubeRight.addOrReplaceChild("Vein7_r1", CubeListBuilder.create().texOffs(28, 80).addBox(1.0F, -1.0F, -1.0F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.1596F, 0.8987F, -5.1777F, -0.2834F, 0.0313F, -1.3245F));

		PartDefinition Vein6_r1 = IntakeTubeRight.addOrReplaceChild("Vein6_r1", CubeListBuilder.create().texOffs(44, 79).addBox(0.0F, -0.5F, -1.0F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.1985F, 0.9066F, -4.7633F, -0.0026F, 0.2484F, 0.2542F));

		PartDefinition Vein5_r1 = IntakeTubeRight.addOrReplaceChild("Vein5_r1", CubeListBuilder.create().texOffs(24, 80).addBox(0.0F, -0.5F, -1.0F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.9985F, 0.8066F, -4.7633F, -0.0725F, 0.2484F, 0.2542F));

		PartDefinition Vein4_r1 = IntakeTubeRight.addOrReplaceChild("Vein4_r1", CubeListBuilder.create().texOffs(16, 79).addBox(0.0F, -0.5F, -1.0F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.7984F, -0.7934F, -4.7633F, 0.0323F, 0.2484F, 0.2542F));

		PartDefinition Vein3_r1 = IntakeTubeRight.addOrReplaceChild("Vein3_r1", CubeListBuilder.create().texOffs(12, 79).addBox(0.0F, -0.5F, -1.0F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.5984F, -0.9934F, -4.7633F, 0.0323F, 0.2484F, 0.2542F));

		PartDefinition Vein2_r1 = IntakeTubeRight.addOrReplaceChild("Vein2_r1", CubeListBuilder.create().texOffs(8, 79).addBox(1.0F, -1.0F, -1.0F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.1596F, 0.3987F, -4.6777F, -0.0915F, 0.0313F, -1.3245F));

		PartDefinition Vein1_r1 = IntakeTubeRight.addOrReplaceChild("Vein1_r1", CubeListBuilder.create().texOffs(66, 36).addBox(1.0F, -1.0F, -1.0F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.3596F, 1.1987F, -4.6777F, -0.0915F, 0.0313F, -1.3245F));

		PartDefinition Fang_r1 = IntakeTubeRight.addOrReplaceChild("Fang_r1", CubeListBuilder.create().texOffs(30, 62).addBox(0.0F, -1.5F, -2.5F, 0.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.8575F, 0.2643F, -1.4258F, -0.5415F, 0.3724F, -1.8113F));

		PartDefinition IntakeTube_r1 = IntakeTubeRight.addOrReplaceChild("IntakeTube_r1", CubeListBuilder.create().texOffs(68, 54).addBox(-2.0F, -1.0F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(-1.9596F, -0.0013F, -2.9777F, 1.6509F, -1.3258F, 0.146F));

		PartDefinition ConnectingTumorBase7_r1 = IntakeTubeRight.addOrReplaceChild("ConnectingTumorBase7_r1", CubeListBuilder.create().texOffs(70, 41).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.4F)), PartPose.offsetAndRotation(-2.8596F, -0.3013F, -0.1777F, 1.5331F, 0.1788F, 0.3017F));

		PartDefinition ConnectingTumorBase6_r1 = IntakeTubeRight.addOrReplaceChild("ConnectingTumorBase6_r1", CubeListBuilder.create().texOffs(74, 77).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(-2.6596F, -0.1013F, -2.6777F, 1.4729F, 0.4394F, 0.2759F));

		PartDefinition ConnectingTumorBase5_r1 = IntakeTubeRight.addOrReplaceChild("ConnectingTumorBase5_r1", CubeListBuilder.create().texOffs(66, 77).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(-1.8596F, -0.9013F, -2.6777F, 1.8388F, 0.5328F, -0.0222F));

		PartDefinition ConnectingTumorBase4_r1 = IntakeTubeRight.addOrReplaceChild("ConnectingTumorBase4_r1", CubeListBuilder.create().texOffs(58, 77).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(-1.1596F, -1.2013F, -1.2777F, 1.2242F, 0.4966F, 0.1119F));

		PartDefinition ConnectingTumorBase3_r1 = IntakeTubeRight.addOrReplaceChild("ConnectingTumorBase3_r1", CubeListBuilder.create().texOffs(78, 24).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(-1.4596F, 0.0987F, -0.0777F, 0.8557F, -0.0278F, -0.5932F));

		PartDefinition ConnectingTumorBase2_r1 = IntakeTubeRight.addOrReplaceChild("ConnectingTumorBase2_r1", CubeListBuilder.create().texOffs(76, 50).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(-1.5596F, 0.8987F, -0.3777F, 0.4371F, -0.6952F, 0.1247F));

		PartDefinition ConnectingTumorBase1_r1 = IntakeTubeRight.addOrReplaceChild("ConnectingTumorBase1_r1", CubeListBuilder.create().texOffs(50, 76).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.4F)), PartPose.offsetAndRotation(-1.3596F, 1.5987F, -1.2777F, -0.3269F, -1.0581F, 0.6593F));

		PartDefinition IntakeTubeTumorBase_r1 = IntakeTubeRight.addOrReplaceChild("IntakeTubeTumorBase_r1", CubeListBuilder.create().texOffs(60, 58).addBox(-1.0F, -1.0F, -1.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(-1.4596F, 0.5987F, -1.8777F, 1.6509F, -1.3258F, 0.146F));

		PartDefinition IntakeTubeLeft = Head.addOrReplaceChild("IntakeTubeLeft", CubeListBuilder.create(), PartPose.offsetAndRotation(4.0192F, -3.1987F, 2.1556F, 0.2475F, -0.5451F, -0.4535F));

		PartDefinition Vein9_r1 = IntakeTubeLeft.addOrReplaceChild("Vein9_r1", CubeListBuilder.create().texOffs(76, 81).addBox(1.0F, -1.0F, -1.0F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.6812F, 1.9008F, -5.5821F, -0.2834F, 0.0313F, -1.3245F));

		PartDefinition Vein8_r2 = IntakeTubeLeft.addOrReplaceChild("Vein8_r2", CubeListBuilder.create().texOffs(72, 81).addBox(1.0F, -1.0F, -1.0F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8812F, 1.1009F, -5.5821F, -0.2834F, 0.0313F, -1.3245F));

		PartDefinition Vein7_r2 = IntakeTubeLeft.addOrReplaceChild("Vein7_r2", CubeListBuilder.create().texOffs(68, 81).addBox(0.0F, -0.5F, -1.0F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.1576F, 1.1087F, -5.1677F, -0.0026F, 0.2484F, 0.2542F));

		PartDefinition Vein6_r2 = IntakeTubeLeft.addOrReplaceChild("Vein6_r2", CubeListBuilder.create().texOffs(64, 81).addBox(0.0F, -0.5F, -1.0F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.9576F, 1.0087F, -5.1677F, -0.0725F, 0.2484F, 0.2542F));

		PartDefinition Vein5_r2 = IntakeTubeLeft.addOrReplaceChild("Vein5_r2", CubeListBuilder.create().texOffs(60, 81).addBox(0.0F, -0.5F, -1.0F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.2424F, -0.5913F, -5.1677F, 0.0323F, 0.2484F, 0.2542F));

		PartDefinition Vein4_r2 = IntakeTubeLeft.addOrReplaceChild("Vein4_r2", CubeListBuilder.create().texOffs(56, 81).addBox(0.0F, -0.5F, -1.0F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5576F, -0.7913F, -5.1677F, 0.0323F, 0.2484F, 0.2542F));

		PartDefinition Vein3_r2 = IntakeTubeLeft.addOrReplaceChild("Vein3_r2", CubeListBuilder.create().texOffs(80, 57).addBox(1.0F, -1.0F, -1.0F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.1188F, 0.6009F, -5.0821F, -0.0915F, 0.0313F, -1.3245F));

		PartDefinition Vein2_r2 = IntakeTubeLeft.addOrReplaceChild("Vein2_r2", CubeListBuilder.create().texOffs(52, 80).addBox(1.0F, -1.0F, -1.0F, 0.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.3188F, 1.4008F, -5.0821F, -0.0915F, 0.0313F, -1.3245F));

		PartDefinition Fang_r2 = IntakeTubeLeft.addOrReplaceChild("Fang_r2", CubeListBuilder.create().texOffs(52, 64).addBox(1.0F, -3.0F, -4.0F, 0.0F, 3.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.9812F, 2.7008F, -1.3821F, 0.0245F, 0.5502F, -1.0503F));

		PartDefinition IntakeTube_r2 = IntakeTubeLeft.addOrReplaceChild("IntakeTube_r2", CubeListBuilder.create().texOffs(36, 70).addBox(-2.0F, -1.0F, -1.0F, 3.0F, 2.0F, 2.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.0812F, 0.2008F, -3.3821F, 1.6509F, -1.3258F, 0.146F));

		PartDefinition ConnectingTumorBase7_r2 = IntakeTubeLeft.addOrReplaceChild("ConnectingTumorBase7_r2", CubeListBuilder.create().texOffs(78, 20).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(-0.5188F, 1.0008F, -2.9821F, 0.0492F, -0.9842F, 0.7483F));

		PartDefinition ConnectingTumorBase6_r2 = IntakeTubeLeft.addOrReplaceChild("ConnectingTumorBase6_r2", CubeListBuilder.create().texOffs(78, 16).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.4F)), PartPose.offsetAndRotation(0.9812F, -0.2992F, -3.0821F, 0.8511F, -0.7888F, -0.7261F));

		PartDefinition ConnectingTumorBase5_r2 = IntakeTubeLeft.addOrReplaceChild("ConnectingTumorBase5_r2", CubeListBuilder.create().texOffs(70, 64).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.4F)), PartPose.offsetAndRotation(2.0812F, 0.7008F, -1.2821F, 1.5987F, 0.2389F, 0.2807F));

		PartDefinition ConnectingTumorBase4_r2 = IntakeTubeLeft.addOrReplaceChild("ConnectingTumorBase4_r2", CubeListBuilder.create().texOffs(78, 12).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(-0.2188F, -0.9992F, -2.2821F, -1.7761F, 0.4018F, 2.8042F));

		PartDefinition ConnectingTumorBase3_r2 = IntakeTubeLeft.addOrReplaceChild("ConnectingTumorBase3_r2", CubeListBuilder.create().texOffs(78, 8).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.5812F, -1.0992F, -0.0821F, 0.8421F, -0.0522F, -0.1866F));

		PartDefinition ConnectingTumorBase2_r2 = IntakeTubeLeft.addOrReplaceChild("ConnectingTumorBase2_r2", CubeListBuilder.create().texOffs(78, 4).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.3812F, 0.5008F, -0.1821F, -0.2924F, -0.0522F, -0.1866F));

		PartDefinition ConnectingTumorBase1_r2 = IntakeTubeLeft.addOrReplaceChild("ConnectingTumorBase1_r2", CubeListBuilder.create().texOffs(78, 0).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.4F)), PartPose.offsetAndRotation(-0.5188F, 1.5008F, -1.2821F, 0.8511F, -0.7888F, -0.7261F));

		PartDefinition IntakeTubeTumorBase_r2 = IntakeTubeLeft.addOrReplaceChild("IntakeTubeTumorBase_r2", CubeListBuilder.create().texOffs(40, 64).addBox(-1.0F, -1.0F, -1.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.5812F, 0.8009F, -2.2821F, 1.6509F, -1.3258F, 0.146F));
		...
		PartDefinition HeadTumors2 = Head.addOrReplaceChild("HeadTumors2", CubeListBuilder.create(), PartPose.offsetAndRotation(3.9447F, -7.5507F, 2.657F, -0.3054F, -0.6981F, 0.0F));

		PartDefinition Tumor5_r1 = HeadTumors2.addOrReplaceChild("Tumor5_r1", CubeListBuilder.create().texOffs(2, 84).addBox(-1.75F, -1.5F, -1.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(-0.6F)), PartPose.offsetAndRotation(-0.7069F, 1.6764F, -0.6327F, 1.1651F, -0.2569F, 1.1594F));

		PartDefinition Tumor4_r1 = HeadTumors2.addOrReplaceChild("Tumor4_r1", CubeListBuilder.create().texOffs(0, 83).addBox(-1.0F, -2.0F, -3.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.8F)), PartPose.offsetAndRotation(-0.3527F, 0.6139F, 1.2329F, 0.0982F, 0.0574F, -0.7634F));
		...
		PartDefinition RightArm = Arms.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(0, 50).addBox(-1.0F, -2.0F, -1.1F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(112, 17).addBox(-1.0F, -2.0F, -1.1F, 4.0F, 5.0F, 4.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(5.0F, -19.0F, 0.0F, 1.6144F, 0.0F, 0.0F));

		PartDefinition Foliage1_r1 = RightArm.addOrReplaceChild("Foliage1_r1", CubeListBuilder.create().texOffs(-7, 99).addBox(-6.0F, 0.0F, -1.0F, 7.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.8F, 0.6F, 0.1F, -0.3142F, 0.0F, 0.3142F));

		PartDefinition GasNozzle = RightArm.addOrReplaceChild("GasNozzle", CubeListBuilder.create(), PartPose.offsetAndRotation(0.8F, 2.6F, 1.0F, 3.1067F, 0.0F, 0.0F));

		PartDefinition MainHandle = GasNozzle.addOrReplaceChild("MainHandle", CubeListBuilder.create().texOffs(120, 123).addBox(12.5F, -6.0F, 0.4F, 2.0F, 3.0F, 2.0F, new CubeDeformation(0.0F))
				.texOffs(116, 118).addBox(12.5F, -3.0F, 0.4F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(122, 114).addBox(12.5F, -6.0F, 3.4F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.0F))
				.texOffs(107, 122).addBox(12.5F, -8.0F, 0.4F, 2.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(99, 124).addBox(12.5F, -10.0F, 1.4F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(-13.4F, 2.219F, -2.4158F));

		PartDefinition NozzleTop_r1 = MainHandle.addOrReplaceChild("NozzleTop_r1", CubeListBuilder.create().texOffs(101, 119).addBox(-1.0F, -1.0F, -2.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(13.5F, -10.3F, 2.9F, -0.1222F, 0.0F, 0.0F));

		PartDefinition NozzleSlope2_r1 = MainHandle.addOrReplaceChild("NozzleSlope2_r1", CubeListBuilder.create().texOffs(99, 124).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(13.5F, -8.1F, 1.5F, -0.192F, 0.0F, 0.0F));

		PartDefinition NozzleSlope1_r1 = MainHandle.addOrReplaceChild("NozzleSlope1_r1", CubeListBuilder.create().texOffs(99, 124).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(13.5F, -8.1F, 3.3F, 0.192F, 0.0F, 0.0F));

		PartDefinition Spout = GasNozzle.addOrReplaceChild("Spout", CubeListBuilder.create(), PartPose.offset(-13.4F, 2.219F, -2.4158F));

		PartDefinition SpoutTip_r1 = Spout.addOrReplaceChild("SpoutTip_r1", CubeListBuilder.create().texOffs(110, 116).addBox(-1.0F, -3.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(-0.4F)), PartPose.offsetAndRotation(13.5F, -13.7F, 3.0F, -0.5236F, 0.0F, 0.0F));

		PartDefinition SpoutBase_r1 = Spout.addOrReplaceChild("SpoutBase_r1", CubeListBuilder.create().texOffs(110, 116).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(13.5F, -11.8F, 2.6F, -0.1571F, 0.0F, 0.0F));

		PartDefinition LeftArm = Arms.addOrReplaceChild("LeftArm", CubeListBuilder.create().texOffs(54, 0).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(96, 17).addBox(-2.0F, -2.0F, -2.0F, 4.0F, 5.0F, 4.0F, new CubeDeformation(-0.2F))
				.texOffs(54, 9).addBox(-2.0F, 4.0F, -2.0F, 4.0F, 3.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(66, 28).addBox(-1.5F, 3.0F, -1.5F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F))
				.texOffs(32, 57).addBox(-2.0F, 6.9F, -2.0F, 4.0F, 1.0F, 4.0F, new CubeDeformation(-0.1F)), PartPose.offset(-6.0F, -19.0F, 0.9F));

		PartDefinition Foliage3_r1 = LeftArm.addOrReplaceChild("Foliage3_r1", CubeListBuilder.create().texOffs(-7, 99).addBox(-6.0F, 0.0F, -1.0F, 7.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8F, 3.6F, -2.3F, 0.1571F, 0.0698F, -0.2967F));

		PartDefinition Tendrils = LeftArm.addOrReplaceChild("Tendrils", CubeListBuilder.create(), PartPose.offset(0.0F, 3.5F, 0.0F));

		PartDefinition Tendril1 = Tendrils.addOrReplaceChild("Tendril1", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition HandTendrilEnd_r1 = Tendril1.addOrReplaceChild("HandTendrilEnd_r1", CubeListBuilder.create().texOffs(40, 78).addBox(0.0F, -4.5F, -1.0F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.1F, 12.5F, 1.5F, -0.2337F, 0.0278F, 0.1369F));

		PartDefinition HandTendrilBase_r1 = Tendril1.addOrReplaceChild("HandTendrilBase_r1", CubeListBuilder.create().texOffs(68, 47).addBox(-1.0F, -2.5F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.0F, 6.2F, 1.6F, 0.1745F, 0.0F, 0.0F));

		PartDefinition Tendril2 = Tendrils.addOrReplaceChild("Tendril2", CubeListBuilder.create(), PartPose.offsetAndRotation(-1.6317F, 8.8444F, 0.1157F, 0.0F, -1.0821F, 0.0F));

		PartDefinition HandTendrilEnd_r2 = Tendril2.addOrReplaceChild("HandTendrilEnd_r2", CubeListBuilder.create().texOffs(40, 78).addBox(0.0F, -4.5F, -1.0F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.7683F, 3.2556F, -1.0157F, -0.4432F, 0.0278F, 0.1369F));

		PartDefinition HandTendrilBase_r2 = Tendril2.addOrReplaceChild("HandTendrilBase_r2", CubeListBuilder.create().texOffs(68, 47).addBox(-1.0F, -2.5F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(-0.1683F, -2.6444F, -0.1157F, 0.1671F, -0.0508F, 0.2925F));

		PartDefinition Tendril3 = Tendrils.addOrReplaceChild("Tendril3", CubeListBuilder.create(), PartPose.offsetAndRotation(0.1683F, 8.8444F, -1.6843F, 3.1235F, -0.0674F, -2.8792F));

		PartDefinition HandTendrilEnd_r3 = Tendril3.addOrReplaceChild("HandTendrilEnd_r3", CubeListBuilder.create().texOffs(40, 78).addBox(0.0F, -4.5F, -1.0F, 1.0F, 6.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.1683F, 3.2556F, -0.8157F, -0.3444F, -0.3557F, 0.299F));

		PartDefinition HandTendrilBase_r3 = Tendril3.addOrReplaceChild("HandTendrilBase_r3", CubeListBuilder.create().texOffs(68, 47).addBox(-1.0F, -2.5F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(-0.1683F, -2.6444F, -0.1157F, 0.1671F, -0.0508F, 0.2925F));
		...
		PartDefinition TorsoApronBottom_r1 = ActualTorso.addOrReplaceChild("TorsoApronBottom_r1", CubeListBuilder.create().texOffs(37, 117).addBox(-4.0F, -0.5398F, -3.2598F, 8.0F, 5.0F, 6.0F, new CubeDeformation(-0.2F))
				.texOffs(30, 17).addBox(-4.0F, -0.5398F, -3.2598F, 8.0F, 5.0F, 6.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(0.0F, -16.0F, 0.9F, -0.1745F, 0.0F, 0.0F));
		...
		PartDefinition TorsoTopInterior_r1 = ActualTorso.addOrReplaceChild("TorsoTopInterior_r1", CubeListBuilder.create().texOffs(100, 26).addBox(-7.0F, -5.0F, -1.0F, 8.0F, 5.0F, 6.0F, new CubeDeformation(-0.2F))
				.texOffs(0, 117).addBox(-7.0F, -5.0F, -1.0F, 8.0F, 5.0F, 6.0F, new CubeDeformation(0.1F))
		...
		PartDefinition BackTendril1 = Torso.addOrReplaceChild("BackTendril1", CubeListBuilder.create().texOffs(12, 67).addBox(-0.8471F, -5.1132F, -1.1224F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.2831F, -17.3699F, 1.7538F, -1.5703F, -0.2271F, 3.0092F));

		PartDefinition r3seg2 = BackTendril1.addOrReplaceChild("r3seg2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.1666F, -8.0766F, -0.1369F, 0.0F, 0.0F, 0.8727F));
		...
		PartDefinition BackTendril2 = Torso.addOrReplaceChild("BackTendril2", CubeListBuilder.create(), PartPose.offsetAndRotation(-2.4169F, -16.9699F, 1.3538F, -1.3898F, 0.1378F, 0.7964F));

		PartDefinition Seg4_r2 = BackTendril2.addOrReplaceChild("Seg4_r2", CubeListBuilder.create().texOffs(62, 64).addBox(-1.0F, -4.0F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.893F, -1.8052F, -0.4714F, 0.0693F, 0.0529F, -0.482F));

		PartDefinition r3seg4 = BackTendril2.addOrReplaceChild("r3seg4", CubeListBuilder.create(), PartPose.offsetAndRotation(-1.1793F, -8.9686F, 0.0141F, 0.0F, 0.0F, 0.8727F));
		...
		PartDefinition RightLeg = Legs.addOrReplaceChild("RightLeg", CubeListBuilder.create().texOffs(44, 39).addBox(-2.0F, 0.5F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(39, 104).addBox(-2.1F, 0.5F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.1F))
				.texOffs(96, 37).addBox(-2.0F, 0.5F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(-0.2F))
				.texOffs(66, 16).addBox(-1.5F, 6.0F, -1.5F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(-2.0F, -13.0F, 0.0F));

		PartDefinition RightForLeg = RightLeg.addOrReplaceChild("RightForLeg", CubeListBuilder.create().texOffs(28, 39).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 7.0F, 0.0F));
		...
		PartDefinition LeftLeg = Legs.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(16, 49).addBox(-2.0F, 0.5F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F))
				.texOffs(18, 104).addBox(-1.9F, 0.5F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.1F))
