...
public class bloomingGargoyleModel<T extends Gargoyl> extends EntityModel<T> implements TentacledModel, GargoyleBits {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Spore.MODID, "bloominggargoylemodel"), "main");
	private final ModelPart Gargoyle;
	private final ModelPart Torso;
	private final ModelPart Chest;
	private final ModelPart Tumor;
	private final ModelPart Stomach;
	private final ModelPart StomachFoliageLushCrown2;
	...
	private final ModelPart HeadFoliageLushCrown;
	...
	private final ModelPart BerryBush1;
	private final ModelPart GlowBerryCluster;
	private final ModelPart RightLeg;
	private final ModelPart BerryBush2;
	private final ModelPart GlowBerryCluster2;
	...
	public bloomingGargoyleModel(ModelPart root, boolean armor) {
		...
		this.StomachFoliageLushCrown2 = this.Stomach.getChild("StomachFoliageLushCrown2");
		...
		this.HeadFoliageLushCrown = this.Head.getChild("HeadFoliageLushCrown");
		...
		this.BerryBush1 = this.LeftLeg.getChild("BerryBush1");
		this.GlowBerryCluster = this.LeftLeg.getChild("GlowBerryCluster");
		this.RightLeg = this.Gargoyle.getChild("RightLeg");
		this.BerryBush2 = this.RightLeg.getChild("BerryBush2");
		this.GlowBerryCluster2 = this.RightLeg.getChild("GlowBerryCluster2");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition StomachFoliageLushCrown2 = Stomach.addOrReplaceChild("StomachFoliageLushCrown2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.4782F, -2.0925F, -5.1058F, 0.7929F, 0.2051F, 0.4855F));

		PartDefinition HeadCrownPetal5_r1 = StomachFoliageLushCrown2.addOrReplaceChild("HeadCrownPetal5_r1", CubeListBuilder.create().texOffs(110, 12).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.65F, 0.975F, -2.775F, 2.8835F, -0.4364F, -1.7982F));

		PartDefinition HeadCrownPetal4_r1 = StomachFoliageLushCrown2.addOrReplaceChild("HeadCrownPetal4_r1", CubeListBuilder.create().texOffs(110, 6).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.35F, 2.975F, -1.975F, 3.0336F, 0.4746F, 3.029F));

		PartDefinition HeadCrownPetal3_r1 = StomachFoliageLushCrown2.addOrReplaceChild("HeadCrownPetal3_r1", CubeListBuilder.create().texOffs(110, 6).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.85F, -0.025F, 1.325F, 1.6058F, 0.4193F, 1.2004F));

		PartDefinition HeadCrownPetal2_r1 = StomachFoliageLushCrown2.addOrReplaceChild("HeadCrownPetal2_r1", CubeListBuilder.create().texOffs(110, 12).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.85F, -1.925F, 1.425F, 1.404F, -0.5977F, -0.0592F));
		...
		PartDefinition Tumor_r2 = TumorCluster8.addOrReplaceChild("Tumor_r2", CubeListBuilder.create().texOffs(52, 71).addBox(-1.0F, -4.0F, -1.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.1325F, -0.4365F, 2.4059F, 1.163F, 0.7706F, -1.0506F));

		PartDefinition Tumor_r3 = TumorCluster8.addOrReplaceChild("Tumor_r3", CubeListBuilder.create().texOffs(54, 71).addBox(-1.0F, -4.0F, -1.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.1325F, -3.4365F, 1.4059F, 0.8355F, -0.8479F, 2.5215F));
		...
		PartDefinition HeadFoliageLushCrown = Head.addOrReplaceChild("HeadFoliageLushCrown", CubeListBuilder.create(), PartPose.offsetAndRotation(3.1876F, -6.0423F, -6.4461F, -0.176F, -0.1289F, 0.0229F));

		PartDefinition HeadCrownPetal4_r2 = HeadFoliageLushCrown.addOrReplaceChild("HeadCrownPetal4_r2", CubeListBuilder.create().texOffs(110, 12).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.65F, -0.025F, -1.775F, 2.5781F, -0.4364F, -1.7982F));

		PartDefinition HeadCrownPetal3_r2 = HeadFoliageLushCrown.addOrReplaceChild("HeadCrownPetal3_r2", CubeListBuilder.create().texOffs(110, 6).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.35F, 1.975F, -0.975F, 2.4227F, 0.4746F, 3.029F));

		PartDefinition HeadCrownPetal2_r2 = HeadFoliageLushCrown.addOrReplaceChild("HeadCrownPetal2_r2", CubeListBuilder.create().texOffs(110, 6).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.85F, -0.025F, 1.325F, 1.5078F, 0.4065F, 1.3905F));

		PartDefinition HeadCrownPetal1_r1 = HeadFoliageLushCrown.addOrReplaceChild("HeadCrownPetal1_r1", CubeListBuilder.create().texOffs(110, 12).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.85F, -1.925F, 1.425F, 1.2151F, -0.5845F, 0.0447F));
		...
		PartDefinition Foliage_r7 = TopArmBase.addOrReplaceChild("Foliage_r7", CubeListBuilder.create().texOffs(-6, 107).addBox(-5.0F, 0.0F, -2.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.7211F, -9.9986F, -4.0F, 2.7477F, 0.7821F, 2.7358F));

		PartDefinition Foliage_r8 = TopArmBase.addOrReplaceChild("Foliage_r8", CubeListBuilder.create().texOffs(-6, 113).addBox(-5.0F, 0.0F, -2.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.7211F, -7.9986F, 0.0F, 2.6259F, -1.1793F, -2.7677F));
		...
		PartDefinition Foliage_r9 = BottomArmBase.addOrReplaceChild("Foliage_r9", CubeListBuilder.create().texOffs(-7, 107).addBox(-5.0F, 0.0F, -3.0F, 6.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(9.7211F, -2.9986F, -3.0F, 0.8173F, -0.9118F, -0.9529F));
		...
		PartDefinition Tumor_r4 = TumorCluster6.addOrReplaceChild("Tumor_r4", CubeListBuilder.create().texOffs(37, 69).addBox(-1.0F, -3.0F, -2.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0466F, -0.4033F, 0.6459F, -0.5533F, 0.2768F, -1.0254F));

		PartDefinition Tumor_r5 = TumorCluster6.addOrReplaceChild("Tumor_r5", CubeListBuilder.create().texOffs(37, 69).addBox(-1.0F, -3.0F, -2.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0466F, 1.5967F, 2.6459F, 0.8603F, 0.09F, 2.5534F));

		PartDefinition Tumor_r6 = TumorCluster6.addOrReplaceChild("Tumor_r6", CubeListBuilder.create().texOffs(35, 68).addBox(-2.0F, -3.0F, -3.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.9534F, -0.4033F, 0.6459F, 1.7455F, -0.043F, -1.5784F));
		...
		PartDefinition Foliage_r10 = TopArmBase2.addOrReplaceChild("Foliage_r10", CubeListBuilder.create().texOffs(-7, 101).addBox(-5.0F, 0.0F, -3.0F, 6.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.0F, -1.0F, -3.0F, -0.1948F, 0.3292F, 0.3908F));

		PartDefinition Foliage_r11 = TopArmBase2.addOrReplaceChild("Foliage_r11", CubeListBuilder.create().texOffs(-7, 107).addBox(-5.0F, 0.0F, -3.0F, 6.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.0F, -7.0F, -6.0F, 0.2427F, 0.0992F, -0.3806F));
		...
		PartDefinition Tumor_r7 = TumorCluster5.addOrReplaceChild("Tumor_r7", CubeListBuilder.create().texOffs(37, 70).addBox(-3.0F, -2.0F, -2.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.939F, 0.8779F, 2.1495F, 0.0F, -0.5236F, -0.6109F));
		...
		PartDefinition foliage_r12 = LeftLeg.addOrReplaceChild("foliage_r12", CubeListBuilder.create().texOffs(-6, 113).addBox(-1.0F, 0.0F, -1.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0208F, 0.4245F, -0.4932F, -0.3491F, 0.0F, 0.0F));

		PartDefinition BerryBush1 = LeftLeg.addOrReplaceChild("BerryBush1", CubeListBuilder.create(), PartPose.offset(-3.0208F, 0.4245F, -1.4932F));

		PartDefinition BB2_r1 = BerryBush1.addOrReplaceChild("BB2_r1", CubeListBuilder.create().texOffs(10, 76).addBox(0.0F, -1.0F, -2.5F, 0.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, 6.0F, 1.5F, 0.0F, -0.6109F, 0.0F));

		PartDefinition BB1_r1 = BerryBush1.addOrReplaceChild("BB1_r1", CubeListBuilder.create().texOffs(10, 76).addBox(0.0F, -1.0F, -2.5F, 0.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, 6.0F, 1.5F, 0.0F, 0.7418F, 0.0F));

		PartDefinition GlowBerryCluster = LeftLeg.addOrReplaceChild("GlowBerryCluster", CubeListBuilder.create(), PartPose.offset(-0.3378F, 4.0426F, 0.9003F));

		PartDefinition Berry3_r1 = GlowBerryCluster.addOrReplaceChild("Berry3_r1", CubeListBuilder.create().texOffs(37, 78).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.683F, 1.3819F, 1.6065F, 0.2249F, -0.7318F, 0.4321F));

		PartDefinition Berry2_r1 = GlowBerryCluster.addOrReplaceChild("Berry2_r1", CubeListBuilder.create().texOffs(37, 79).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.683F, -0.6181F, 1.6065F, 0.9667F, -0.7318F, 0.4321F));

		PartDefinition Berry1_r1 = GlowBerryCluster.addOrReplaceChild("Berry1_r1", CubeListBuilder.create().texOffs(35, 77).addBox(-2.0F, -3.0F, -1.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.317F, 1.3819F, -1.3935F, 0.9667F, -0.7318F, 0.4321F));
		...
		PartDefinition BerryBush2 = RightLeg.addOrReplaceChild("BerryBush2", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.028F, 5.4245F, 0.0068F, 0.0F, 3.0543F, 0.0F));

		PartDefinition BB4_r1 = BerryBush2.addOrReplaceChild("BB4_r1", CubeListBuilder.create().texOffs(10, 76).addBox(0.0F, -1.0F, -2.5F, 0.0F, 7.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.0F, 0.0F, 0.0F, -0.6109F, 0.0F));

		PartDefinition BB3_r1 = BerryBush2.addOrReplaceChild("BB3_r1", CubeListBuilder.create().texOffs(10, 76).addBox(0.0F, -1.0F, -2.5F, 0.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.0F, 0.0F, 0.0F, 0.7418F, 0.0F));

		PartDefinition GlowBerryCluster2 = RightLeg.addOrReplaceChild("GlowBerryCluster2", CubeListBuilder.create(), PartPose.offset(-0.8441F, 2.0465F, -1.1534F));

		PartDefinition Berry6_r1 = GlowBerryCluster2.addOrReplaceChild("Berry6_r1", CubeListBuilder.create().texOffs(38, 79).addBox(-1.0F, -2.0F, -1.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8161F, -0.622F, -0.3398F, 0.9189F, -0.7218F, -0.4978F));

		PartDefinition Berry5_r1 = GlowBerryCluster2.addOrReplaceChild("Berry5_r1", CubeListBuilder.create().texOffs(37, 79).addBox(-1.0F, -2.0F, -1.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.1839F, 0.378F, 0.6602F, 0.7432F, -0.3243F, 1.3099F));

		PartDefinition Berry4_r1 = GlowBerryCluster2.addOrReplaceChild("Berry4_r1", CubeListBuilder.create().texOffs(38, 78).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.1839F, 1.378F, 1.6602F, 0.5138F, -1.2265F, 0.0955F));
		...
		PartDefinition Foliage_r13 = LeftWing.addOrReplaceChild("Foliage_r13", CubeListBuilder.create().texOffs(-6, 101).addBox(-5.0F, 0.0F, -2.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.7789F, -4.7486F, 1.5F, 3.0183F, -0.7131F, -3.0625F));
