...
public class SpreaderChemistModel<T extends Chemist> extends EntityModel<T> implements TentacledModel{
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Spore.MODID,"spreaderchemistmodel"), "main");
	...
	private final ModelPart deadlyshroom;
	...
	private final ModelPart deadlyshroom2;
	...
	public SpreaderChemistModel(ModelPart root) {
		...
		this.deadlyshroom = this.Head.getChild("deadlyshroom");
		...
		this.deadlyshroom2 = this.Tank.getChild("deadlyshroom2");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r1 = Head.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(59, 114).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, -8.0F, -2.0F, 0.3491F, 0.0F, 1.5708F));
		...
		PartDefinition Foliage6_r1 = Head.addOrReplaceChild("Foliage6_r1", CubeListBuilder.create().texOffs(-7, 100).addBox(-6.0F, 0.0F, -1.0F, 7.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.3F, -6.0F, 0.95F, 2.9031F, -0.5902F, 2.9876F));
		...
		PartDefinition cube_r2 = Filter2.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(20, 112).addBox(-1.0F, -2.0F, 1.0F, 2.0F, 4.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 1.0F, -5.0F, -0.612F, -0.0174F, 0.0146F));
		...
		PartDefinition deadlyshroom = Head.addOrReplaceChild("deadlyshroom", CubeListBuilder.create().texOffs(53, 112).addBox(-1.531F, -2.0F, -1.5134F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(59, 114).addBox(-0.531F, -3.0F, -0.5134F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(53, 118).addBox(-0.531F, 0.0F, -0.5134F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -9.0F, -1.0F, 0.0F, -0.5672F, 0.0F));
		...
		PartDefinition RightArm = Arms.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(0, 50).addBox(0.0F, -2.0F, -1.1F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(112, 17).addBox(0.0F, -2.0F, -1.1F, 4.0F, 5.0F, 4.0F, new CubeDeformation(-0.2F))
		.texOffs(52, 49).addBox(0.0F, 4.0F, -1.1F, 4.0F, 5.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(66, 24).addBox(0.5F, 3.0F, -0.6F, 3.0F, 1.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(4.0F, -19.0F, 0.0F));

		PartDefinition Foliage1_r1 = RightArm.addOrReplaceChild("Foliage1_r1", CubeListBuilder.create().texOffs(-7, 92).addBox(-6.0F, 0.0F, -1.0F, 7.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.8F, 0.6F, 0.1F, -0.3142F, 0.0F, 0.3142F));
		...
		PartDefinition StomachTumor2_r1 = StomachTumors.addOrReplaceChild("StomachTumor2_r1", CubeListBuilder.create().texOffs(0, 111).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(1.3F, -13.3F, 3.0F, -0.5886F, -0.7649F, 0.2685F));
		...
		PartDefinition Tank = ActualTorso.addOrReplaceChild("Tank", CubeListBuilder.create().texOffs(34, 0).addBox(-2.5F, -8.0F, -1.0F, 5.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, -13.5F, -5.0F, -0.121F, 0.05F, 0.3897F));

		PartDefinition cube_r3 = Tank.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, -4.0F, 3.0F, 0.0F, 0.0F, 1.0036F));

		PartDefinition cube_r4 = Tank.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, -4.0F, 1.0F, 0.0F, 0.0F, 0.3054F));

		PartDefinition cube_r5 = Tank.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, 0.0F, 1.0F, -0.5236F, 0.0F, -0.6981F));

		PartDefinition cube_r6 = Tank.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, -2.0F, 2.0F, 0.0F, 0.0F, -0.6109F));

		PartDefinition cube_r7 = Tank.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, -2.0F, 1.0F, -1.309F, 0.0F, 0.0F));

		PartDefinition cube_r8 = Tank.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, 1.0F, -1.0F, -2.9416F, -0.2368F, 1.121F));

		PartDefinition cube_r9 = Tank.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(0, 0).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.0F, -2.0F, -1.3758F, -0.1758F, 0.7245F));
		...
		PartDefinition deadlyshroom2 = Tank.addOrReplaceChild("deadlyshroom2", CubeListBuilder.create().texOffs(53, 112).addBox(-2.0F, -2.0F, -19.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(59, 114).addBox(-1.0F, -3.0F, -18.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
		.texOffs(53, 118).addBox(-1.0F, 0.0F, -18.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.0F, -17.0F, 1.25F, 1.3814F, 0.2466F, -0.1653F));
		...
		.texOffs(112, 37).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 6.0F, 4.0F, new CubeDeformation(-0.2F)), PartPose.offset(0.0F, 6.0F, 0.0F));
