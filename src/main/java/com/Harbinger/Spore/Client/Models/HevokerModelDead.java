...
public class HevokerModelDead<T extends Hevoker> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition hevoker = partdefinition.addOrReplaceChild("hevoker", CubeListBuilder.create(), PartPose.offsetAndRotation(-3.0F, 25.0F, -32.0F, -1.4835F, 0.0F, 0.0F));
		...
		.texOffs(56, 66).addBox(-1.0F, -4.0F, -8.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.2019F, -10.8646F, -0.8695F, -0.3727F, -0.3268F, 0.0082F));
		...
		.texOffs(83, 125).addBox(-4.0F, -3.0F, -4.0F, 8.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.0455F, -0.3084F, -1.9395F, 0.58F, 0.3329F, 0.1213F));
		...
		PartDefinition BackClaw1 = BackClaws.addOrReplaceChild("BackClaw1", CubeListBuilder.create().texOffs(118, 31).addBox(-1.0F, -7.0F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(-2.8349F, -3.482F, 2.0035F, -0.8727F, 0.0F, -0.5672F));
		...
		PartDefinition BackClaw3 = BackClaws.addOrReplaceChild("BackClaw3", CubeListBuilder.create().texOffs(118, 31).addBox(-1.0F, -10.0F, -1.0F, 2.0F, 8.0F, 2.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(1.8744F, -2.2252F, -0.0086F, -2.2093F, -0.1331F, -2.1053F));
		...
		.texOffs(0, 156).addBox(-5.0F, -1.5F, -2.5F, 5.0F, 11.0F, 5.0F, new CubeDeformation(0.2F)), PartPose.offsetAndRotation(-5.25F, -0.5F, 0.5F, 0.1864F, -0.6727F, 0.9864F));

		PartDefinition LeftArm2 = LeftArm.addOrReplaceChild("LeftArm2", CubeListBuilder.create().texOffs(20, 94).addBox(-2.0F, 0.0F, -2.5F, 4.0F, 6.0F, 5.0F, new CubeDeformation(-0.01F)), PartPose.offsetAndRotation(-3.1082F, 7.0119F, 0.0F, -0.0555F, -0.5648F, -0.1148F));
		...
		PartDefinition LAClaw1 = LeftArm.addOrReplaceChild("LAClaw1", CubeListBuilder.create().texOffs(118, 31).addBox(-1.0F, -7.0F, -1.0F, 2.0F, 7.0F, 2.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(-4.539F, 0.8738F, 0.4958F, -2.5307F, 0.8727F, 2.0944F));
		...
		PartDefinition RightArm = Arms.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(64, 24).addBox(-0.25F, -2.0F, -3.0F, 6.0F, 8.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.0F, 0.0F, 0.0F, 1.6759F, 0.8684F, 0.6352F));

		PartDefinition RMClaw1 = RightArm.addOrReplaceChild("RMClaw1", CubeListBuilder.create().texOffs(38, 94).addBox(-2.0F, -10.0F, -1.0F, 3.0F, 13.0F, 3.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(4.415F, 1.9809F, 1.4353F, -1.7463F, -0.3601F, -1.8031F));
		...
		PartDefinition RAClaw2 = RightArm2.addOrReplaceChild("RAClaw2", CubeListBuilder.create().texOffs(118, 31).addBox(-1.0F, -10.0F, -1.0F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.4262F, 2.9298F, -1.9353F, 1.9088F, -0.8533F, 0.2862F));
		...
		PartDefinition RAClaw5 = RightArm2.addOrReplaceChild("RAClaw5", CubeListBuilder.create().texOffs(118, 31).addBox(-1.0F, -10.0F, -1.0F, 2.0F, 10.0F, 2.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(-1.3805F, 0.9865F, 1.1291F, 1.2182F, 1.35F, -1.3904F));
		...
		PartDefinition RightArmSplit1 = RightArm3.addOrReplaceChild("RightArmSplit1", CubeListBuilder.create().texOffs(56, 117).addBox(-1.0F, 0.0F, -1.5F, 2.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.3581F, 5.7537F, -0.3996F, -0.5021F, 0.5816F, 0.2605F));

		PartDefinition RASplit1Claw = RightArmSplit1.addOrReplaceChild("RASplit1Claw", CubeListBuilder.create().texOffs(50, 129).addBox(-0.5F, -6.5F, -1.0F, 1.0F, 7.0F, 2.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(-0.3312F, 6.8287F, -0.5515F, 3.1128F, 1.0357F, 0.7329F));
		...
		PartDefinition RASplit1Claw2 = RightArmSplit1.addOrReplaceChild("RASplit1Claw2", CubeListBuilder.create().texOffs(50, 129).addBox(-0.5F, -6.5F, -1.0F, 1.0F, 7.0F, 2.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0952F, 4.0477F, -0.092F, -0.9259F, 0.9971F, 1.0769F));
		...
		PartDefinition RightArmSplit2 = RightArm3.addOrReplaceChild("RightArmSplit2", CubeListBuilder.create().texOffs(114, 99).addBox(-2.0F, 0.0F, -1.5F, 3.0F, 7.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.4035F, 4.2047F, 0.8685F, 0.6559F, -0.5907F, 0.0965F));
		...
		PartDefinition RASplit2Claw1 = RightArmSplit2Seg1.addOrReplaceChild("RASplit2Claw1", CubeListBuilder.create().texOffs(118, 31).addBox(-1.0F, 0.0F, -1.0F, 2.0F, 6.0F, 2.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.177F, 1.5284F, 0.003F, -2.415F, -1.0724F, 1.5044F));
		...
		PartDefinition LeftLeg = Legs.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(86, 93).addBox(-2.5F, 0.0F, -2.0F, 5.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.0F, -22.3193F, 3.6179F, -0.3909F, -0.0283F, -0.1278F));

		PartDefinition LeftLegClaw4 = LeftLeg.addOrReplaceChild("LeftLegClaw4", CubeListBuilder.create().texOffs(50, 129).addBox(-0.5F, -4.0F, -1.0F, 1.0F, 4.0F, 2.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(1.0093F, 5.9026F, -0.3099F, -0.9314F, -1.0117F, 2.5125F));

		PartDefinition LLClawJoint5 = LeftLegClaw4.addOrReplaceChild("LLClawJoint5", CubeListBuilder.create().texOffs(44, 129).addBox(-0.5F, -5.0F, -1.0F, 1.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, 0.0F, 1.0036F, 0.0F, 0.0F));
		...
		PartDefinition Tumor_r1 = LeftLegTumors.addOrReplaceChild("Tumor_r1", CubeListBuilder.create().texOffs(7, 75).addBox(0.0F, 1.0F, -4.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-9.0F, -14.8236F, 4.1656F, -0.3927F, -0.4363F, 0.0F));

		PartDefinition Tumor_r2 = LeftLegTumors.addOrReplaceChild("Tumor_r2", CubeListBuilder.create().texOffs(5, 76).addBox(1.0F, 1.0F, -5.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.0F, -19.8236F, 2.1656F, -0.6545F, -0.5236F, 0.0F));

		PartDefinition Tumor_r3 = LeftLegTumors.addOrReplaceChild("Tumor_r3", CubeListBuilder.create().texOffs(5, 78).addBox(1.0F, 0.0F, -3.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, -16.8236F, 2.1656F, -0.3927F, 0.4363F, 0.0F));

		PartDefinition Tumor_r4 = LeftLegTumors.addOrReplaceChild("Tumor_r4", CubeListBuilder.create().texOffs(3, 77).addBox(1.0F, 1.0F, -5.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-7.0F, -18.8236F, 4.1656F, -0.6981F, 0.0F, -1.0472F));
		...
		.texOffs(38, 145).mirror().addBox(-1.5F, -2.5F, -1.5F, 4.0F, 8.0F, 3.0F, new CubeDeformation(0.2F)).mirror(false), PartPose.offsetAndRotation(-2.0711F, -20.0953F, 3.7866F, -0.2202F, -0.0189F, 0.2174F));
		...
		PartDefinition Tumor_r5 = RightLegTumors.addOrReplaceChild("Tumor_r5", CubeListBuilder.create().texOffs(7, 76).addBox(1.0F, 1.0F, -5.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-8.0F, -19.8236F, 2.1656F, -0.6545F, -0.5236F, 0.0F));

		PartDefinition Tumor_r6 = RightLegTumors.addOrReplaceChild("Tumor_r6", CubeListBuilder.create().texOffs(6, 79).addBox(1.0F, 1.0F, -5.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-7.0F, -18.8236F, 4.1656F, -0.6981F, 0.0F, -1.0472F));

		PartDefinition RightLeg2 = RightLeg.addOrReplaceChild("RightLeg2", CubeListBuilder.create().texOffs(76, 116).addBox(-1.5F, -2.0F, -1.5F, 4.0F, 8.0F, 3.0F, new CubeDeformation(0.01F)), PartPose.offset(0.0F, 7.6429F, -0.0335F));
