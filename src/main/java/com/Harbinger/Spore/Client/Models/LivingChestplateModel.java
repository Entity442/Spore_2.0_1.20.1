...
public class LivingChestplateModel<T extends LivingEntity> extends BaseArmorModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Spore.MODID, "livingchestplate"), "main");
	...
	public LivingChestplateModel(ModelPart root, boolean value) {
		this.value = value;
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.left_arm.visible = value;
		this.right_arm.visible = value;
