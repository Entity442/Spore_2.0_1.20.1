...
public class ScamperModel<T extends Scamper> extends EntityModel<T> {
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.mound1.xScale = 1 + Mth.sin(ageInTicks/8)/9;
		this.mound1.yScale = 1 - Mth.sin(ageInTicks/8)/9;
		this.mound1.zScale = 1 + Mth.sin(ageInTicks/8)/9;

		this.mound2.xScale = 1 + Mth.sin(ageInTicks/8)/8;
		this.mound2.yScale = 1 - Mth.sin(ageInTicks/8)/8;
		this.mound2.zScale = 1 + Mth.sin(ageInTicks/8)/8;

		this.mound3.xScale = 1 + Mth.sin(ageInTicks/8)/7;
		this.mound3.yScale = 1 - Mth.sin(ageInTicks/8)/7;
		this.mound3.zScale = 1 + Mth.sin(ageInTicks/8)/7;
