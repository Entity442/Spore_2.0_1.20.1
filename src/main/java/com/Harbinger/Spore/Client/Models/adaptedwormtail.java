...
public class adaptedwormtail<T extends HohlMultipart> extends EntityModel<T>  implements TentacledModel {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Spore.MODID, "adaptedwormtail"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition EndRoot2 = tail.addOrReplaceChild("EndRoot2", CubeListBuilder.create().texOffs(358, 234).addBox(-20.0F, -4.0F, -4.0F, 20.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-11.9602F, 1.0281F, 75.1348F, 2.1895F, 0.8675F, 0.2664F));
		...
		PartDefinition bone = tail.addOrReplaceChild("bone", CubeListBuilder.create(), PartPose.offset(33.1F, -30.5F, 10.4F));

		PartDefinition cube_r1 = bone.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(132, 71).addBox(-22.0F, -16.0F, -15.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(-1.9F)), PartPose.offsetAndRotation(-13.7F, 41.0F, 0.0F, -1.8241F, 0.0054F, -1.3773F));

		PartDefinition cube_r2 = bone.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(132, 71).addBox(-22.0F, -16.0F, -15.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(-2.1F)), PartPose.offsetAndRotation(-55.0F, 40.0F, 33.2F, -0.3462F, -0.0565F, -1.472F));

		PartDefinition cube_r3 = bone.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(132, 71).addBox(-22.0F, -16.0F, -15.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(-1.1F)), PartPose.offsetAndRotation(-65.1F, 36.0F, 33.2F, -2.2533F, -0.3178F, -1.7502F));

		PartDefinition cube_r4 = bone.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(132, 71).addBox(-22.0F, -16.0F, -15.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(-1.9F)), PartPose.offsetAndRotation(-57.0F, 23.6F, 5.8F, -1.5068F, -0.1732F, -1.5384F));

		PartDefinition cube_r5 = bone.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(132, 71).addBox(-22.0F, -16.0F, -15.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(-2.1F)), PartPose.offsetAndRotation(12.9F, 18.2F, 22.1F, -0.9399F, -0.2366F, -1.2333F));

		PartDefinition cube_r6 = bone.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(132, 71).addBox(-22.0F, -16.0F, -15.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(-1.1F)), PartPose.offsetAndRotation(-12.7F, -6.8F, -6.7F, -2.2533F, -0.3178F, -1.7502F));

		PartDefinition cube_r7 = bone.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(132, 71).addBox(-22.0F, -16.0F, -15.0F, 16.0F, 16.0F, 16.0F, new CubeDeformation(-1.9F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -1.8241F, 0.0054F, -1.3773F));
	...
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float r, float g, float b, float alpha) {
		tail.render(poseStack, vertexConsumer, packedLight, packedOverlay,r,g,b, alpha);
	}
}