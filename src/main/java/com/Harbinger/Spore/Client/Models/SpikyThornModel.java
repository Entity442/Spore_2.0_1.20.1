...
public class SpikyThornModel<T extends Thorn> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Spore.MODID, "spikythornmodel"), "main");
	...
	public SpikyThornModel(ModelPart root) {
	...
	private void animateSpike(T entity ,ModelPart part,float value,int va){
		boolean visible = entity.getSpikeAmount() >= va;
		if (visible){
			part.visible = true;
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		animateSpike(entity,LeftLegThorns1.getChild("Thorn55"),-ageInTicks,++spikes);
		animateSpike(entity,LeftLegThorns1.getChild("Thorn56"),ageInTicks,++spikes);
		animateSpike(entity,LeftLegThorns1.getChild("Thorn57"),-ageInTicks/2,++spikes);
		animateSpike(entity,LeftLegThorns1.getChild("Thorn58"),ageInTicks,++spikes);
		animateSpike(entity,LeftLegThorns2.getChild("Thorn51"),-ageInTicks,++spikes);
		animateSpike(entity,LeftLegThorns2.getChild("Thorn52"),ageInTicks/2,++spikes);
		animateSpike(entity,LeftLegThorns2.getChild("Thorn53"),-ageInTicks,++spikes);
		animateSpike(entity,LeftLegThorns2.getChild("Thorn54"),ageInTicks,++spikes);
		animateSpike(entity,RightLegThorns1.getChild("Thorn43"),-ageInTicks/2,++spikes);
		animateSpike(entity,RightLegThorns1.getChild("Thorn44"),ageInTicks,++spikes);
		animateSpike(entity,RightLegThorns1.getChild("Thorn45"),-ageInTicks,++spikes);
		animateSpike(entity,RightLegThorns1.getChild("Thorn46"),ageInTicks,++spikes);
		animateSpike(entity,RightLegThorns2.getChild("Thorn47"),-ageInTicks/2,++spikes);
		animateSpike(entity,RightLegThorns2.getChild("Thorn48"),-ageInTicks,++spikes);
		animateSpike(entity,RightLegThorns2.getChild("Thorn49"),ageInTicks,++spikes);
		animateSpike(entity,RightLegThorns2.getChild("Thorn50"),-ageInTicks,++spikes);
		animateSpike(entity,TorsoThorns1.getChild("Thorn11"),-ageInTicks,++spikes);
		animateSpike(entity,TorsoThorns1.getChild("Thorn12"),-ageInTicks/2,++spikes);
		animateSpike(entity,TorsoThorns1.getChild("Thorn13"),ageInTicks,++spikes);
		animateSpike(entity,TorsoThorns1.getChild("Thorn14"),-ageInTicks,++spikes);
		animateSpike(entity,TorsoThorns1.getChild("Thorn15"),ageInTicks/2,++spikes);
		animateSpike(entity,TorsoThorns1.getChild("Thorn16"),-ageInTicks,++spikes);
		animateSpike(entity,TorsoThorns1.getChild("Thorn17"),-ageInTicks,++spikes);
		animateSpike(entity,TorsoThorns1.getChild("Thorn18"),ageInTicks/2,++spikes);
		animateSpike(entity,TorsoThorns1.getChild("Thorn19"),-ageInTicks,++spikes);
		animateSpike(entity,TorsoThorns1.getChild("Thorn20"),ageInTicks,++spikes);
		animateSpike(entity,TorsoThorns2.getChild("Thorn1"),-ageInTicks,++spikes);
		animateSpike(entity,TorsoThorns2.getChild("Thorn2"),ageInTicks,++spikes);
		animateSpike(entity,TorsoThorns2.getChild("Thorn3"),-ageInTicks,++spikes);
		animateSpike(entity,TorsoThorns2.getChild("Thorn4"),ageInTicks,++spikes);
		animateSpike(entity,TorsoThorns2.getChild("Thorn5"),ageInTicks/2,++spikes);
		animateSpike(entity,TorsoThorns2.getChild("Thorn6"),-ageInTicks,++spikes);
		animateSpike(entity,TorsoThorns2.getChild("Thorn7"),ageInTicks,++spikes);
		animateSpike(entity,TorsoThorns2.getChild("Thorn8"),ageInTicks/2,++spikes);
		animateSpike(entity,TorsoThorns2.getChild("Thorn9"),-ageInTicks,++spikes);
		animateSpike(entity,TorsoThorns2.getChild("Thorn10"),ageInTicks/2,++spikes);
		animateSpike(entity,HeadThorns.getChild("Thorn59"),ageInTicks,++spikes);
		animateSpike(entity,HeadThorns.getChild("Thorn60"),-ageInTicks/2,++spikes);
		animateSpike(entity,HeadThorns.getChild("Thorn61"),-ageInTicks,++spikes);
		animateSpike(entity,RightArmThorns1.getChild("Thorn31"),-ageInTicks,++spikes);
		animateSpike(entity,RightArmThorns1.getChild("Thorn32"),ageInTicks,++spikes);
		animateSpike(entity,RightArmThorns1.getChild("Thorn33"),-ageInTicks,++spikes);
		animateSpike(entity,RightArmThorns1.getChild("Thorn34"),ageInTicks,++spikes);
		animateSpike(entity,RightArmThorns2.getChild("Thorn35"),ageInTicks/2,++spikes);
		animateSpike(entity,RightArmThorns2.getChild("Thorn36"),-ageInTicks,++spikes);
		animateSpike(entity,RightArmThorns2.getChild("Thorn37"),ageInTicks/2,++spikes);
		animateSpike(entity,RightArmThorns2.getChild("Thorn38"),-ageInTicks,++spikes);
		animateSpike(entity,LeftArmThorns1.getChild("Thorn21"),-ageInTicks,++spikes);
		animateSpike(entity,LeftArmThorns1.getChild("Thorn22"),ageInTicks,++spikes);
		animateSpike(entity,LeftArmThorns1.getChild("Thorn23"),-ageInTicks,++spikes);
		animateSpike(entity,LeftArmThorns1.getChild("Thorn24"),ageInTicks,++spikes);
		animateSpike(entity,LeftArmThorns1.getChild("Thorn25"),-ageInTicks/2,++spikes);
		animateSpike(entity,LeftArmThorns1.getChild("Thorn26"),-ageInTicks,++spikes);
		animateSpike(entity,LeftArmThorns1.getChild("Thorn27"),ageInTicks,++spikes);
		animateSpike(entity,LeftArmThorns1.getChild("Thorn28"),ageInTicks/2,++spikes);
		animateSpike(entity,LeftArmThorns1.getChild("Thorn29"),-ageInTicks,++spikes);
		animateSpike(entity,LeftArmThorns1.getChild("Thorn30"),-ageInTicks,++spikes);
	}
