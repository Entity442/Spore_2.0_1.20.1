...
public class IchorGargoyleModel<T extends Gargoyl> extends EntityModel<T> implements TentacledModel, GargoyleBits {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Spore.MODID, "ichorgargoylemodel"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Foliage_r7 = Stomach.addOrReplaceChild("Foliage_r7", CubeListBuilder.create().texOffs(-6, 101).addBox(-5.0F, 0.0F, -2.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.7789F, -2.5986F, -2.3F, 2.4024F, -1.4251F, -2.4531F));
		...
		PartDefinition BileCluster = Stomach.addOrReplaceChild("BileCluster", CubeListBuilder.create().texOffs(44, 81).addBox(-2.3F, -1.4F, -2.7F, 4.0F, 6.0F, 0.0F, new CubeDeformation(0.0F))
		.texOffs(44, 81).addBox(-4.5F, -7.1F, 6.7F, 4.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offset(-1.0F, 0.75F, -2.4F));

		PartDefinition cube_r1 = BileCluster.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(44, 81).addBox(-3.0F, -2.0F, -1.0F, 4.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(6.6F, -1.5F, 0.3F, -0.1222F, -0.8901F, 0.0F));

		PartDefinition cube_r2 = BileCluster.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(44, 81).addBox(-3.0F, -2.0F, -1.0F, 4.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.9F, -4.5F, -2.1F, -0.1745F, 0.2094F, 0.0F));

		PartDefinition Bile_r1 = BileCluster.addOrReplaceChild("Bile_r1", CubeListBuilder.create().texOffs(25, 78).addBox(-3.0F, -4.0F, -3.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(-2.2F, -5.3F, 7.0F, 0.0134F, -0.4279F, 0.0067F));

		PartDefinition Bile_r2 = BileCluster.addOrReplaceChild("Bile_r2", CubeListBuilder.create().texOffs(25, 78).addBox(-3.0F, -4.0F, -3.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(-1.5F, -4.2F, 0.9F, 0.3972F, 0.0464F, -0.2315F));

		PartDefinition Bile_r3 = BileCluster.addOrReplaceChild("Bile_r3", CubeListBuilder.create().texOffs(25, 78).addBox(-3.0F, -4.0F, -3.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.4F)), PartPose.offsetAndRotation(-1.2F, -5.9F, -0.1F, 0.159F, 0.1551F, -0.0974F));

		PartDefinition Bile_r4 = BileCluster.addOrReplaceChild("Bile_r4", CubeListBuilder.create().texOffs(25, 78).addBox(-3.0F, -4.0F, -3.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(6.9F, -2.1F, 0.5F, 0.1396F, 0.192F, 0.2094F));

		PartDefinition Bile_r5 = BileCluster.addOrReplaceChild("Bile_r5", CubeListBuilder.create().texOffs(25, 78).addBox(-3.0F, -4.0F, -3.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.7F, -0.6F, 1.3F, 0.3234F, -0.098F, -0.3741F));

		PartDefinition Bile_r6 = BileCluster.addOrReplaceChild("Bile_r6", CubeListBuilder.create().texOffs(25, 78).addBox(-3.0F, -4.0F, -3.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.3F, -2.7F, -0.2F, -0.0877F, -0.1043F, -0.2177F));

		PartDefinition Bile_r7 = BileCluster.addOrReplaceChild("Bile_r7", CubeListBuilder.create().texOffs(25, 78).addBox(-3.0F, -4.0F, -3.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(1.6F, -1.7F, -0.6F, -0.073F, -0.3513F, -0.0928F));

		PartDefinition Bile_r8 = BileCluster.addOrReplaceChild("Bile_r8", CubeListBuilder.create().texOffs(25, 78).addBox(-3.0F, -4.0F, -3.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1223F, 0.052F, 0.2158F));
		...
		PartDefinition Foliage3_r1 = Head.addOrReplaceChild("Foliage3_r1", CubeListBuilder.create().texOffs(-6, 107).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.4624F, -3.8673F, -6.6211F, -1.4201F, 1.3088F, -1.5463F));
		...
		PartDefinition cube_r3 = HeadBileCluster.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(44, 81).addBox(-3.0F, -2.0F, -1.0F, 4.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-6.1F, -0.4F, -6.7F, -0.3367F, 0.623F, 0.0032F));

		PartDefinition cube_r4 = HeadBileCluster.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(44, 81).addBox(-3.0F, -2.0F, -1.0F, 4.0F, 6.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-7.6F, 1.8F, -4.0F, 1.2582F, 1.2982F, 1.1162F));

		PartDefinition Bile_r9 = HeadBileCluster.addOrReplaceChild("Bile_r9", CubeListBuilder.create().texOffs(25, 78).addBox(-3.0F, -4.0F, -3.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(-5.4F, 3.5F, -4.5F, 0.1223F, 0.052F, 0.2158F));

		PartDefinition Bile_r10 = HeadBileCluster.addOrReplaceChild("Bile_r10", CubeListBuilder.create().texOffs(25, 78).addBox(-3.0F, -4.0F, -3.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(-5.5F, 2.5F, -4.5F, -0.1686F, -0.0672F, -0.1779F));

		PartDefinition Bile_r11 = HeadBileCluster.addOrReplaceChild("Bile_r11", CubeListBuilder.create().texOffs(25, 78).addBox(-3.0F, -4.0F, -3.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.4F)), PartPose.offsetAndRotation(-6.8F, 1.2F, -2.1F, 0.2714F, 0.1717F, 0.177F));

		PartDefinition Bile_r12 = HeadBileCluster.addOrReplaceChild("Bile_r12", CubeListBuilder.create().texOffs(25, 78).addBox(-3.0F, -4.0F, -3.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(-4.6F, 0.7F, -4.5F, 0.1277F, -0.2944F, 0.1722F));

		PartDefinition Bile_r13 = HeadBileCluster.addOrReplaceChild("Bile_r13", CubeListBuilder.create().texOffs(25, 78).addBox(-3.0F, -4.0F, -3.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-6.8F, -0.2F, -4.2F, 0.0124F, -0.1885F, 0.5778F));

		PartDefinition Bile_r14 = HeadBileCluster.addOrReplaceChild("Bile_r14", CubeListBuilder.create().texOffs(25, 78).addBox(-3.0F, -4.0F, -3.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.1223F, 0.052F, 0.2158F));
		...
		PartDefinition Claw_r1 = BottomArmBase.addOrReplaceChild("Claw_r1", CubeListBuilder.create().texOffs(22, 93).addBox(-3.2834F, -3.091F, 0.0F, 5.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.0F, 4.0F, -5.0F, 3.1416F, 0.0F, 3.0543F));

		PartDefinition Claw_r2 = BottomArmBase.addOrReplaceChild("Claw_r2", CubeListBuilder.create().texOffs(22, 93).addBox(-3.2834F, -3.091F, 0.0F, 5.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(8.0F, 4.0F, -2.0F, 3.1416F, 0.0F, 3.0543F));
		...
		PartDefinition claw2_r1 = BottomArmBase2.addOrReplaceChild("claw2_r1", CubeListBuilder.create().texOffs(22, 93).addBox(-1.7F, -4.0F, 1.0F, 5.0F, 7.0F, 0.0F, new CubeDeformation(0.0F))
		.texOffs(22, 93).addBox(-1.7F, -4.0F, -2.0F, 5.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(7.0F, 5.0F, -3.0F, 0.0F, 0.0F, -0.0873F));
