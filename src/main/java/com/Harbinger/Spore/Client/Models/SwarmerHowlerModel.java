...
public class SwarmerHowlerModel<T extends Howler> extends EntityModel<T> implements TentacledModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r35 = Stub1.addOrReplaceChild("cube_r35", CubeListBuilder.create().texOffs(33, 44).addBox(-4.0F, -5.0F, -4.0F, 5.0F, 5.0F, 5.0F, new CubeDeformation(-0.6F)), PartPose.offsetAndRotation(2.7334F, -0.1856F, 2.3273F, 1.5615F, 0.0382F, -0.1242F));
		...
		PartDefinition Nerves_r1 = Nerves3.addOrReplaceChild("Nerves_r1", CubeListBuilder.create().texOffs(32, 94).addBox(0.0F, -5.0F, -2.5F, 0.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.7F, 0.0F, 0.0F, 3.0194F, -0.733F, -3.0543F));

		PartDefinition Nerves_r2 = Nerves3.addOrReplaceChild("Nerves_r2", CubeListBuilder.create().texOffs(32, 94).addBox(0.0F, -5.0F, -2.5F, 0.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.6F, 0.0F, 0.0F, -0.0175F, -1.3788F, 0.0873F));
		...
		PartDefinition Nerves_r3 = Nerves2.addOrReplaceChild("Nerves_r3", CubeListBuilder.create().texOffs(32, 94).addBox(0.0F, -5.0F, -2.5F, 0.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.7F, 0.0F, 0.0F, 3.0194F, -0.733F, -3.0543F));

		PartDefinition Nerves_r4 = Nerves2.addOrReplaceChild("Nerves_r4", CubeListBuilder.create().texOffs(32, 94).addBox(0.0F, -5.0F, -2.5F, 0.0F, 10.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.6F, 0.0F, 0.0F, -0.0175F, -1.3788F, 0.0873F));
		...
		PartDefinition LeftLeg = Howler.addOrReplaceChild("LeftLeg", CubeListBuilder.create().texOffs(63, 66).addBox(-1.25F, 0.0F, -2.0F, 3.0F, 8.0F, 4.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r46 = spine.addOrReplaceChild("cube_r46", CubeListBuilder.create().texOffs(45, 80).addBox(-2.0F, -4.0F, -2.25F, 3.0F, 4.0F, 4.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(-2.0F, 0.0F, -2.0F, 0.0F, -0.2618F, 0.0F));
		...
		PartDefinition BackTendril2_r1 = ActualTorso.addOrReplaceChild("BackTendril2_r1", CubeListBuilder.create().texOffs(120, 28).addBox(1.0F, -4.0F, -3.0F, 0.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.5F, -8.4F, 2.7F, -0.7854F, 0.0F, 0.0F));

		PartDefinition BackTendril1_r1 = ActualTorso.addOrReplaceChild("BackTendril1_r1", CubeListBuilder.create().texOffs(96, 39).addBox(1.0F, -4.0F, -3.0F, 0.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.4F, -8.4F, 2.7F, -1.0996F, 0.0F, 0.0F));

		PartDefinition TorsoClothes_r1 = ActualTorso.addOrReplaceChild("TorsoClothes_r1", CubeListBuilder.create().texOffs(84, 56).addBox(-3.0F, -4.0F, -2.0F, 6.0F, 8.0F, 4.0F, new CubeDeformation(0.1F))
		.texOffs(84, 15).addBox(-3.0F, -4.0F, -2.0F, 6.0F, 8.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -7.9F, 0.5F, 0.7854F, 0.0F, 0.0F));
		...
		PartDefinition BackJaw_r1 = Head2.addOrReplaceChild("BackJaw_r1", CubeListBuilder.create().texOffs(85, 51).addBox(-2.0F, -0.3F, 1.0F, 5.0F, 2.0F, 2.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(-0.5F, -0.2F, 0.0F, -0.3142F, 0.0F, 0.0F));

		PartDefinition BottomJaw_r1 = Head2.addOrReplaceChild("BottomJaw_r1", CubeListBuilder.create().texOffs(104, 15).addBox(-3.0F, -0.5703F, -4.705F, 6.0F, 1.0F, 5.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.0F, 1.9F, 1.4F, -0.0175F, 0.0F, 0.0F));

		PartDefinition HeadMain_r1 = Head2.addOrReplaceChild("HeadMain_r1", CubeListBuilder.create().texOffs(79, 67).addBox(-3.0F, 0.7F, -3.0F, 6.0F, 1.0F, 6.0F, new CubeDeformation(0.0F))
		.texOffs(84, 4).addBox(-3.0F, -4.3F, -3.0F, 6.0F, 5.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.3142F, 0.0F, 0.0F));
		...
		PartDefinition LeftArmTop_r1 = LeftArm2.addOrReplaceChild("LeftArmTop_r1", CubeListBuilder.create().texOffs(104, 21).addBox(-0.1F, -1.2564F, -1.5987F, 3.0F, 6.0F, 3.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(-0.3F, 0.75F, 0.1F, -0.1745F, 0.0F, 0.0F));
		...
		PartDefinition LeftClaw3_r1 = LeftArmLower.addOrReplaceChild("LeftClaw3_r1", CubeListBuilder.create().texOffs(90, 44).addBox(0.0F, -0.5754F, -2.9277F, 0.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.2F, 4.2645F, -0.8611F, 0.384F, 0.0F, 0.0F));

		PartDefinition LeftClaw2_r1 = LeftArmLower.addOrReplaceChild("LeftClaw2_r1", CubeListBuilder.create().texOffs(104, 45).addBox(0.0F, -0.5243F, -2.947F, 0.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.8F, 4.2118F, -0.8463F, 0.5934F, 0.0F, 0.0F));

		PartDefinition LeftClaw1_r1 = LeftArmLower.addOrReplaceChild("LeftClaw1_r1", CubeListBuilder.create().texOffs(84, 44).addBox(0.0F, -0.5243F, -2.947F, 0.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8F, 4.2118F, -0.8463F, 0.4363F, 0.0F, 0.0F));

		PartDefinition LeftArmBottom_r1 = LeftArmLower.addOrReplaceChild("LeftArmBottom_r1", CubeListBuilder.create().texOffs(108, 4).addBox(-1.5F, -0.4692F, -1.4297F, 3.0F, 6.0F, 3.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.8F, 0.2645F, -0.0611F, 0.1309F, 0.0F, 0.0F));
		...
		PartDefinition RightArmTop_r1 = RightArm2.addOrReplaceChild("RightArmTop_r1", CubeListBuilder.create().texOffs(84, 27).addBox(-2.8F, -1.1752F, -1.4829F, 3.0F, 6.0F, 3.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(0.6F, 0.85F, -0.1F, -0.1745F, 0.0F, 0.0F));
		...
		PartDefinition RightClaw3_r1 = RightArmLower.addOrReplaceChild("RightClaw3_r1", CubeListBuilder.create().texOffs(120, 41).addBox(-1.0F, -2.0F, -2.0F, 0.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.4F, -0.1F, -0.9F, 2.2166F, 0.0F, 0.0F));

		PartDefinition RightClaw2_r1 = RightArmLower.addOrReplaceChild("RightClaw2_r1", CubeListBuilder.create().texOffs(120, 36).addBox(-1.0F, -2.0F, -2.0F, 0.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.4F, -0.2F, -0.9F, 2.2166F, 0.0F, 0.0F));

		PartDefinition RightClaw1_r1 = RightArmLower.addOrReplaceChild("RightClaw1_r1", CubeListBuilder.create().texOffs(120, 8).addBox(-1.0F, -2.0F, -2.0F, 0.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.4F, -0.1F, -0.9F, 2.1991F, 0.0F, 0.0F));

		PartDefinition RightArmBottom_r1 = RightArmLower.addOrReplaceChild("RightArmBottom_r1", CubeListBuilder.create().texOffs(96, 30).addBox(-1.5F, -0.3831F, -1.5419F, 3.0F, 6.0F, 3.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(-4.4F, -5.3F, -2.3F, 0.1309F, 0.0F, 0.0F));
		...
		PartDefinition LeftLegBottom_r1 = LeftLegLower.addOrReplaceChild("LeftLegBottom_r1", CubeListBuilder.create().texOffs(84, 36).addBox(-1.5F, -0.7302F, -1.2213F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.0F, -2.5F, 2.2F, 1.1694F, 0.0F, 0.0F));
		...
		PartDefinition RightLegBottom_r1 = RightLeg2.addOrReplaceChild("RightLegBottom_r1", CubeListBuilder.create().texOffs(108, 30).addBox(-1.5F, -0.8367F, -1.4179F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.5F, -2.6F, -0.4F, 0.3491F, 0.0F, 0.0F));
	...
	public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		animateTentacleY(RightArm2,Mth.sin(ageInTicks/6)/6);
		animateTentacleX(LeftArm2,Mth.sin(ageInTicks/7)/8);
	}
