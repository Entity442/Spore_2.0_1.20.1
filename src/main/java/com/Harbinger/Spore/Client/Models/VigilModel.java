...
public class VigilModel<T extends Vigil> extends EntityModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Biomassbase_r1 = Biomasses.addOrReplaceChild("Biomassbase_r1", CubeListBuilder.create().texOffs(0, 0).addBox(-5.5F, -5.5F, -5.5F, 11.0F, 11.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8686F, 0.3937F, 1.6926F, 0.177F, -0.1987F, 0.0898F));
		...
		PartDefinition FungalPlane_r1 = BiomassDetails.addOrReplaceChild("FungalPlane_r1", CubeListBuilder.create().texOffs(47, 34).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.6419F, 2.8015F, -3.4025F, 1.0859F, -1.2932F, -0.7993F));
		...
		PartDefinition FungalPlane_r3 = BiomassDetails.addOrReplaceChild("FungalPlane_r3", CubeListBuilder.create().texOffs(47, 34).addBox(-3.0F, 0.0F, -3.0F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.7417F, 2.5451F, 2.2678F, -0.2817F, 0.6784F, -0.0488F));

		PartDefinition FungalStalks = BiomassDetails.addOrReplaceChild("FungalStalks", CubeListBuilder.create(), PartPose.offset(-4.0768F, -0.3312F, -4.3054F));

		PartDefinition FungalStalk1 = FungalStalks.addOrReplaceChild("FungalStalk1", CubeListBuilder.create().texOffs(16, 56).addBox(-1.6415F, -1.0005F, -1.613F, 2.0F, 3.0F, 2.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.7085F, -0.6646F, 0.613F, 0.0F, 0.0F, -0.5236F));

		PartDefinition FungalStalk1Seg3_r1 = FungalStalk1.addOrReplaceChild("FungalStalk1Seg3_r1", CubeListBuilder.create().texOffs(0, 22).addBox(-1.6123F, -1.7904F, -1.3487F, 2.0F, 5.0F, 2.0F, new CubeDeformation(-0.6F)), PartPose.offsetAndRotation(-0.5217F, -5.7954F, 0.5442F, 0.0873F, 0.4363F, -0.2182F));
		...
		PartDefinition Root2Detail2Seg2_r1 = Root1Detail2.addOrReplaceChild("Root2Detail2Seg2_r1", CubeListBuilder.create().texOffs(38, 79).addBox(-12.1372F, 9.1704F, 5.2504F, 4.0F, 2.0F, 2.0F, new CubeDeformation(-0.65F)), PartPose.offsetAndRotation(1.9367F, -9.6252F, 1.0786F, 0.206F, 0.4076F, -0.9762F));

		PartDefinition Root1Detail2Seg1_r1 = Root1Detail2.addOrReplaceChild("Root1Detail2Seg1_r1", CubeListBuilder.create().texOffs(79, 40).addBox(-11.1641F, 9.1704F, 1.4283F, 4.0F, 2.0F, 2.0F, new CubeDeformation(-0.45F)), PartPose.offsetAndRotation(1.9367F, -9.6252F, 1.0786F, 0.27F, 0.7897F, -0.8648F));
		...
		PartDefinition Root1DetailSmall2_r1 = Root1SmallDetails.addOrReplaceChild("Root1DetailSmall2_r1", CubeListBuilder.create().texOffs(38, 79).addBox(4.0438F, 7.0416F, -0.2856F, 4.0F, 2.0F, 2.0F, new CubeDeformation(-0.6F)), PartPose.offsetAndRotation(0.9367F, -11.3752F, 0.5786F, 1.7F, 0.3469F, 0.9995F));

		PartDefinition Root1DetailSmall1_r1 = Root1SmallDetails.addOrReplaceChild("Root1DetailSmall1_r1", CubeListBuilder.create().texOffs(24, 28).addBox(13.2594F, 1.9374F, -4.6722F, 3.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(0.9367F, -11.3752F, 0.5786F, 1.5395F, -0.5514F, 0.4852F));
		...
		PartDefinition Root2Detail1 = Root2Details.addOrReplaceChild("Root2Detail1", CubeListBuilder.create(), PartPose.offsetAndRotation(0.4199F, -6.8481F, -1.4222F, 2.864F, -0.1509F, 3.0251F));

		PartDefinition Root2Detail1Seg4_r1 = Root2Detail1.addOrReplaceChild("Root2Detail1Seg4_r1", CubeListBuilder.create().texOffs(78, 31).addBox(22.4778F, -8.7118F, -5.0278F, 4.0F, 2.0F, 2.0F, new CubeDeformation(-0.75F)), PartPose.offsetAndRotation(11.827F, -12.2814F, 15.5416F, 2.27F, 0.6524F, 1.6452F));
		...
		PartDefinition Root2Detail1Seg2_r1 = Root2Detail1.addOrReplaceChild("Root2Detail1Seg2_r1", CubeListBuilder.create().texOffs(38, 79).addBox(14.5874F, 0.5025F, -19.8384F, 4.0F, 2.0F, 2.0F, new CubeDeformation(-0.5F)), PartPose.offsetAndRotation(11.827F, -12.2814F, 15.5416F, 0.5996F, 0.1245F, 1.3912F));
		...
		PartDefinition Root2Detail2 = Root2Details.addOrReplaceChild("Root2Detail2", CubeListBuilder.create(), PartPose.offsetAndRotation(4.8527F, 1.1231F, 2.3581F, -1.8776F, 0.9844F, -2.2956F));
		...
		PartDefinition Root2DetailSmall1_r1 = Root2SmallDetails.addOrReplaceChild("Root2DetailSmall1_r1", CubeListBuilder.create().texOffs(24, 28).addBox(-0.0642F, -0.3488F, -1.1494F, 3.0F, 1.0F, 1.0F, new CubeDeformation(-0.25F)), PartPose.offsetAndRotation(1.2173F, 2.4917F, 2.0464F, 1.6909F, 0.3921F, 0.8362F));
		...
		PartDefinition FungalPlane_r4 = TorsoDetails.addOrReplaceChild("FungalPlane_r4", CubeListBuilder.create().texOffs(47, 34).addBox(-3.0746F, 0.974F, -3.2139F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.4553F, -1.297F, -0.5638F, 1.9438F, -0.4775F, -1.9859F));
		...
		PartDefinition TorsoStalk1Seg2_r1 = TorsoStalk1.addOrReplaceChild("TorsoStalk1Seg2_r1", CubeListBuilder.create().texOffs(0, 52).addBox(-0.0454F, -1.7506F, -1.0393F, 1.0F, 3.0F, 1.0F, new CubeDeformation(-0.15F)), PartPose.offsetAndRotation(-0.1189F, -0.1177F, -0.7685F, 1.7393F, -0.1282F, 0.6001F));
		...
		PartDefinition ArmLeft = Arm.addOrReplaceChild("ArmLeft", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.2215F, -0.8256F, -0.2477F, 0.3054F, -1.2217F, -1.6144F));
		...
		PartDefinition ArmLeftTop_r1 = ArmLeft.addOrReplaceChild("ArmLeftTop_r1", CubeListBuilder.create().texOffs(12, 72).addBox(-2.5112F, 3.2046F, -2.259F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.1956F, -3.9335F, 0.2151F, 0.2611F, 0.0151F, -0.0859F));
		...
		PartDefinition ArmRightCloth_r1 = ArmRight.addOrReplaceChild("ArmRightCloth_r1", CubeListBuilder.create().texOffs(1, 87).addBox(-0.9667F, -3.1641F, -1.3698F, 3.0F, 8.0F, 3.0F, new CubeDeformation(0.2F))
		.texOffs(28, 69).addBox(-0.9667F, -3.1641F, -1.3698F, 3.0F, 8.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.75F, 2.75F, 0.0F, -0.2259F, 0.133F, 0.5528F));
		...
		PartDefinition BottomJaw_r1 = Head.addOrReplaceChild("BottomJaw_r1", CubeListBuilder.create().texOffs(44, 28).addBox(-3.9704F, -0.109F, -5.0801F, 8.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.2449F, 2.0651F, 1.3196F, 0.48F, 0.0F, 0.0F));

		PartDefinition HeadTop_r1 = Head.addOrReplaceChild("HeadTop_r1", CubeListBuilder.create().texOffs(36, 14).addBox(-3.9704F, -3.5292F, -3.152F, 8.0F, 6.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.2449F, -2.3432F, -0.5714F, -0.48F, 0.0F, 0.0F));
		...
		PartDefinition TTSeg1Teeth1_r1 = TTSeg1Details.addOrReplaceChild("TTSeg1Teeth1_r1", CubeListBuilder.create().texOffs(7, 3).addBox(-1.7779F, -0.6892F, -0.3585F, 0.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.2085F, -7.616F, -5.0597F, 0.0803F, -0.0184F, 0.269F));
		...
		PartDefinition TTSeg2_r1 = TTSeg2.addOrReplaceChild("TTSeg2_r1", CubeListBuilder.create().texOffs(56, 57).addBox(-3.3F, -9.251F, -1.7936F, 5.0F, 11.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8F, -0.3471F, 1.0121F, -0.2618F, 0.0F, 0.0F));

		PartDefinition TTSeg2Details = TTSeg2.addOrReplaceChild("TTSeg2Details", CubeListBuilder.create(), PartPose.offset(0.2455F, -0.503F, 0.21F));

		PartDefinition TTSeg2Teeth3_r1 = TTSeg2Details.addOrReplaceChild("TTSeg2Teeth3_r1", CubeListBuilder.create().texOffs(0, 36).addBox(-1.125F, -3.7435F, 1.8669F, 0.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8201F, -4.831F, 1.3656F, -0.2674F, -0.0687F, -0.111F));
		...
		PartDefinition TTSeg3_r1 = TTSeg3.addOrReplaceChild("TTSeg3_r1", CubeListBuilder.create().texOffs(0, 68).addBox(-1.0F, -7.2883F, -2.637F, 4.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, -0.9894F, 0.4357F, 0.2182F, 0.0F, 0.0F));
		...
		PartDefinition TTS3Teeth2_r1 = TTSeg3Details.addOrReplaceChild("TTS3Teeth2_r1", CubeListBuilder.create().texOffs(18, 36).addBox(0.275F, -2.4901F, -2.1757F, 0.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.6603F, -3.9223F, -2.7452F, 0.3796F, -0.2079F, -0.3157F));

		PartDefinition TTS3Teeth1_r1 = TTSeg3Details.addOrReplaceChild("TTS3Teeth1_r1", CubeListBuilder.create().texOffs(65, 69).addBox(-0.75F, -2.0383F, -1.437F, 0.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5177F, -3.607F, -3.4521F, 0.2182F, 0.0F, 0.0F));
		...
		PartDefinition EyeConnector1 = Connectors.addOrReplaceChild("EyeConnector1", CubeListBuilder.create(), PartPose.offset(-1.9081F, -0.9207F, -0.4374F));

		PartDefinition Connector1Seg1_r1 = EyeConnector1.addOrReplaceChild("Connector1Seg1_r1", CubeListBuilder.create().texOffs(24, 46).addBox(-0.9892F, -1.4782F, -1.3719F, 1.0F, 3.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.6745F, -1.0621F, 0.0837F, 0.182F, -0.3968F, -0.5952F));
		...
		PartDefinition Connector3Seg2_r2 = EyeConnector4.addOrReplaceChild("Connector3Seg2_r2", CubeListBuilder.create().texOffs(18, 43).addBox(1.0819F, -1.6202F, -0.6406F, 1.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0817F, -1.4844F, -1.2549F, 0.0035F, 1.4376F, -0.0485F));
	...
	public void setupAnim(T vigil, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.Biomasses.getChild("BiomassDetails").getChild("FungalStalks").xRot = Mth.sin(ageInTicks/4)/6;
		this.Biomasses.getChild("BiomassDetails").getChild("FungalStalks").zRot = Mth.sin(ageInTicks/7)/6;
		this.Limbs.getChild("Arm").yRot = Mth.sin(ageInTicks/8)/6;
		this.Limbs.getChild("LegRight").yRot = Mth.sin(ageInTicks/7)/5;
		this.Limbs.getChild("LegLeft").zRot = Mth.sin(ageInTicks/5)/9;
		this.HeadPivot.yRot = netHeadYaw / (180F / (float) Math.PI);
		this.HeadPivot.getChild("TTSeg1").xRot = -0.3f + Mth.sin(ageInTicks/7)/6;
		...
		if (entity != null) {
			...
			if (d0 > 0.0D) {
				this.HeadPivot.getChild("TTSeg1").getChild("TTSeg2").getChild("TTSeg3").getChild("Eye").getChild("pupil").y = -3.0F;
			} else {
				this.HeadPivot.getChild("TTSeg1").getChild("TTSeg2").getChild("TTSeg3").getChild("Eye").getChild("pupil").y = -2.0F;
			}
			...
			this.HeadPivot.getChild("TTSeg1").getChild("TTSeg2").getChild("TTSeg3").getChild("Eye").getChild("pupil").x =1+ Mth.sqrt((float)Math.abs(d1)) * 1.5F * (float)Math.signum(d1);
		}
	}
