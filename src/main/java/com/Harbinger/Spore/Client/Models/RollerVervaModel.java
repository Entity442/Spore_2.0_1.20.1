...
public class RollerVervaModel<T extends Thorn> extends EntityModel<T> implements TentacledModel {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Spore.MODID, "rollervervamodel"), "main");
	...
	public RollerVervaModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition RollerPart = Torn.addOrReplaceChild("RollerPart", CubeListBuilder.create(), PartPose.offset(2.5F, -12.9F, -2.2F));
