...
public class ScamperVillagerModel<T extends Scamper> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Spore.MODID, "scampervillagermodel"), "main");
	...
	public ScamperVillagerModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition cube_r3 = body.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(31, 13).addBox(-2.0F, -23.0F, 6.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 22.0F, -3.0F, 0.2233F, -0.2129F, -0.0479F));
		...
		PartDefinition cloths = body.addOrReplaceChild("cloths", CubeListBuilder.create().texOffs(102, 23).addBox(-4.0F, -2.0F, -2.5F, 8.0F, 7.0F, 5.0F, new CubeDeformation(0.15F)), PartPose.offset(0.0F, 9.0F, 0.0F));

		PartDefinition cube_r4 = cloths.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(92, 35).addBox(-5.0F, -8.0F, -3.0F, 8.0F, 8.0F, 5.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(1.0F, -2.0F, 0.5F, 0.3491F, 0.0F, 0.0F));
		...
		PartDefinition cube_r5 = LeftForArm.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(0, 57).addBox(-1.0F, 0.0F, -1.5F, 3.0F, 6.0F, 3.0F, new CubeDeformation(0.1F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.0873F, 0.0F, 0.0F));
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head", CubeListBuilder.create().texOffs(96, 0).addBox(-4.0F, -10.0F, -4.0F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F))
		.texOffs(42, 6).addBox(-4.0F, -2.0F, 0.0F, 8.0F, 2.0F, 4.0F, new CubeDeformation(0.0F))
		.texOffs(118, 16).addBox(-1.0F, -5.0F, -6.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
		...
		PartDefinition cube_r6 = head.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(57, 61).addBox(-4.0F, -26.0F, -1.0F, 7.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 19.5F, 2.5F, 0.0F, 0.0F, -0.1309F));

		PartDefinition cube_r7 = head.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(58, 61).addBox(-4.0F, -24.0F, -4.0F, 7.0F, 0.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, 17.5F, -0.5F, -0.0873F, 0.9163F, 0.2618F));

		PartDefinition cube_r8 = head.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(31, 12).addBox(-1.0F, -26.0F, 2.0F, 4.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 17.5F, 2.5F, 0.0436F, 0.0F, 0.0F));

		PartDefinition flower2 = head.addOrReplaceChild("flower2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.5F, -9.5F, -0.5F, 0.238F, -0.3148F, -0.0403F));

		PartDefinition cube_r9 = flower2.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(35, 68).addBox(-4.0406F, 0.0F, 0.0F, 7.0711F, 0.0F, 6.061F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r10 = flower2.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(35, 68).addBox(0.0F, 0.0F, -3.0305F, 6.061F, 0.0F, 6.061F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5051F, 0.0F, 0.0F, 0.0F, 0.0F, -0.3927F));

		PartDefinition cube_r11 = flower2.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(35, 68).addBox(-4.0406F, 0.0F, -6.061F, 7.0711F, 0.0F, 6.061F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r12 = flower2.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(35, 68).addBox(-6.061F, 0.0F, -3.0305F, 6.061F, 0.0F, 6.061F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5051F, 0.0F, 0.0F, 0.0F, 0.0F, 0.3927F));

		PartDefinition flower = head.addOrReplaceChild("flower", CubeListBuilder.create(), PartPose.offsetAndRotation(2.5F, -8.0F, -2.5F, 0.6655F, -0.2266F, 0.3196F));

		PartDefinition cube_r13 = flower.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(56, 61).addBox(-5.52F, 0.0F, 0.0F, 9.66F, 0.0F, 8.28F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r14 = flower.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(56, 61).addBox(0.0F, 0.0F, -4.14F, 8.28F, 0.0F, 8.28F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.69F, 0.0F, 0.0F, 0.0F, 0.0F, -0.3927F));

		PartDefinition cube_r15 = flower.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(56, 61).addBox(-5.52F, 0.0F, -8.28F, 9.66F, 0.0F, 8.28F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r16 = flower.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(56, 61).addBox(-8.28F, 0.0F, -4.14F, 8.28F, 0.0F, 8.28F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.69F, 0.0F, 0.0F, 0.0F, 0.0F, 0.3927F));

		PartDefinition flower3 = head.addOrReplaceChild("flower3", CubeListBuilder.create(), PartPose.offsetAndRotation(-1.5F, -7.5F, 2.5F, -0.9553F, -0.8558F, 0.2404F));

		PartDefinition cube_r17 = flower3.addOrReplaceChild("cube_r17", CubeListBuilder.create().texOffs(35, 68).addBox(-4.0406F, 0.0F, 0.0F, 7.0711F, 0.0F, 6.061F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r18 = flower3.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(35, 68).addBox(0.0F, 0.0F, -3.0305F, 6.061F, 0.0F, 6.061F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5051F, 0.0F, 0.0F, 0.0F, 0.0F, -0.3927F));

		PartDefinition cube_r19 = flower3.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(35, 68).addBox(-4.0406F, 0.0F, -6.061F, 7.0711F, 0.0F, 6.061F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r20 = flower3.addOrReplaceChild("cube_r20", CubeListBuilder.create().texOffs(35, 68).addBox(-6.061F, 0.0F, -3.0305F, 6.061F, 0.0F, 6.061F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5051F, 0.0F, 0.0F, 0.0F, 0.0F, 0.3927F));
		...
		PartDefinition cube_r21 = body2.addOrReplaceChild("cube_r21", CubeListBuilder.create().texOffs(12, 80).addBox(-2.0F, -4.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, -13.0F, 0.0F, -0.7854F, 0.0F));
		...
		PartDefinition cube_r22 = body3.addOrReplaceChild("cube_r22", CubeListBuilder.create().texOffs(12, 80).addBox(-2.0F, -4.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, -13.0F, 0.0F, -0.7854F, 0.0F));
		...
		PartDefinition cube_r23 = body4.addOrReplaceChild("cube_r23", CubeListBuilder.create().texOffs(12, 80).addBox(-2.0F, -4.0F, -2.0F, 4.0F, 4.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, -13.0F, 0.0F, -0.7854F, 0.0F));
