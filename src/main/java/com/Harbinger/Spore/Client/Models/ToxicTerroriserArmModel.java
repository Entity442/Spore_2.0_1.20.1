...
public class ToxicTerroriserArmModel<T extends LivingEntity> extends EntityModel<T> implements TentacledModel{
	...
	public ToxicTerroriserArmModel() {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Terrorrizer = partdefinition.addOrReplaceChild("Terrorrizer", CubeListBuilder.create(), PartPose.offsetAndRotation(-5.0F, 13.0F, -3.0F, 1.5708F, 0.0F, 0.0F));
		...
		.texOffs(0, 60).addBox(-1.0F, -12.0F, -19.0F, 2.0F, 1.0F, 25.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 8.0F, 0.0F));
		...
		.texOffs(54, 60).addBox(-2.0F, -13.4F, 5.65F, 4.0F, 4.0F, 15.0F, new CubeDeformation(-0.01F)), PartPose.offset(0.0F, 8.0F, 0.0F));
		...
		.texOffs(18, 123).addBox(0.0F, -7.0F, 10.0F, 0.0F, 4.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 8.0F, 0.0F));
		...
		PartDefinition tumor = Terrorrizer.addOrReplaceChild("tumor", CubeListBuilder.create(), PartPose.offset(0.0F, 8.0F, 0.0F));
