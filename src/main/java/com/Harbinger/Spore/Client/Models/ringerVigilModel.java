...
public class ringerVigilModel<T extends Vigil> extends EntityModel<T> implements TentacledModel {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Spore.MODID, "ringervigilmodel"), "main");
	private final ModelPart Vigil;
	...
	private final ModelPart Root2Details;
	private final ModelPart Root2Detail1;
	private final ModelPart Root2Detail2;
	private final ModelPart Root2SmallDetails;
	private final ModelPart Body;
	private final ModelPart Torso;
	private final ModelPart TorsoDetails;
	private final ModelPart TorsoStalk1;
	private final ModelPart TorsoStalk2;
	private final ModelPart TorsoConnectors;
	private final ModelPart Limbs;
	private final ModelPart Arm;
	private final ModelPart ArmLeft;
	private final ModelPart LegLeft;
	private final ModelPart LegLeftDetails;
	private final ModelPart LegRight;
	private final ModelPart LegRightDetails;
	private final ModelPart LegRightDetail1;
	private final ModelPart ArmRight;
	private final ModelPart HeadPivot;
	private final ModelPart Head;
	private final ModelPart TTSeg1;
	private final ModelPart TTSeg1Details;
	private final ModelPart TTSeg2;
	private final ModelPart TTSeg2Details;
	private final ModelPart TTSeg3;
	private final ModelPart TTSeg3Details;
	private final ModelPart Connectors;
	private final ModelPart EyeConnector1;
	private final ModelPart EyeConnector2;
	private final ModelPart EyeConnector3;
	private final ModelPart EyeConnector4;
	...
	private final ModelPart HeadDetails;
	private final ModelPart bellringerhead;
	private final ModelPart HeadDetails2;
	private final ModelPart flower5;
	private final ModelPart rightArm;
	private final ModelPart tacobell;

	public ringerVigilModel(ModelPart root) {
		this.Vigil = root.getChild("Vigil");
		this.Biomasses = this.Vigil.getChild("Biomasses");
		this.BiomassDetails = this.Biomasses.getChild("BiomassDetails");
		this.FungalStalks = this.BiomassDetails.getChild("FungalStalks");
		this.Roots = this.Vigil.getChild("Roots");
		...
		this.Root2Details = this.Root2.getChild("Root2Details");
		this.Root2Detail1 = this.Root2Details.getChild("Root2Detail1");
		this.Root2Detail2 = this.Root2Details.getChild("Root2Detail2");
		this.Root2SmallDetails = this.Root2Details.getChild("Root2SmallDetails");
		this.Body = this.Vigil.getChild("Body");
		this.Torso = this.Body.getChild("Torso");
		this.TorsoDetails = this.Torso.getChild("TorsoDetails");
		this.TorsoStalk1 = this.TorsoDetails.getChild("TorsoStalk1");
		this.TorsoStalk2 = this.TorsoDetails.getChild("TorsoStalk2");
		this.TorsoConnectors = this.TorsoDetails.getChild("TorsoConnectors");
		this.Limbs = this.Vigil.getChild("Limbs");
		this.Arm = this.Limbs.getChild("Arm");
		this.ArmLeft = this.Arm.getChild("ArmLeft");
		this.LegLeft = this.Limbs.getChild("LegLeft");
		this.LegLeftDetails = this.LegLeft.getChild("LegLeftDetails");
		this.LegRight = this.Limbs.getChild("LegRight");
		this.LegRightDetails = this.LegRight.getChild("LegRightDetails");
		this.LegRightDetail1 = this.LegRightDetails.getChild("LegRightDetail1");
		this.ArmRight = this.Limbs.getChild("ArmRight");
		this.HeadPivot = this.Vigil.getChild("HeadPivot");
		this.Head = this.HeadPivot.getChild("Head");
		this.TTSeg1 = this.HeadPivot.getChild("TTSeg1");
		this.TTSeg1Details = this.TTSeg1.getChild("TTSeg1Details");
		this.TTSeg2 = this.TTSeg1.getChild("TTSeg2");
		this.TTSeg2Details = this.TTSeg2.getChild("TTSeg2Details");
		this.TTSeg3 = this.TTSeg2.getChild("TTSeg3");
		this.TTSeg3Details = this.TTSeg3.getChild("TTSeg3Details");
		this.Connectors = this.TTSeg3.getChild("Connectors");
		this.EyeConnector1 = this.Connectors.getChild("EyeConnector1");
		this.EyeConnector2 = this.Connectors.getChild("EyeConnector2");
		this.EyeConnector3 = this.Connectors.getChild("EyeConnector3");
		this.EyeConnector4 = this.Connectors.getChild("EyeConnector4");
		this.Eye = this.TTSeg3.getChild("Eye");
		this.pupil = this.Eye.getChild("pupil");
		this.flower3 = this.HeadPivot.getChild("flower3");
		this.flower4 = this.HeadPivot.getChild("flower4");
		this.bellbody = this.Vigil.getChild("bellbody");
		this.leftArm = this.bellbody.getChild("leftArm");
		this.HeadDetails = this.bellbody.getChild("HeadDetails");
		this.bellringerhead = this.bellbody.getChild("bellringerhead");
		this.HeadDetails2 = this.bellringerhead.getChild("HeadDetails2");
		this.flower5 = this.bellringerhead.getChild("flower5");
		this.rightArm = this.bellbody.getChild("rightArm");
		this.tacobell = this.rightArm.getChild("tacobell");
	}
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Vigil = partdefinition.addOrReplaceChild("Vigil", CubeListBuilder.create(), PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition Biomasses = Vigil.addOrReplaceChild("Biomasses", CubeListBuilder.create(), PartPose.offset(-2.507F, -5.0455F, -1.2225F));
		...
		PartDefinition Roots = Vigil.addOrReplaceChild("Roots", CubeListBuilder.create(), PartPose.offset(0.0F, -4.0F, 0.0F));
		...
		PartDefinition Body = Vigil.addOrReplaceChild("Body", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition Limbs = Vigil.addOrReplaceChild("Limbs", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition LegLeftDetails = LegLeft.addOrReplaceChild("LegLeftDetails", CubeListBuilder.create(), PartPose.offset(0.6941F, 4.7783F, -0.5544F));

		PartDefinition Tumor_r1 = LegLeftDetails.addOrReplaceChild("Tumor_r1", CubeListBuilder.create().texOffs(17, 10).addBox(-2.5969F, -3.8261F, -2.6063F, 6.0F, 6.0F, 6.0F, new CubeDeformation(-1.0F)), PartPose.offsetAndRotation(0.6941F, -0.2217F, -0.5544F, 0.3054F, 0.3054F, -3.1416F));
		...
		PartDefinition ArmRight = Limbs.addOrReplaceChild("ArmRight", CubeListBuilder.create(), PartPose.offsetAndRotation(-4.3788F, -13.5169F, 0.6838F, 0.1309F, 0.0F, 0.0F));

		PartDefinition ArmRight_r1 = ArmRight.addOrReplaceChild("ArmRight_r1", CubeListBuilder.create().texOffs(0, 90).addBox(-1.5983F, -0.4522F, -1.5855F, 3.0F, 9.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.2798F, -0.3416F, 0.2382F, -1.624F, -1.4386F, 2.5635F));

		PartDefinition HeadPivot = Vigil.addOrReplaceChild("HeadPivot", CubeListBuilder.create(), PartPose.offset(0.0F, -15.0F, 0.0F));
		...
		PartDefinition TTseg_r1 = TTSeg1Details.addOrReplaceChild("TTseg_r1", CubeListBuilder.create().texOffs(44, 26).addBox(-0.9274F, -1.6148F, -1.3199F, 0.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.8071F, -7.8007F, -3.8942F, 0.1988F, 0.0808F, -0.1629F));

		PartDefinition TTseg_r2 = TTSeg1Details.addOrReplaceChild("TTseg_r2", CubeListBuilder.create().texOffs(7, 3).addBox(-1.778F, -0.6892F, -0.3585F, 0.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.2085F, -7.616F, -5.0597F, 0.0803F, -0.0184F, 0.269F));
		...
		PartDefinition TTseg_r3 = TTSeg2.addOrReplaceChild("TTseg_r3", CubeListBuilder.create().texOffs(56, 57).addBox(-3.3F, -9.2509F, -1.7936F, 5.0F, 11.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.8F, -0.3472F, 1.0121F, -0.2618F, 0.0F, 0.0F));
		...
		PartDefinition TTseg_r4 = TTSeg2Details.addOrReplaceChild("TTseg_r4", CubeListBuilder.create().texOffs(0, 36).addBox(-1.125F, -3.7435F, 1.8669F, 0.0F, 8.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.82F, -4.8311F, 1.3656F, -0.2674F, -0.0687F, -0.111F));

		PartDefinition TTseg_r5 = TTSeg2Details.addOrReplaceChild("TTseg_r5", CubeListBuilder.create().texOffs(24, 70).addBox(-1.0748F, -4.5028F, -1.8071F, 0.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5469F, -5.1408F, 0.3583F, -0.2952F, -0.0566F, -0.0607F));

		PartDefinition TTseg_r6 = TTSeg2Details.addOrReplaceChild("TTseg_r6", CubeListBuilder.create().texOffs(0, 77).addBox(-0.9343F, -4.5027F, -1.0326F, 0.0F, 11.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.262F, -5.0733F, -1.1303F, -0.2674F, 0.3181F, -0.0313F));
		...
		PartDefinition TTseg_r7 = TTSeg3.addOrReplaceChild("TTseg_r7", CubeListBuilder.create().texOffs(0, 68).addBox(-1.0F, -7.2882F, -2.637F, 4.0F, 9.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0F, -0.9894F, 0.4357F, 0.2182F, 0.0F, 0.0F));
		...
		PartDefinition flower3 = HeadPivot.addOrReplaceChild("flower3", CubeListBuilder.create(), PartPose.offsetAndRotation(-0.25F, -5.75F, 5.0F, -1.5441F, -0.0877F, 0.0323F));

		PartDefinition cube_r1 = flower3.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(104, 6).addBox(-5.9833F, 0.0403F, -2.001F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.3927F));

		PartDefinition cube_r2 = flower3.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(104, 6).addBox(-0.0167F, 0.0403F, -2.001F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.3927F));

		PartDefinition cube_r3 = flower3.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(104, 0).addBox(-4.0F, 0.4226F, 0.9063F, 7.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 0.0F, 0.0F, 0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r4 = flower3.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(104, 0).addBox(-4.0F, -0.342F, -5.0603F, 7.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 0.0F, 0.0F, -0.3927F, 0.0F, 0.0F));

		PartDefinition flower4 = HeadPivot.addOrReplaceChild("flower4", CubeListBuilder.create(), PartPose.offsetAndRotation(-2.25F, -5.75F, 1.0F, -1.0735F, -1.5216F, -0.46F));

		PartDefinition cube_r5 = flower4.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(104, 6).addBox(-5.9833F, 0.0403F, -2.001F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, 0.3927F));

		PartDefinition cube_r6 = flower4.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(104, 6).addBox(-0.0167F, 0.0403F, -2.001F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.0F, -0.3927F));

		PartDefinition cube_r7 = flower4.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(104, 0).addBox(-4.0F, 0.4226F, 0.9063F, 7.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 0.0F, 0.0F, 0.3927F, 0.0F, 0.0F));

		PartDefinition cube_r8 = flower4.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(104, 0).addBox(-4.0F, -0.342F, -5.0603F, 7.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.5F, 0.0F, 0.0F, -0.3927F, 0.0F, 0.0F));

		PartDefinition bellbody = Vigil.addOrReplaceChild("bellbody", CubeListBuilder.create(), PartPose.offsetAndRotation(4.15F, -15.1F, 2.3F, 3.1416F, -0.3491F, -2.9671F));

		PartDefinition cube_r9 = bellbody.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(14, 14).addBox(-2.0F, -3.0F, -1.0F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.4298F, 4.0F, -1.0875F, -0.0169F, -0.2944F, 0.4239F));

		PartDefinition cube_r10 = bellbody.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(13, 13).addBox(-2.0F, -3.0F, -1.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5702F, -2.0F, 2.9125F, 0.1886F, -0.7885F, -0.2271F));

		PartDefinition cube_r11 = bellbody.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(13, 13).addBox(-2.0F, -3.0F, -1.0F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5702F, -2.0F, -0.0875F, 0.529F, -0.2909F, 0.196F));

		PartDefinition cube_r12 = bellbody.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(15, 14).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.4298F, -3.0F, 4.9125F, 0.5033F, 0.1509F, -0.6156F));

		PartDefinition cube_r13 = bellbody.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(15, 14).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.5702F, 1.0F, 3.9125F, -0.4337F, 0.2253F, 2.0095F));

		PartDefinition cube_r14 = bellbody.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(15, 14).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.5702F, 1.0F, -0.0875F, 0.4295F, 0.3093F, -0.9356F));

		PartDefinition bellbody_r1 = bellbody.addOrReplaceChild("bellbody_r1", CubeListBuilder.create().texOffs(33, 0).addBox(-3.9332F, -2.4623F, -1.6595F, 8.0F, 5.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.5702F, -1.75F, 0.9125F, 0.9536F, -1.4214F, -1.8332F));

		PartDefinition leftArm = bellbody.addOrReplaceChild("leftArm", CubeListBuilder.create(), PartPose.offset(-1.699F, 0.2331F, -2.4037F));

		PartDefinition ArmLeft_r1 = leftArm.addOrReplaceChild("ArmLeft_r1", CubeListBuilder.create().texOffs(0, 104).addBox(-0.9667F, -3.1641F, -1.3698F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, -2.0F, -0.425F, -0.3575F, 0.573F));

		PartDefinition HeadDetails = bellbody.addOrReplaceChild("HeadDetails", CubeListBuilder.create(), PartPose.offset(7.9246F, -15.5711F, -3.2368F));

		PartDefinition bellringerhead = bellbody.addOrReplaceChild("bellringerhead", CubeListBuilder.create(), PartPose.offsetAndRotation(-4.3202F, -3.7505F, 1.0484F, 1.2595F, 1.5162F, 0.7934F));

		PartDefinition FungalPlane_r6 = bellringerhead.addOrReplaceChild("FungalPlane_r6", CubeListBuilder.create().texOffs(47, 34).addBox(-3.0747F, 0.974F, -3.2139F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.186F, 2.3698F, 1.422F, -2.9376F, -1.234F, 2.6886F));

		PartDefinition FungalPlane_r7 = bellringerhead.addOrReplaceChild("FungalPlane_r7", CubeListBuilder.create().texOffs(47, 34).addBox(-3.0747F, 0.974F, -3.2139F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.186F, -5.6302F, 0.422F, 2.3342F, -1.0837F, -2.51F));

		PartDefinition cube_r15 = bellringerhead.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(15, 14).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.25F, -0.2495F, -0.1359F, 0.5236F, 0.0F, -0.3491F));

		PartDefinition cube_r16 = bellringerhead.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(14, 14).addBox(-2.0F, -3.0F, -1.0F, 3.0F, 3.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.25F, -1.2495F, 0.8641F, 0.529F, -0.2909F, 0.196F));

		PartDefinition FungalPlane_r8 = bellringerhead.addOrReplaceChild("FungalPlane_r8", CubeListBuilder.create().texOffs(47, 34).addBox(-3.0747F, 0.974F, -3.2139F, 6.0F, 0.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.186F, -3.6302F, 4.422F, -3.0623F, -1.2401F, 2.8206F));

		PartDefinition nose_r1 = bellringerhead.addOrReplaceChild("nose_r1", CubeListBuilder.create().texOffs(22, 122).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.0F, -5.0F, -0.5221F, 0.0368F, 0.0791F));

		PartDefinition BottomJaw_r2 = bellringerhead.addOrReplaceChild("BottomJaw_r2", CubeListBuilder.create().texOffs(44, 28).addBox(-3.9705F, -0.109F, -5.0801F, 8.0F, 1.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.2449F, 1.0651F, 0.3196F, -0.1269F, 0.0507F, 0.1616F));

		PartDefinition HeadBottom_r1 = bellringerhead.addOrReplaceChild("HeadBottom_r1", CubeListBuilder.create().texOffs(16, 61).addBox(-3.9705F, -1.0779F, -1.5035F, 8.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.2549F, 1.1799F, 1.0789F, -0.3491F, 0.0F, 0.0F));

		PartDefinition HeadTop_r2 = bellringerhead.addOrReplaceChild("HeadTop_r2", CubeListBuilder.create().texOffs(5, 112).addBox(-3.9705F, -5.5293F, -3.152F, 8.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.2449F, -2.3432F, -0.5714F, -0.48F, 0.0F, 0.0F));

		PartDefinition HeadDetails2 = bellringerhead.addOrReplaceChild("HeadDetails2", CubeListBuilder.create(), PartPose.offset(0.2449F, -3.8206F, -4.2852F));

		PartDefinition flower5 = bellringerhead.addOrReplaceChild("flower5", CubeListBuilder.create(), PartPose.offsetAndRotation(-1.5F, -7.9995F, -1.1359F, -0.1666F, -1.0068F, -0.4326F));
		...
		PartDefinition rightArm = bellbody.addOrReplaceChild("rightArm", CubeListBuilder.create(), PartPose.offset(-1.0F, -0.75F, 6.0F));

		PartDefinition ArmRight_r2 = rightArm.addOrReplaceChild("ArmRight_r2", CubeListBuilder.create().texOffs(0, 104).addBox(-1.445F, -0.287F, -1.3007F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.4512F, -2.8632F, 1.8047F, 1.88F, -0.91F, 0.0887F));

		PartDefinition ArmRight_r3 = rightArm.addOrReplaceChild("ArmRight_r3", CubeListBuilder.create().texOffs(0, 90).addBox(-1.5983F, -0.4522F, -1.5855F, 3.0F, 5.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.499F, -0.6169F, -0.4037F, 2.1069F, -0.91F, 0.0887F));

		PartDefinition tacobell = rightArm.addOrReplaceChild("tacobell", CubeListBuilder.create().texOffs(96, 108).addBox(-3.8087F, 10.9272F, -4.0313F, 8.0F, 2.0F, 8.0F, new CubeDeformation(0.0F))
		.texOffs(96, 95).addBox(-2.8087F, 3.9272F, -3.0313F, 6.0F, 7.0F, 6.0F, new CubeDeformation(0.0F))
		.texOffs(82, 122).addBox(-0.8087F, -0.0728F, -1.0313F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.9553F, -4.2362F, 3.9571F, 0.0012F, 0.5565F, 0.1649F));
	...
	public void setupAnim(T vigil, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.ArmRight.yRot = Mth.cos(ageInTicks/8)/6;
		this.LegRight.yRot = Mth.sin(ageInTicks/7)/5;
		this.LegLeft.zRot = Mth.cos(ageInTicks/5)/9;
		this.HeadPivot.yRot = netHeadYaw / (180F / (float) Math.PI);
		this.TTSeg2.xRot = this.TTSeg2.getInitialPose().xRot + Mth.sin(ageInTicks/7)/6;
		this.leftArm.yRot = Mth.cos(ageInTicks/5)/5;
		animateTentacleY(bellringerhead,Mth.sin(ageInTicks/6)/4);
		this.rightArm.yRot = Mth.sin(ageInTicks/6)/6;
		this.tacobell.xRot = Mth.sin(ageInTicks/6)/6;
		...
		if (entity != null) {
			...
			this.pupil.x =pupil.getInitialPose().x + Mth.sqrt((float)Math.abs(d1)) * 1.5F * (float)Math.signum(d1);
		}
	}

	@Override
	public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float r, float g, float b, float alpha) {
		Vigil.render(poseStack, vertexConsumer, packedLight, packedOverlay,r,g,b, alpha);
	}
}