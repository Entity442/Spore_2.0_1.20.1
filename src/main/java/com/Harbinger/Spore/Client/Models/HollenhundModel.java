...
public class HollenhundModel<T extends Hollenhund> extends EntityModel<T> implements TentacledModel{
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(Spore.MODID, "hollenhundmodel"), "main");
	...
	public HollenhundModel(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition tail = body.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(36, 18).addBox(-4.0F, -3.0F, 0.0F, 8.0F, 6.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 0.0F));
		...
		PartDefinition tail2 = tail.addOrReplaceChild("tail2", CubeListBuilder.create().texOffs(7, 49).addBox(-3.0F, -2.0F, 0.0F, 6.0F, 4.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 7.0F));

		PartDefinition tail3 = tail2.addOrReplaceChild("tail3", CubeListBuilder.create().texOffs(47, 59).addBox(-2.0F, -1.0F, 0.0F, 4.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 0.0F, 11.0F));
		...
		PartDefinition upperbody = body2.addOrReplaceChild("upperbody", CubeListBuilder.create().texOffs(0, 18).addBox(-5.0F, -4.0F, -8.0F, 10.0F, 8.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, -9.0F, 0.2618F, 0.0F, 0.0F));
		...
		PartDefinition cube_r4 = spine3.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(72, 103).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.4393F, 0.0F, -0.3674F, -0.0398F, 0.0891F, 0.0438F));

		PartDefinition cube_r5 = spine3.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(100, 103).addBox(-0.5F, -0.5F, -0.5F, 5.0F, 1.0F, 1.0F, new CubeDeformation(-0.025F)), PartPose.offsetAndRotation(-4.7939F, 7.7789F, -3.2329F, 0.1299F, 0.0422F, 0.0227F));

		PartDefinition cube_r6 = spine3.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(96, 103).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.6576F, -0.1527F, -4.2682F, 0.1309F, -0.1309F, 0.0F));

		PartDefinition cube_r7 = spine3.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(108, 89).addBox(-0.5F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(-0.025F)), PartPose.offsetAndRotation(-5.0293F, 7.8194F, -6.8498F, -0.0085F, -0.4798F, 0.0469F));

		PartDefinition cube_r8 = spine3.addOrReplaceChild("cube_r8", CubeListBuilder.create().texOffs(32, 104).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.6856F, -0.173F, -6.7892F, -0.0076F, -0.0435F, 0.0433F));

		PartDefinition cube_r9 = spine3.addOrReplaceChild("cube_r9", CubeListBuilder.create().texOffs(108, 87).addBox(-4.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.6931F, 0.0F, -6.6154F, -0.0076F, -0.0435F, 0.0433F));

		PartDefinition cube_r10 = spine3.addOrReplaceChild("cube_r10", CubeListBuilder.create().texOffs(108, 61).addBox(-4.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.2141F, 0.0F, -3.661F, -0.0077F, -0.1744F, 0.0443F));

		PartDefinition cube_r11 = spine3.addOrReplaceChild("cube_r11", CubeListBuilder.create().texOffs(58, 16).addBox(-3.0F, -0.5F, -0.5F, 3.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.4507F, 0.0F, -0.6288F, 0.0F, 0.0873F, 0.0F));

		PartDefinition cube_r12 = spine3.addOrReplaceChild("cube_r12", CubeListBuilder.create().texOffs(108, 57).addBox(-3.5F, -0.5F, -0.25F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.9663F, 7.9924F, -2.4614F, -0.0356F, -0.174F, -0.0274F));

		PartDefinition cube_r13 = spine3.addOrReplaceChild("cube_r13", CubeListBuilder.create().texOffs(76, 103).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.0421F, 0.0F, -2.1211F, 0.0F, 0.2201F, 0.0F));

		PartDefinition cube_r14 = spine3.addOrReplaceChild("cube_r14", CubeListBuilder.create().texOffs(84, 103).addBox(-4.5F, -0.5F, -0.5F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.1932F, 7.9924F, -5.0603F, -0.0465F, 0.085F, -0.0569F));

		PartDefinition cube_r15 = spine3.addOrReplaceChild("cube_r15", CubeListBuilder.create().texOffs(80, 103).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.1177F, 0.0F, -4.7196F, -0.0436F, -0.2182F, 0.0F));

		PartDefinition cube_r16 = spine3.addOrReplaceChild("cube_r16", CubeListBuilder.create().texOffs(108, 59).addBox(-0.4815F, -0.5F, -0.4194F, 4.0F, 1.0F, 1.0F, new CubeDeformation(-0.025F)), PartPose.offsetAndRotation(1.7F, 0.0F, -5.5598F, 0.0F, -0.2182F, 0.0F));
		...
		PartDefinition cube_r18 = rightjaw.addOrReplaceChild("cube_r18", CubeListBuilder.create().texOffs(18, 106).addBox(-2.0F, -3.0F, -0.5F, 2.0F, 6.0F, 1.0F, new CubeDeformation(-0.025F)), PartPose.offsetAndRotation(-2.0F, -3.0F, 0.25F, 0.0F, -0.7854F, 0.0F));

		PartDefinition cube_r19 = rightjaw.addOrReplaceChild("cube_r19", CubeListBuilder.create().texOffs(12, 106).addBox(0.0F, -3.0F, -0.5F, 2.0F, 6.0F, 1.0F, new CubeDeformation(-0.025F)), PartPose.offsetAndRotation(2.0F, -3.0F, 0.25F, 0.0F, 0.7854F, 0.0F));

		PartDefinition cube_r20 = rightjaw.addOrReplaceChild("cube_r20", CubeListBuilder.create().texOffs(106, 8).addBox(-2.0F, -2.0F, -0.5F, 4.0F, 2.0F, 1.0F, new CubeDeformation(-0.025F)), PartPose.offsetAndRotation(0.0F, -6.0F, 0.25F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r21 = rightjaw.addOrReplaceChild("cube_r21", CubeListBuilder.create().texOffs(100, 105).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -5.0F, -0.25F, 0.3491F, 0.0F, 0.3054F));

		PartDefinition cube_r22 = rightjaw.addOrReplaceChild("cube_r22", CubeListBuilder.create().texOffs(106, 6).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, -0.25F, 0.3054F, 0.0F, -0.1745F));

		PartDefinition cube_r23 = rightjaw.addOrReplaceChild("cube_r23", CubeListBuilder.create().texOffs(84, 105).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.0F, -0.25F, 0.3491F, 0.0F, 0.1745F));
		...
		PartDefinition cube_r24 = leftjaw.addOrReplaceChild("cube_r24", CubeListBuilder.create().texOffs(36, 106).addBox(0.0F, -3.0F, -0.5F, 2.0F, 6.0F, 1.0F, new CubeDeformation(-0.025F)), PartPose.offsetAndRotation(2.0F, -3.0F, 0.25F, 0.0F, 0.7854F, 0.0F));

		PartDefinition cube_r25 = leftjaw.addOrReplaceChild("cube_r25", CubeListBuilder.create().texOffs(106, 31).addBox(-2.0F, -3.0F, -0.5F, 2.0F, 6.0F, 1.0F, new CubeDeformation(-0.025F)), PartPose.offsetAndRotation(-2.0F, -3.0F, 0.25F, 0.0F, -0.7854F, 0.0F));

		PartDefinition cube_r26 = leftjaw.addOrReplaceChild("cube_r26", CubeListBuilder.create().texOffs(104, 17).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, -0.25F, 0.3491F, 0.0F, 0.1745F));

		PartDefinition cube_r27 = leftjaw.addOrReplaceChild("cube_r27", CubeListBuilder.create().texOffs(104, 15).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -5.0F, -0.25F, 0.48F, 0.0F, 0.4363F));

		PartDefinition cube_r28 = leftjaw.addOrReplaceChild("cube_r28", CubeListBuilder.create().texOffs(36, 104).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -4.0F, -0.25F, 0.4363F, 0.0F, -0.6109F));

		PartDefinition cube_r29 = leftjaw.addOrReplaceChild("cube_r29", CubeListBuilder.create().texOffs(104, 13).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.0F, -0.25F, 0.5672F, 0.0F, -0.3491F));

		PartDefinition cube_r30 = leftjaw.addOrReplaceChild("cube_r30", CubeListBuilder.create().texOffs(106, 19).addBox(-2.0F, -2.0F, -0.5F, 4.0F, 2.0F, 1.0F, new CubeDeformation(-0.025F)), PartPose.offsetAndRotation(0.0F, -6.0F, 0.25F, 0.7854F, 0.0F, 0.0F));
		...
		PartDefinition cube_r31 = midjaw.addOrReplaceChild("cube_r31", CubeListBuilder.create().texOffs(108, 107).addBox(0.0F, -2.5F, -2.0F, 0.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.8536F, -2.5F, -1.0607F, -0.2292F, 0.3602F, -0.3014F));

		PartDefinition cube_r32 = midjaw.addOrReplaceChild("cube_r32", CubeListBuilder.create().texOffs(24, 107).addBox(0.0F, -1.5F, -0.5F, 2.0F, 5.0F, 1.0F, new CubeDeformation(-0.025F)), PartPose.offsetAndRotation(1.5F, -3.5F, 0.0F, 0.0F, 0.7854F, 0.0F));

		PartDefinition cube_r33 = midjaw.addOrReplaceChild("cube_r33", CubeListBuilder.create().texOffs(42, 106).addBox(-2.0F, -1.5F, -0.5F, 2.0F, 5.0F, 1.0F, new CubeDeformation(-0.025F)), PartPose.offsetAndRotation(-1.5F, -3.5F, 0.0F, 0.0F, -0.7854F, 0.0F));

		PartDefinition cube_r34 = midjaw.addOrReplaceChild("cube_r34", CubeListBuilder.create().texOffs(110, 0).addBox(-1.5F, -2.0F, -0.5F, 3.0F, 2.0F, 1.0F, new CubeDeformation(-0.025F)), PartPose.offsetAndRotation(0.0F, -5.0F, 0.0F, 0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r35 = midjaw.addOrReplaceChild("cube_r35", CubeListBuilder.create().texOffs(108, 99).addBox(-1.5F, 0.0F, -2.0F, 3.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.5F, -0.5F, 0.3054F, 0.0F, 0.5236F));

		PartDefinition cube_r36 = midjaw.addOrReplaceChild("cube_r36", CubeListBuilder.create().texOffs(108, 97).addBox(-1.5F, 0.0F, -2.0F, 3.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -2.5F, -0.5F, 0.3491F, 0.0F, -0.2618F));

		PartDefinition cube_r37 = midjaw.addOrReplaceChild("cube_r37", CubeListBuilder.create().texOffs(108, 95).addBox(-1.5F, 0.0F, -2.0F, 3.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -5.0F, -0.5F, 0.5672F, 0.0F, 0.0F));
		...
		PartDefinition cube_r38 = jaw.addOrReplaceChild("cube_r38", CubeListBuilder.create().texOffs(90, 107).addBox(-2.0F, -2.5F, -0.5F, 2.0F, 5.0F, 1.0F, new CubeDeformation(-0.025F)), PartPose.offsetAndRotation(-3.5F, -2.5F, 0.0F, 0.0F, 0.7854F, 0.0F));

		PartDefinition cube_r39 = jaw.addOrReplaceChild("cube_r39", CubeListBuilder.create().texOffs(52, 68).addBox(0.0F, -2.5F, -0.5F, 0.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.5F, -2.5F, 1.4142F, 0.2132F, -0.762F, -0.3038F));

		PartDefinition cube_r40 = jaw.addOrReplaceChild("cube_r40", CubeListBuilder.create().texOffs(84, 107).addBox(0.0F, -2.5F, -0.5F, 2.0F, 5.0F, 1.0F, new CubeDeformation(-0.025F)), PartPose.offsetAndRotation(3.5F, -2.5F, 0.0F, 0.0F, -0.7854F, 0.0F));

		PartDefinition cube_r41 = jaw.addOrReplaceChild("cube_r41", CubeListBuilder.create().texOffs(74, 13).addBox(-3.5F, -2.0F, -0.5F, 7.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -5.0F, 0.0F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r42 = jaw.addOrReplaceChild("cube_r42", CubeListBuilder.create().texOffs(94, 4).addBox(-3.5F, 1.0F, -0.5F, 7.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.0F, 1.0F, -0.3054F, 0.0F, 0.1309F));

		PartDefinition cube_r43 = jaw.addOrReplaceChild("cube_r43", CubeListBuilder.create().texOffs(68, 46).addBox(-3.5F, 0.0F, 0.0F, 7.0F, 0.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -5.0F, 0.5F, -0.2618F, 0.0F, 0.0F));

		PartDefinition cube_r44 = jaw.addOrReplaceChild("cube_r44", CubeListBuilder.create().texOffs(88, 79).addBox(-3.5F, -1.0F, -0.5F, 7.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.0F, 1.0F, 0.0F, 0.0F, -0.1745F));

		PartDefinition cube_r45 = jaw.addOrReplaceChild("cube_r45", CubeListBuilder.create().texOffs(40, 16).addBox(-3.5F, 0.0F, 0.0F, 7.0F, 0.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -3.0F, 0.5F, -0.2618F, 0.0F, 0.3491F));
		...
		PartDefinition cube_r46 = rightsidejaw.addOrReplaceChild("cube_r46", CubeListBuilder.create().texOffs(100, 81).addBox(-2.0F, -0.5F, -2.0F, 4.0F, 1.0F, 2.0F, new CubeDeformation(-0.025F)), PartPose.offsetAndRotation(0.0F, 0.0F, -6.0F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r47 = rightsidejaw.addOrReplaceChild("cube_r47", CubeListBuilder.create().texOffs(86, 95).addBox(0.0F, -1.5F, -3.0F, 0.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, -1.4142F, -3.0F, 0.0F, 0.2182F, 0.7854F));

		PartDefinition cube_r48 = rightsidejaw.addOrReplaceChild("cube_r48", CubeListBuilder.create().texOffs(78, 65).addBox(-2.0F, -0.5F, -3.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(-0.025F)), PartPose.offsetAndRotation(-2.0F, 0.0F, -3.0F, 0.0F, 0.0F, 0.7854F));

		PartDefinition cube_r49 = rightsidejaw.addOrReplaceChild("cube_r49", CubeListBuilder.create().texOffs(76, 6).addBox(0.0F, -0.5F, -3.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(-0.025F)), PartPose.offsetAndRotation(2.0F, 0.0F, -3.0F, 0.0F, 0.0F, -0.7854F));

		PartDefinition cube_r50 = rightsidejaw.addOrReplaceChild("cube_r50", CubeListBuilder.create().texOffs(110, 101).addBox(-2.0F, -2.0F, 0.0F, 4.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.5F, -4.0F, -0.5236F, 0.2182F, 0.0F));

		PartDefinition cube_r51 = rightsidejaw.addOrReplaceChild("cube_r51", CubeListBuilder.create().texOffs(110, 69).addBox(-2.0F, -2.0F, 0.0F, 4.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.5F, -5.0F, -0.48F, -0.7418F, 0.0F));

		PartDefinition cube_r52 = rightsidejaw.addOrReplaceChild("cube_r52", CubeListBuilder.create().texOffs(110, 67).addBox(-2.0F, -2.0F, 0.0F, 4.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.5F, -3.0F, 0.0F, -0.3054F, 0.0F));
		...
		PartDefinition cube_r53 = leftsidejaw.addOrReplaceChild("cube_r53", CubeListBuilder.create().texOffs(100, 84).addBox(-2.0F, -0.5F, -2.0F, 4.0F, 1.0F, 2.0F, new CubeDeformation(-0.025F)), PartPose.offsetAndRotation(0.0F, 0.0F, -6.0F, -0.7854F, 0.0F, 0.0F));

		PartDefinition cube_r54 = leftsidejaw.addOrReplaceChild("cube_r54", CubeListBuilder.create().texOffs(52, 82).addBox(0.0F, -0.5F, -3.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(-0.025F)), PartPose.offsetAndRotation(2.0F, 0.0F, -3.0F, 0.0F, 0.0F, -0.7854F));

		PartDefinition cube_r55 = leftsidejaw.addOrReplaceChild("cube_r55", CubeListBuilder.create().texOffs(74, 95).addBox(0.0F, -2.0F, -3.0F, 0.0F, 2.0F, 6.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.3536F, -1.0607F, -3.0F, 0.0F, 0.1745F, 0.7854F));

		PartDefinition cube_r56 = leftsidejaw.addOrReplaceChild("cube_r56", CubeListBuilder.create().texOffs(70, 81).addBox(-2.0F, -0.5F, -3.0F, 2.0F, 1.0F, 6.0F, new CubeDeformation(-0.025F)), PartPose.offsetAndRotation(-2.0F, 0.0F, -3.0F, 0.0F, 0.0F, 0.7854F));

		PartDefinition cube_r57 = leftsidejaw.addOrReplaceChild("cube_r57", CubeListBuilder.create().texOffs(110, 63).addBox(-2.0F, -1.5F, 0.0F, 4.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.0F, -4.0F, 0.0F, 0.1309F, 0.0F));

		PartDefinition cube_r58 = leftsidejaw.addOrReplaceChild("cube_r58", CubeListBuilder.create().texOffs(110, 28).addBox(-2.0F, -1.5F, 0.0F, 4.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.4329F, -1.0F, -4.9526F, 0.0F, -0.3491F, 0.0F));

		PartDefinition cube_r59 = leftsidejaw.addOrReplaceChild("cube_r59", CubeListBuilder.create().texOffs(110, 65).addBox(-2.0F, -1.5F, 0.0F, 4.0F, 2.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.0F, -1.75F, 0.0F, -0.6109F, 0.0F));
		...
		PartDefinition rightarm = upperbody.addOrReplaceChild("rightarm", CubeListBuilder.create().texOffs(40, 0).addBox(-14.0F, -1.5F, -1.5F, 14.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, -2.0F, -5.0F, -0.5468F, -0.3796F, 1.024F));
		...
		PartDefinition leftarm = upperbody.addOrReplaceChild("leftarm", CubeListBuilder.create().texOffs(40, 10).addBox(0.0F, -1.5F, -1.5F, 14.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, -2.0F, -5.0F, -0.5468F, 0.3796F, -1.024F));
		...
		PartDefinition rightgrabarm = upperbody.addOrReplaceChild("rightgrabarm", CubeListBuilder.create().texOffs(66, 16).addBox(-10.0F, -1.0F, -1.0F, 10.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0F, 2.0F, -4.0F, -0.2139F, -0.6699F, 0.3365F));
		...
		PartDefinition leftgrabarm = upperbody.addOrReplaceChild("leftgrabarm", CubeListBuilder.create().texOffs(66, 20).addBox(0.0F, -1.0F, -1.0F, 10.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.0F, 2.0F, -4.0F, -0.2139F, 0.6699F, -0.3365F));
		...
		PartDefinition cube_r61 = tumors.addOrReplaceChild("cube_r61", CubeListBuilder.create().texOffs(96, 88).addBox(-1.5F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 0.5F, 0.0F, 0.4363F, -0.4363F, -0.3054F));

		PartDefinition cube_r62 = tumors.addOrReplaceChild("cube_r62", CubeListBuilder.create().texOffs(42, 96).addBox(-1.5F, -1.5F, -1.5F, 3.0F, 3.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -0.5F, 1.0F, 0.9163F, 0.5236F, 0.3491F));

		PartDefinition cube_r63 = tumors.addOrReplaceChild("cube_r63", CubeListBuilder.create().texOffs(108, 91).addBox(-1.0F, -1.0F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -1.0F, 0.0F, -0.5672F, -0.6981F, -0.3927F));
		...
		PartDefinition cube_r66 = spine2.addOrReplaceChild("cube_r66", CubeListBuilder.create().texOffs(68, 99).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 10.0F, 1.0F, new CubeDeformation(-0.025F)), PartPose.offsetAndRotation(5.4948F, -0.5F, 2.8466F, 0.0F, -0.0436F, 0.0F));

		PartDefinition cube_r67 = spine2.addOrReplaceChild("cube_r67", CubeListBuilder.create().texOffs(108, 51).addBox(-3.5F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.7656F, 8.423F, -0.7223F, -0.031F, 0.1392F, 0.0478F));

		PartDefinition cube_r68 = spine2.addOrReplaceChild("cube_r68", CubeListBuilder.create().texOffs(4, 101).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 10.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.5616F, -0.5F, 0.4346F, -0.1289F, -0.0015F, -0.0227F));

		PartDefinition cube_r69 = spine2.addOrReplaceChild("cube_r69", CubeListBuilder.create().texOffs(54, 99).addBox(-5.5F, -0.5F, -0.5F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.2774F, 8.4919F, -2.5517F, 0.0433F, -0.0001F, 0.0057F));

		PartDefinition cube_r70 = spine2.addOrReplaceChild("cube_r70", CubeListBuilder.create().texOffs(8, 101).addBox(-0.5F, -1.0F, -0.5F, 1.0F, 10.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.3258F, 0.0F, -2.9193F, 0.0436F, -0.1309F, 0.0F));

		PartDefinition cube_r71 = spine2.addOrReplaceChild("cube_r71", CubeListBuilder.create().texOffs(102, 77).addBox(-0.25F, -0.5F, -0.5F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.3321F, -0.5F, -4.3729F, 0.0F, -0.3491F, 0.0F));

		PartDefinition cube_r72 = spine2.addOrReplaceChild("cube_r72", CubeListBuilder.create().texOffs(102, 75).addBox(0.0F, -0.5F, -0.5F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.13F, -0.5F, -0.3468F, 0.0F, -0.1745F, 0.0F));

		PartDefinition cube_r73 = spine2.addOrReplaceChild("cube_r73", CubeListBuilder.create().texOffs(106, 79).addBox(0.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.9982F, -0.5F, 2.694F, 0.0F, -0.0436F, 0.0F));

		PartDefinition cube_r74 = spine2.addOrReplaceChild("cube_r74", CubeListBuilder.create().texOffs(108, 49).addBox(-0.5F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(-0.025F)), PartPose.offsetAndRotation(-5.607F, 8.3633F, 1.3574F, 0.0F, -0.2182F, 0.0F));

		PartDefinition cube_r75 = spine2.addOrReplaceChild("cube_r75", CubeListBuilder.create().texOffs(0, 101).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 10.0F, 1.0F, new CubeDeformation(-0.025F)), PartPose.offsetAndRotation(-5.5388F, -0.5F, 2.9188F, -0.1745F, 0.0436F, 0.0F));

		PartDefinition cube_r76 = spine2.addOrReplaceChild("cube_r76", CubeListBuilder.create().texOffs(100, 24).addBox(-0.5F, -0.5F, -0.5F, 6.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.4257F, 8.6522F, -1.8608F, 0.0236F, -0.1264F, -0.0281F));

		PartDefinition cube_r77 = spine2.addOrReplaceChild("cube_r77", CubeListBuilder.create().texOffs(54, 101).addBox(-0.6573F, -0.5376F, 0.0915F, 1.0F, 10.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.9189F, -0.3F, -2.4097F, 0.0074F, -0.3889F, 0.0125F));

		PartDefinition cube_r78 = spine2.addOrReplaceChild("cube_r78", CubeListBuilder.create().texOffs(98, 101).addBox(-4.7042F, -0.3568F, -0.5878F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.4665F, -0.5264F, -0.1957F, -0.1053F, -0.3995F, -0.0342F));

		PartDefinition cube_r79 = spine2.addOrReplaceChild("cube_r79", CubeListBuilder.create().texOffs(102, 73).addBox(-5.0F, -0.5F, -0.5F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.0431F, -0.5F, 2.7225F, -0.1309F, 0.0436F, 0.0F));

		PartDefinition cube_r80 = spine2.addOrReplaceChild("cube_r80", CubeListBuilder.create().texOffs(0, 96).addBox(-1.5F, -1.0F, 0.0F, 3.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 0.0F, 0.1745F, 0.0F));
		...
		PartDefinition cube_r83 = spine.addOrReplaceChild("cube_r83", CubeListBuilder.create().texOffs(58, 101).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 9.0F, 1.0F, new CubeDeformation(-0.025F)), PartPose.offsetAndRotation(5.1778F, 0.0F, -0.1209F, -0.0057F, -0.1308F, 0.044F));

		PartDefinition cube_r84 = spine.addOrReplaceChild("cube_r84", CubeListBuilder.create().texOffs(84, 63).addBox(-0.5F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.957F, 7.9261F, -0.1817F, 0.0767F, -0.1719F, 0.0304F));

		PartDefinition cube_r85 = spine.addOrReplaceChild("cube_r85", CubeListBuilder.create().texOffs(48, 104).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 8.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.6316F, 0.4546F, -0.7479F, 0.0871F, -0.5198F, 0.0002F));

		PartDefinition cube_r86 = spine.addOrReplaceChild("cube_r86", CubeListBuilder.create().texOffs(102, 71).addBox(-0.5F, -0.5F, -0.5F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-5.0847F, 8.2454F, -2.4193F, -0.0276F, 0.1274F, -0.0769F));

		PartDefinition cube_r87 = spine.addOrReplaceChild("cube_r87", CubeListBuilder.create().texOffs(62, 101).addBox(-0.5F, -0.5F, -0.5F, 1.0F, 9.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.979F, 0.2471F, -2.2899F, -0.0162F, -0.0452F, 0.0139F));

		PartDefinition cube_r88 = spine.addOrReplaceChild("cube_r88", CubeListBuilder.create().texOffs(42, 102).addBox(-4.5F, -0.5F, -0.5F, 5.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-0.985F, 0.1283F, -2.1067F, 0.0731F, -0.0458F, -0.0297F));

		PartDefinition cube_r89 = spine.addOrReplaceChild("cube_r89", CubeListBuilder.create().texOffs(78, 72).addBox(-3.9829F, -0.5F, -0.2389F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-1.5106F, 0.0F, 0.7526F, 0.0752F, -0.5187F, -0.1509F));

		PartDefinition cube_r90 = spine.addOrReplaceChild("cube_r90", CubeListBuilder.create().texOffs(106, 11).addBox(0.0F, -0.5F, -0.5F, 4.0F, 1.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.7077F, 0.0F, -0.5777F, 0.0F, -0.1309F, 0.0F));

		PartDefinition foliage = body.addOrReplaceChild("foliage", CubeListBuilder.create(), PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition cube_r91 = foliage.addOrReplaceChild("cube_r91", CubeListBuilder.create().texOffs(71, 31).addBox(-3.5F, -3.5F, 0.0F, 7.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, -4.0F, -3.0F, -0.1309F, -0.2618F, 0.4363F));

		PartDefinition cube_r92 = foliage.addOrReplaceChild("cube_r92", CubeListBuilder.create().texOffs(71, 31).addBox(-3.5F, -3.5F, 0.0F, 7.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.0F, -3.0F, -2.0F, 0.2618F, -0.1309F, 0.3491F));

		PartDefinition cube_r93 = foliage.addOrReplaceChild("cube_r93", CubeListBuilder.create().texOffs(71, 31).addBox(-3.5F, -3.5F, 0.0F, 7.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, -3.0F, -3.0F, -0.3054F, -0.1745F, -0.4363F));

		PartDefinition cube_r94 = foliage.addOrReplaceChild("cube_r94", CubeListBuilder.create().texOffs(71, 31).addBox(-3.5F, -3.5F, 0.0F, 7.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(1.0F, 3.0F, -3.0F, 0.3054F, 0.0F, 0.2618F));

		PartDefinition cube_r95 = foliage.addOrReplaceChild("cube_r95", CubeListBuilder.create().texOffs(71, 31).addBox(-3.5F, -3.5F, 0.0F, 7.0F, 7.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, -1.0F, -1.0F, -0.2182F, -0.3927F, -0.7418F));
