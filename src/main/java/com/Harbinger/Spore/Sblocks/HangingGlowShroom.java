...
public class HangingGlowShroom extends HangingRootsBlock {
    public HangingGlowShroom() {
        super(Properties.of().strength(0f, 0f).noCollission().noOcclusion().sound(SoundType.CROP).lightLevel(s -> 3).hasPostProcess((bs, br, bp) -> true).emissiveRendering((bs, br, bp) -> true));
    }
