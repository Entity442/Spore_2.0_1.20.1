...
public class SMenu {
    ...
    public static final RegistryObject<MenuType<InjectionRecipeMenu>> INJECTION_RECIPE_MENU = MENU.register("injection_recipe_menu", () -> IForgeMenuType.create(InjectionRecipeMenu::new));
