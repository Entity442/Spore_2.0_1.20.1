...
public class Sblocks {
    ...
    public static final RegistryObject<Block> CALCIFIED_BIOMASS_BLOCK = BLOCKS.register("calcified_biomass_block", () -> new Block(BlockBehaviour.Properties.of().strength(10f,10f).sound(SoundType.SLIME_BLOCK)));
