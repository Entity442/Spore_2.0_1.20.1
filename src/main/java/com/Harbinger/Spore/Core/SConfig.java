...
public class SConfig {
    ...
    public static class Server {
        ...
        public Server(ForgeConfigSpec.Builder builder) {
            ...
            builder.pop();
            builder.push("Saber");
            this.saber_durability = builder.comment("Default 600").define("Durability",600);
            ...
            this.greatsword_durability = builder.comment("Default 1000").define("Durability",1000);
            this.greatsword_damage = builder.comment("Default 12").defineInRange("Damage", 12, 1, Integer.MAX_VALUE);
            builder.pop();
            builder.push("Crossbow");
            this.crossbow_durability = builder.comment("Default 500").define("Crossbow Durability",500);
            this.crossbow_arrow_damage_multiplier = builder.comment("Default 1.0").define("Crossbow Range Damage Modifier",1.0);
             builder.pop();
            builder.push("Bow");
            this.bow_durability = builder.comment("Default 500").define("Bow Durability",500);
            ...
            builder.pop();
            builder.push("Armads");
            this.armads_durability = builder.comment("Default 1500").define("Durability",1500);
            this.armads_damage = builder.comment("Default 15").defineInRange("Damage", 15, 1, Integer.MAX_VALUE);
            builder.pop();
            builder.push("Maul");
            this.maul_durability = builder.comment("Default 2500").define("Durability",2500);
            this.maul_damage = builder.comment("Default 7").defineInRange("Damage", 7, 1, Integer.MAX_VALUE);
            builder.pop();
            builder.push("Pickaxe");
            this.inf_pickaxe_durability = builder.comment("Default 1500").define("Durability",1500);
            ...
            this.shovel_durability = builder.comment("Default 1800").define("Durability",1800);
            this.shovel_damage = builder.comment("Default 6").defineInRange("Damage", 6, 1, Integer.MAX_VALUE);
            builder.pop();
            builder.push("Rapier");
            this.rapier_durability = builder.comment("Default 800").define("Durability",800);
            this.rapier_damage = builder.comment("Default 10").defineInRange("Damage", 10, 1, Integer.MAX_VALUE);
            builder.pop();
            builder.push("Mace");
            this.mace_durability = builder.comment("Default 800").define("Durability",800);
