...
public class Infected extends Monster{
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new HurtTargetGoal(this ,entity -> {return !likedFellows(entity);}, Infected.class).setAlertOthers(Infected.class));
        ...
        this.targetSelector.addGoal(1, new NearestAttackableTargetGoal<>(this, Animal.class, 5, false, true, (en) -> {
            return !this.likedFellows(en) && SConfig.SERVER.at_an.get();
        }));
