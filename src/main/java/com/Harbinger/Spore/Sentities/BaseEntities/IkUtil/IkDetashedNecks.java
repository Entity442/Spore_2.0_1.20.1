...
public class IkDetashedNecks {
    ...
    protected final DragonHead.DragonHeadMultipart[] hitboxes;
    ...
    public IkDetashedNecks(DragonHead owner, int amount, Vec3 defaultBodyOffset,
        ...
        this.hitboxes = new DragonHead.DragonHeadMultipart[amount];
        ...
        for(int i = 0; i < amount; i++){
            ...
            targetYaws[i] = 0;
            currentYaws[i] = 0;
            hitboxes[i] = new DragonHead.DragonHeadMultipart(owner,"part" + i);
        }
    ...
    public void setSitPosition(Vec3 vec3){
        sitPosition = vec3;
    }
    ...
    public DragonHead.DragonHeadMultipart[] getHitboxes() {
        return hitboxes;
    }
    ...
    public void applyIK() {
        ...
        for (int i = 0;i<entities.length;i++){
            DragonHead.DragonHeadMultipart multipart = hitboxes[i];
            Vec3 vec3 = entities[i];
            setupPositionHitbox(multipart,vec3);
        }
    }

    public void setupPositionHitbox(DragonHead.DragonHeadMultipart multipart,Vec3 vec3) {
        Vec3 prev = new Vec3(
                multipart.getX(),
                multipart.getY(),
                multipart.getZ()
