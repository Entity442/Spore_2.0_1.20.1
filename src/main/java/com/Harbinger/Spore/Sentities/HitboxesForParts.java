...
public enum HitboxesForParts {
    ...
    HOWI_CANNON1(17,3f,1.5f,CALAMITY_TYPE.GROUND),
    HOWI_CANNON2(18,3f,1.5f,CALAMITY_TYPE.GROUND),
    HOWI_CANNON3(19,3f,1.5f,CALAMITY_TYPE.GROUND),
    ...
    LEVI_BODY(41,3,3,CALAMITY_TYPE.WATER),
    LEVI_SEGMENT(42,3,3,CALAMITY_TYPE.WATER),
    LEVI_TAIL(43,5,2.5f,CALAMITY_TYPE.WATER),
    LEVI_RIGHT_JAW(44,2.5f,1,CALAMITY_TYPE.WATER),
    LEVI_LEFT_JAW(45,2.5f,1,CALAMITY_TYPE.WATER),
    HOHL_ADA_JAW(46,3,1.2f,CALAMITY_TYPE.GROUND),
    HOHL_ADA_HEAD(47,3,2.5f,CALAMITY_TYPE.GROUND),
