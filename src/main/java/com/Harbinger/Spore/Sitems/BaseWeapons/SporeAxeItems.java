...
public class SporeAxeItems extends SporeDiggerTools{
    ...
    private Optional<BlockState> getStripped(BlockState p_150691_) {
        return Optional.ofNullable((Block)STRIPPABLES.get(p_150691_.getBlock())).map((p_150689_) -> {
            return (BlockState)p_150689_.defaultBlockState().setValue(RotatedPillarBlock.AXIS, (Direction.Axis)p_150691_.getValue(RotatedPillarBlock.AXIS));
        });
    }
